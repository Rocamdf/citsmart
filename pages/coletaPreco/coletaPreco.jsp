...
<script>
	...
	function load() {
	    ...
	    document.form.afterLoad = function() {
            $('.tabs').tabs('select', 0);
            document.form.dataColeta.value = "<%=UtilDatas.dateToSTR(UtilDatas.getDataAtual())%>";
        }
	}
...
<div class="box grid_16 tabs">
	<form name='form'
		action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/coletaPreco/coletaPreco'>
		<div class="columns clearfix">
            ...
            <div class="section">
              <div class="col_40">
	                 <h2 class="section">
	                     <i18n:message key="coletaPreco.coletasIncluidas" />
	                 </h2>
                     <div class="col_100" style='height:300px;overflow:auto' >
                         <table id="tblColetasPreco" class="table">
                             <tr>
                                 <th width="1%"></th>
                                 <th width="5%"><i18n:message key="coletaPreco.numero" /></th>
                                 <th width="40%"><i18n:message key="coletaPreco.item" /></th>
              ...
              <div class="col_60">
                     <h2 class="section">
                         <i18n:message key="cotacao.coletaPreco" />
                     </h2>
				    <ul class="tab_header clearfix">
				        <li><a href="#tabs-1"><i18n:message key="coletaPreco.identificacao" />
				        </a>
				        </li>
				        <li><a href="#tabs-2"><i18n:message key="coletaPreco.avaliacao" />
				        </a>
				        </li>
				    </ul>
				    <div class="toggle_container">
				        <div id="tabs-1" class="block">
				            <div class="section">
                                ...
                                <div class="col_50">
                                    <fieldset>
                                        <label class="campoObrigatorio"><i18n:message key="coletaPreco.dataColeta" />
                                        </label>
                                            <div>
                                ...
                                <div class="col_50">
                                    <fieldset>
                                        <label><i18n:message key="coletaPreco.dataValidade" />
                                        </label>
                                        <div>
                        ...
                        <div id="tabs-2" class="block">
                            <div class="section">
                                <div class="col_50">
                                    <fieldset>
                                        <label class="campoObrigatorio"><i18n:message key="coletaPreco.quantidadeCotada" />
                                        </label>
                                        <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.preco" />
					                    </label>
					                    <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.valorFrete" />
					                    </label>
					                    <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.valorDesconto" />
					                    </label>
					                    <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.prazoEntrega" />
					                    </label>
					                    <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.prazoPagto" />
					                    </label>
					                    <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.taxaJuros" />
					                    </label>
					                    <div>
					            ...
					            <div class="col_50">
					                <fieldset>
					                    <label class="campoObrigatorio"><i18n:message key="coletaPreco.prazoGarantia" />
					                    </label>
					                    <div>
