...
<script>
	...
	function limpar() {
	   	...
	   	limpar_LOOKUP_ATITUDE_ORGANIZACIONAL();
	}
	...
	function LOOKUP_ATITUDE_ORGANIZACIONAL_select(id, desc) {
		
		document.form.restore({
			idAtitudeOrganizacional : id
		});
	}
	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="solicitacaoCargo.atitudesOrganizacional" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="solicitacaoCargo.cadastroAtitudeOrganizacional" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="solicitacaoCargo.pesquisaAtitudeOrganizacional" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						...
						<div class="section">
							...
							<form id='form'
								  name='form'
								  action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/atitudeOrganizacional/atitudeOrganizacional'>
								  
								<input type='hidden' name='idAtitudeOrganizacional' id="idAtitudeOrganizacional" />
					...
					<div id="tabs-2" class="block">
						<div class="section">
							...
							<form name='formPesquisa'>
								<cit:findField formName='formPesquisa'lockupName='LOOKUP_ATITUDE_ORGANIZACIONAL' id='LOOKUP_ATITUDE_ORGANIZACIONAL' top='0'left='0' len='550' heigth='400' javascriptCode='true' htmlCode='true' />
							</form>
						</div>
					</div>
