		...
		<div id="wrapper">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">
					<h2><i18n:message key="patrimonio.cadastro_patrimonio"/></h2>						
				</div>
				
				<div class="box grid_16 tabs">
					<ul class="tab_header clearfix">
						<li>
							<a href="#tabs-1"><i18n:message key="patrimonio.cadastro_patrimonio"/></a>
						</li>
					</ul>				
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">											
								<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/patrimonio/patrimonio'>
									...
									<div class="columns clearfix">
											...
											<div class="col_100">
												...
												<div id="divItemConfiguracaoPai" class="col_15">
													<fieldset>
														...
														<label ><i18n:message key="patrimonio.selecione_item"/></label>
												...
												<div id="divItemConfiguracaoPai" class="col_25">
													<fieldset>
														<label class="campoObrigatorio"><i18n:message key="patrimonio.item_config_pai"/></label>
														<div style="height: 36px">
															<input id="addItemConfiguracaoPai" style="width: 90% !important;" type='text' name="nomeItemConfiguracaoPai" maxlength="70" size="70"/> 
															<img id="addItemConfiguracaoPai" style="cursor: pointer; vertical-align: middle;" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/magnifying_glass.png">
														</div>
													</fieldset>
												</div>
												...
												<div id="divTipoItemConfiguracao" class="col_25">
													<fieldset>
														<label class="campoObrigatorio"><i18n:message key="patrimonio.tipo_item"/></label>
															<div>
												...
												<div id="divItemConfiguracaoFilho" class="col_25">
													<fieldset>
														<label class="campoObrigatorio"><i18n:message key="patrimonio.item_config_filho"/></label>
														<div style="height: 36px">
															...
															<img id="addItemConfiguracaoFilho" style="cursor: pointer; vertical-align: middle;" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/magnifying_glass.png">
														</div>
													</fieldset>
												</div>
											</div>
										...
										<div id="gridCaracteristica" class="columns clearfix" style="display: none;">
											<h1><i18n:message key="patrimonio.patrimonio_item_pai"/></h1>
										...
										<div id="gridCaracteristicaItemFilho" class="columns clearfix" style="display: none;">
											<h1><i18n:message key="patrimonio.patrimonio_item_filho"/></h1>
