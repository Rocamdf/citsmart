											...
											<div class="tab-content">
												<div class="tab-pane active" id="tab1-4"> <!-- conteudo da tab Listagem de Serviços -->
													...
													<table class="table table-bordered">
												    	<tr><th class="span5"><i18n:message key="servico.nome" /></th><th class="span3"><i18n:message key="portal.carrinho.descricao" /></th><th class="span4"><i18n:message key="portal.carrinho.adicionar" /></th></tr>
														...
														<div class="modal-header">
												  		...
												  		<div class="modal-body">
													  		<table class="table table-bordered" id="tblDescricao">
														    	<tr><th class="span2"><i18n:message key="servico.nome" /></th><th class="span7"><i18n:message key="portal.carrinho.descricao" /></th><th class="span2"><i18n:message key="portal.carrinho.preco" /></th><th class="span1"><i18n:message key="portal.carrinho.adicionar" /></th></tr>
														...
														<table class="table table-bordered table-primary table-striped table-vertical-center checkboxs js-table-sortable">
															<thead>
																<tr>
																	...
																	<th style="width: 1%;" class="center"><i18n:message key="carrinho.numero"/></th>
																	<th></th>
																	<th style="width: 80px;"><i18n:message key="carrinho.categoria"/></th>
																	<th style="width: 50px;"><i18n:message key="carrinho.quantidade"/></th>
																	<th style="width: 80px;"><i18n:message key="carrinho.preço"/></th>
																	<th style="width: 80px;"><i18n:message key="carrinho.subtotal"/></th>
																	<th style="width: 80px;"><i18n:message key="carrinho.excluir"/></th>
																</tr>
															</thead>
															<tbody>
																<!-- Cart item -->
																<tr class="selectable">
																	...
																	<td class="product">
																		<div class="media">
																			<!-- <a href="shop_client_product.html?lang=en&amp;layout_type=fluid&amp;menu_position=menu-left&amp;style=style-light" class="media-object pull-left"><img class="thumb" src="theme/images/gallery-2/1.jpg" width="80" alt=""></a> -->
														...
														<!-- Column -->
															...
															<div class="span4 offset3">
																<table class="table table-borderless table-condensed cart_total">
																	<tbody>
																		<%-- <tr>
																			<td class="right"><i18n:message key="Subtotal:"/></td>
																			<td class="right strong">&dollar;1,000.00</td>
																		</tr>
																		<tr>
																			<td class="right"><i18n:message key="Delivery:"/></td>
																		...
																		<tr>
																			<td colspan="2">
																				<div class="separator bottom"></div>
																				<span class="label center label-block large"><i18n:message key="carrinho.total"/> &dollar;3,000.00</span>
																			</td>
																		</tr>
																		<tr>
																			<td colspan="2"><button type="submit" class="btn btn-block btn-primary btn-icon glyphicons right_arrow"><i></i><i18n:message key="carrinho.Concluir"/></span></td>
																		</tr>
																	</tbody>
																</table>
															</div>
