	...
	<body>
		<div class="container-fluid fixed ">
			...
			<div class="widget-body">
				...
				<!-- Inicio conteudo -->
				<div id="content">
					<form style="margin: 0;" class="form-horizontal" name='form' action='<%=request.getContextPath()%>/pages/justificativaAcaoCurriculo/justificativaAcaoCurriculo'>
						<div style="padding: 0;" class="tab-content">
								...
								<div id="account-details" class="tab-pane active">
									...
									<div style="margin: 0;" class="form-actions">
										<button class="btn btn-icon btn-primary glyphicons circle_ok" type="button" onclick='document.form.save()'><i></i><i18n:message key="citcorpore.comum.gravar" /></button>
