		...
		<div id="wrapper">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">
					<h2><i18n:message key="baseItemConfiguracao.software"/></h2>						
				</div>
				
				<div class="box grid_16 tabs">
					<ul class="tab_header clearfix">
						<li>
							<a href="#tabs-1"><i18n:message key="baseItemConfiguracao.cadastro"/></a>
						</li>
						<li>
							<a href="#tabs-2" class="round_top"><i18n:message key="baseItemConfiguracao.pesquisa"/></a>
						</li>
					</ul>				
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">											
								<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/baseItemConfiguracao/baseItemConfiguracao'>
									<div class="columns clearfix">
										...
										<div class="columns clearfix">
											<div class="col_100">				
												<fieldset>
													<label class="campoObrigatorio"><i18n:message key="baseItemConfiguracao.software"/></label>
														<div>
											...
											<div class="col_100">				
												<fieldset>
													<label class="campoObrigatorio"><i18n:message key="baseItemConfiguracao.tipoExecucao"/></label>
													<div class="columns clearfix" style="border: none;">
														<div class="col_50" style="border: none;">
													  		<input type="checkbox" name="tipoExecucaoInstalacao" id="tipoExecucaoInstalacao" checked="checked" onclick="checarExecucaoInstalacao(event)" /><i18n:message key="baseItemConfiguracao.instalacao"/>
												  		</div>
													  	<div class="col_50">
													  		<input type="checkbox" name="tipoExecucaoDesinstalacao" id="tipoExecucaoDesinstalacao" onclick="checarExecucaoDesinstalacao(event)" /><i18n:message key="baseItemConfiguracao.desinstalacao"/>
												  		</div>
													</div>
												</fieldset>
											</div>
											...
											<div class="col_100" id="divExecucaoInstalacao" style="display: block;">
												<div class="columns clearfix" style="border: none;">
													<div class="col_100">
														<fieldset>
															<label class="campoObrigatorio"><i18n:message key="baseItemConfiguracao.executavel"/></label>
																<div>
													...
													<div class="col_100">				
														<fieldset style="height: 78px;">
															<label><i18n:message key="baseItemConfiguracao.comando"/></label>
																<div>
											...
											<div class="col_50" id="divExecucaoDesinstalacao" style="display: none;">
												<div class="columns clearfix" style="border: none;">
													<div class="col_100">
														<fieldset>
															<label class="campoObrigatorio"><i18n:message key="baseItemConfiguracao.executavelDesinstalacao"/></label>
																<div>
													...
													<div class="col_100" id="divComandosIguais">				
														<fieldset style="border: none;">
															<div>
															  	<input type='checkbox' name="comandosIguais" id="comandosIguais" onclick="checarComandosIguais(event);" /><i18n:message key="baseItemConfiguracao.comandosIguais"/>
															</div>
														</fieldset>
													</div>
													<div class="col_100" >				
														<fieldset style="border-top: none; height: 55px;">
															<label style="display: none;" id="labelComandoDesinstalacao"><i18n:message key="baseItemConfiguracao.comandoDesinstalacao"/></label>
