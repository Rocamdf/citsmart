...
<head>
    ...
    <script>
        function limpar(){
	    	window.location = '<%=Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/movimentacaoPessoal/movimentacaoPessoal.load';
	    } 
...
<body> 
 <div class="box grid_16 tabs" style='width:100%;margin: 0px 0px 0px 0px;'>
    <form name='form'
        action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/movimentacaoPessoal/movimentacaoPessoal'>
 			...
 			<input type='hidden' name='serializeTriagem' id='serializeTriagem'/>
        		<div class="col_100">
                   <div class="col_25">
                        <fieldset style="height: 70px;">
                            <label class="campoObrigatorio"><i18n:message key="Gestor" /></label>
                            <div>
                   ...
                   <div class="col_25">
                        <fieldset style="height: 70px;">
                            <label class="campoObrigatorio"><i18n:message key="Nome Colaborador" /></label>
                            <div>
                   ...
                   <div class="col_25">
                        <fieldset style="height: 70px;">
                            <label class="campoObrigatorio"><i18n:message key="Número Requisição Pessoal" /></label>
                            <div>
                   ...
                   <div class="col_25">
	        	         <fieldset style="height: 70px;">
	                         <label class="campoObrigatorio"><i18n:message key="Data" /></label>
	                         <div>
                ...
                <div class="col_100" style="background:#F5F5F5">
                	<fieldset style="height: 50px;">
                		...
                		<h2><i18n:message key="ALTERAÇÃO"/></h2>
                	</fieldset>
                </div>
                <div id="divAlteracao" style="display: none;">
	        	    ...
	        	    <div class="col_33">
	        	         <fieldset style="height: 70px;">
	                         <label class="campoObrigatorio"><i18n:message key="Cargo" /></label>
	                         <div>
	        	    ...
	        	    <div class="col_33">
	        	         <fieldset style="height: 70px;">
	                         <label class="campoObrigatorio"><i18n:message key="Lotação" /></label>
	                         <div>
		        	 ...
		        	 <div class="col_33">
	        	         <fieldset style="height: 70px;">
	                         <label class="campoObrigatorio"><i18n:message key="Centro de Resultado" /></label>
	                         <div>
	        	   ...
	        	   <div class="col_100">  
	        	    <div class="col_33">
	        	         <fieldset style="height: 70px;">
	                         <label class="campoObrigatorio"><i18n:message key="Projeto" /></label>
	                         <div>
		        	 ...
		        	 <div class="col_33">
	        	         <fieldset style="height: 70px;">
	                         <label class="campoObrigatorio"><i18n:message key="Salário" /></label>
	                         <div>
	        	   ...
	        	   <div class="col_100">
	        	     <fieldset style="height: 20px;">
	        	       <label class="campoObrigatorio"><i18n:message key="Justificativas" /></label>
	        	     </fieldset>
	        	   </div>
	        	   <div class="col_100">
					  <fieldset>
						  <div class="col_20">
							 Iniciativa<textarea rows="5" cols="122" name='iniciativa'></textarea>
						  </div>
						  <div class="col_20">
							 Aperfeiçoamento<textarea rows="5" cols="122" name='aperfeicoamento'></textarea>
						  </div>
						  <div class="col_20">
							 Comprometimento<textarea rows="5" cols="122" name='comprometimento'></textarea>
						  </div>
						  <div class="col_20">
							 Integridade<textarea rows="5" cols="122" name='integridade'></textarea>
						  </div>
					  </fieldset>
					</div>
        	    </div>
                ...
                <div class="col_100" style="background:#F5F5F5">
                    <fieldset style="height: 50px;">
                	    ...
                	    <h2><i18n:message key="DEMISSÃO"/></h2>
                	</fieldset>
                </div>
        	      ...
        	      <div class="col_100">
	        	      	<div class="col_33">
		        	    	<fieldset style="height: 70px;">
		                         ...
		                         <label class="campoNaoObrigatorio"><i18n:message key="Aviso Indenizado" /></label>
		                    </fieldset>
		               </div>
		               <div class="col_33">
		                    <fieldset style="height: 70px;">
		                         <input type="radio" name="tipoDemissao" value="T"/>
		                         <label class="campoNaoObrigatorio"><i18n:message key="Aviso Trabalhado" /></label>
		                    </fieldset>
		               </div>
		               <div class="col_33">
		                    <fieldset style="height: 70px;">
		                         <input type="radio" name="tipoDemissao" value="C"/>
		                         <label class="campoNaoObrigatorio"><i18n:message key="Término de Contrato" /></label>
		                     </fieldset>
		      			</div>
                   </div>
                   <div class="col_100">
					  <fieldset>
						  <label class="campoNaoObrigatorio"><i18n:message key="Observações" /></label>			
						  <div>
...
<div id="POPUP_EMPREGADOS" title="<i18n:message key="citcorpore.comum.pesquisa" />">
