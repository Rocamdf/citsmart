 ...
 <div id="main_container" class="main_container container_16 clearfix">
	<%@include file="/include/menu_horizontal.jsp"%>
		...
		<div class="flat_area grid_16">
				<h2><i18n:message key="menu.menu"/></h2>						
		</div>
  <div class="box grid_16 tabs">
			<ul class="tab_header clearfix">
				<li>
					<a href="#tabs-1"><i18n:message key="menu.cadastroMenu"/></a>
				</li>
				<li>
					<a href="#tabs-2" class="round_top"><i18n:message key="menu.pesquisaMenu"/></a>
				</li>
			</ul>				
	<a href="#" class="toggle">&nbsp;</a>
	 <div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="">
							<form name='form' 
							action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/menu2/menu2'>
								<div class="columns clearfix">
									...
									<div class="col_50">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="citcorpore.comum.descricao" />
											</label>
											<div>
									...
									<div class="col_33">
										<fieldset style="height: 61px">
											<label> <i18n:message key="menu.menuPai" />
											</label>
											<div>
									...
									<div class="col_33">
										<fieldset>
											<label><i18n:message key="menu.link" /> </label>
											<div>
									...
									<div class="col_33">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="menu.ordem" /> </label>
											<div>
									...
									<div class="col_100">
										<div>
											<label ><i18n:message key="menu.imagem" /></label>
										</div>
										<label><img style="vertical-align: top;"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/home.png" />
										</label><input
											class=""
											...
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/documents.png" />
										</label> <input
											class=""
											...
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/list_w_images.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="list_w_images.png" /> <label><img style="vertical-align: top;"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/money.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="money.png" /> <label><img style="vertical-align: top;"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/users.png" />
										</label><input
											class=""
											...
											height="25"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/large/grey/cog_3.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="cog_3.png" /> <label><img style="vertical-align: top;"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/alert_2.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="alert_2.png" /> <label><img style="vertical-align: top;"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/strategy.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="strategy.png" /> <label><img style="vertical-align: top;"
											height="25"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/large/grey/box_outgoing_2.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="box_outgoing_2.png" /> <label><img style="vertical-align: top;"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/user_comment.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="user_comment.png" /> <label><img style="vertical-align: top;"
											height="25"
											src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/books_2.png" />
										</label><input
											class=""
											type="radio" name="imagem" value="books_2.png" />
									</div>
									<%-- <div  class="col_100">
										<label class="campoObrigatorio" ><i18n:message key="menu.horizontal"/> </label>
											 <input value="S" type="radio" id="horizontal" name="horizontal" class="Valid[Required] Description[Selecione Sim ou Não]" onclick="desativaMenuPai()" /><i18n:message key="menu.sim"/>
											 <input value="N" type="radio" id="horizontal" name="horizontal"  class="Valid[Required] Description[Selecione Sim ou Não]" onclick="ativaMenuPai()" /><i18n:message key="menu.nao"/> 
										
										<label><i18n:message key="menu.menuRapido"/></label>
