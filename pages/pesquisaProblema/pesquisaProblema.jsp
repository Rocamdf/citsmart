		...
		<%-- 	<%@include file="/include/menu_horizontal.jsp"%> --%>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="pesquisaProblema.pesquisaProblema"/></a></li>
				</ul> 
				<a href="#" class="toggle">&nbsp;</a>
				<div  class="toggle_container">
					<div  class="block" >
						<div id="parametros" >
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/pesquisaProblema/pesquisaProblema'>
								...
								<div class="columns clearfix">
									...
									<div class="col_25">
										<fieldset style="height: 71px">
											<label><i18n:message key="pesquisaProblema.numero" /></label>
											<div>
										...
										<fieldset style="height: 71px">
											...
											<div>
												...
												<select name='ordenacao' id="ordenacao">
													<option selected="selected" value='problema.idproblema'><i18n:message key="citcorpore.comum.numero" /></option>
													<option value="problema.datahorainicio"><i18n:message key="citcorpore.comum.data" /></option>
										            ...
										            <OPTION value='problema.status'><i18n:message key="problema.status" /></OPTION>
										            <OPTION value='problema.idgrupo'><i18n:message key="pesquisasolicitacao.gruposolucionador" /></OPTION>
												</select>
											</div>
											</div>
										</fieldset>																				
								...
								<div class="columns clearfix">
									...
									<div class="col_25">
										<fieldset >
											<label><i18n:message key="problema.proprietario" /></label>
											<div>
									...
									<div class="col_25">
										<fieldset style="height: 55px" >
											<label><i18n:message key="problema.status" /></label>
											<div>
												<select name='status'>
												
												
													<option value=''>--<i18n:message key="citcorpore.comum.todos" /> --</option>
													<OPTION value="Concluída" ><i18n:message key="citcorpore.comum.concluida" /></OPTION>
													<OPTION value='Em andamento'><i18n:message key="citcorpore.comum.emandamento" /></OPTION>
													<OPTION value='Em Investigação'><i18n:message key="pesquisaProblema.emInvestigacao" /></OPTION>
													<OPTION value='Registrada'><i18n:message key="citcorpore.comum.registrada" /></OPTION>
										           <OPTION value='Resolução'><i18n:message key="pesquisaProblema.resolucao" /></OPTION>
								...
								<div class="columns clearfix">
									...
									<div class="col_25">
										<div>
											<fieldset>
												<label><i18n:message key="categoriaProblema.categoriaProblema" /></label>
												<div>
									...
									<div class="col_25">
										<div id="div_categoria" style="display:none">
											<fieldset>
												<label><i18n:message key="pesquisaProblema.categoriaProblema" /></label>
												<div>
													<select  name='nomeCategoriaProblema'>
													<option value=''>--<i18n:message key="citcorpore.comum.todos" /> --</option>
													<option value="Importante"><i18n:message key="pesquisaProblema.categoriaMudancaImportante" /></option>
													<option value="Significativa"><i18n:message key="pesquisaProblema.categoriaMudancaSignificativa" /></option>
													<option value="Pequena"><i18n:message key="pesquisaProblema.categoriaMudancaPequena" /></option>
													</select>
												</div>
											</fieldset>										
										</div>
								...
								<table id='tblProblema' class="table" cellpadding="0" cellspacing="0" width='100%' height="100%" >
									<tr>
										<th width="10%" ><i18n:message key="visao.numero" /></th>
										<th width="10%" ><i18n:message key="citcorpore.comum.categoria" /></th>
										<th width="10%" ><i18n:message key="problema.status" /></th>
										<th width="10%"><i18n:message key="problema.proprietario" /></th>
										...
										<th width="10%" ><i18n:message key="citcorpore.comum.dataHoraConclusao" /></th>
										<th width="10%" ><i18n:message key="grupo.grupo" /></th>
										<th width="10%" ><i18n:message key="problema.titulo" /></th>
