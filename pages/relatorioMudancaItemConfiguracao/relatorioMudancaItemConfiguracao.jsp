			...
			<div class="box grid_16 tabs">
				...
				<div class="toggle_container">
					<div class="block">
						<div id="parametros">
							<form name="form"
								action="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/relatorioMudancaItemConfiguracao/relatorioMudancaItemConfiguracao">
									...
									<fieldset>
										<button type='button' name='btnRelatorio' class="light"
											...
											<img
												...
												style="padding-left: 8px;"> <span><i18n:message
