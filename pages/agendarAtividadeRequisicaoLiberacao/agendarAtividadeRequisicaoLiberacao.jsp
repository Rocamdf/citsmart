...
<!-- Conteudo -->
 <div id="main_container" class="main_container container_16 clearfix">
		...
		<div class="flat_area grid_16">
				<h4><i18n:message key="requisicaoLiberacao.requisicaoLiberacao"/>&nbsp;Nº&nbsp;<%=idRequisicaoLiberacao%></h4>						
		</div>
  <div class="box grid_16 tabs">
	 ...
	 <div class="toggle_container">
						...
						<div id="tabs-2" class="block">
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/agendarAtividadeRequisicaoLiberacao/agendarAtividadeRequisicaoLiberacao'>
								<div class="columns clearfix">
									...
									<div class="col_100">
										<fieldset>
											...
											<div> 
												<select name='idGrupoAtvPeriodica' <%--class=" Valid[Required]--%> Description[<i18n:message key='gerenciaservico.agendaratividade.crupoatividades' />]">
												</select>					
											</div>
										</fieldset>
										<fieldset id='fldOrientacao'>
											...
											<div> 
												<textarea <%--class=" Valid[Required]--%> Description[<i18n:message key='gerenciaservico.agendaratividade.crupoatividades' />]" name="orientacaoTecnica" cols='90' rows='5'></textarea>
											</div>
										</fieldset>										
										<fieldset id='fldIniciarEm'>
											<label class="campoObrigatorio" style="cursor: pointer;"><i18n:message key='gerenciaservico.agendaratividade.agendarpara' /></label>
											<div> 
												<table>
													<tr>
														<td>
										...
										<fieldset id='fldDuracaoEstimada'>
											<label class="campoObrigatorio" style="cursor: pointer;"><i18n:message key='gerenciaservico.agendaratividade.duracaoestimada' /> </label>
											<div> 
												<table>
													<tr>
														<td>
