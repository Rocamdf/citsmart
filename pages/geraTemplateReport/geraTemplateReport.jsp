<%
String htmlProcess = (String)request.getAttribute("htmlProcess");
if (htmlProcess == null){
	htmlProcess = "";
}
...
<body>	
        <script type="text/javascript">
    		...
    		function gerarPainel(){
    			...
    			//if(validaData(dataInicio, dataFim)){
    				...
    				{
    					document.formParametros.action = '<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/geraTemplateReport/geraTemplateReport.load';
        ...
        <div id='divImpressao'>
        	<button type='button' name='btnImprimir' onclick='imprimir()' class='light'>Imprimir</button>
        </div>
