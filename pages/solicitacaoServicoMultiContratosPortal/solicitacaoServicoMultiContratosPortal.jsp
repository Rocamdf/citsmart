			...
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div class="">
						...
						<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/solicitacaoServicoMultiContratosPortal/solicitacaoServicoMultiContratosPortal'>
							<div class="columns clearfix">
								...
								<div class="col_100">
									<div class="col_50">
										<fieldset>
											<label><i18n:message key="solicitacaoServico.nomeDoContato" /></label>
											<div>
									...
									<div class="col_50">
										<fieldset>
											<label><i18n:message key="solicitacaoServico.emailContato" /></label>
											<div><input id="emailcontato" name="emailcontato" size="35"/></div>
										</fieldset>
									</div>
									<div class="col_33">
										<fieldset>
											<label><i18n:message key="solicitacaoServico.telefoneDoContato" /></label>
...
<div id="POPUP_menuAnexos" title="<i18n:message  key="citcorpore.comum.anexos" />">
