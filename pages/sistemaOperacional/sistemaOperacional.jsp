...
<!-- Conteudo -->
	...
	<%}%>
			...
			<div class="flat_area grid_16">
				<h2><i18n:message key="comandoso.sistema"/></h2>
			</div>

			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="sistema.cadastro"/></a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="sistema.pesquisa"/></a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/sistemaOperacional/sistemaOperacional'>
								<div class="columns clearfix">
									<input type='hidden' name='id' />
									<div class="col_66">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="sistema.nome"/></label>
											<div>
