...
<%}%>
	...
	<script type="text/javascript">
		...
		function addLinhaTabelaServico(idServico, nomedDoServico){
			...
			var coluna = row.insertCell(0);
			contServico++;
			coluna.innerHTML = '<img id="imgDelEmpregado' + contServico + '" style="cursor: pointer;" title="<i18n:message key="citcorpore.comum.excluir" />" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="removeLinhaTabelaServico(\'tabelaServico\', this.parentNode.parentNode.rowIndex);">';
			coluna = row.insertCell(1);
		...
		function removeLinhaTabelaServico(idTabela, rowIndex) {
			 if (confirm(i18n_message("citcorpore.comum.deleta"))) {
				document.form.idServicoExclusao.value = eval('document.getElementById("idServico' + rowIndex + '").name');
			...
			<div class="box grid_16 tabs">
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/servicoContratoMulti/servicoContratoMulti'>
								...
								<div class="col_100">
									<br>
									<fieldset>
										<label id="addServico" style="cursor: pointer;"title="<i18n:message  key="citcorpore.comum.cliqueParaAdicinar" />"><i18n:message  key="servicoContrato.receberConfiguracao" /><img	src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"></label>
										<br>
										<label id="addTodosOsServicos" style="cursor: pointer;"title="<i18n:message  key="servicoContrato.cliqueAdicionarTodosOsServicos" />"><i18n:message  key="servicoContrato.adicionarTodosOsServicos" /><img	src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/club_add.png"></label>
										<br>
										<div  id="gridServicos">
											<table class="tableLess" id="tabelaServico" width="100%">
												<thead>
													<tr class="th">
														<th></th>
														<th><i18n:message  key="visao.id" /></th>
														<th><i18n:message  key="visao.servico" />  /  <i18n:message  key="visao.detalhamentoServico" /></th>
													</tr>
												</thead>
												<tbody></tbody>
											</table>
