		...
		<div class="<%=(iframe == null) ? "container-fluid fixed" : "" %>">
			...
			<div id="wrapper">
				...
				<div id="content <%=(iframe == null) ? "contentframe" : "" %>">				
					...
					<div class="row-fluid">
						<div class="innerLR">							
							<form class="form-horizontal" id='form' name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/solicitacaoServicoMultiContratosPortal2/solicitacaoServicoMultiContratosPortal2'>		
								...
								<div class='row-fluid'>
									<div class='span6'>
										<div class="control-group">
											<label class="control-label"><i18n:message key="contrato.contrato"/></label>
											<div class="controls">
												<div id="nomeContrato"></div>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label"><i18n:message key="solicitacaoServico.solicitante"/></label>
											<div class="controls">
												<div id="solicitante"></div>
											</div>
										</div>
										<div class="control-group row-fluid">
											<label class="control-label"><i18n:message key="solicitacaoServico.telefoneDoContato"/></label>
											<div class="controls">
									...
									<div class='span6'>
										<div class="control-group">
											<label class="control-label"><i18n:message key="origemAtendimento.origem"/></label>
											<div class="controls">
												<div id="origem"></div>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label"><i18n:message key="solicitacaoServico.emailContato"/></label>
											<div class="controls">
								...
								<div class="control-group row-fluid">
									<label class="control-label"><i18n:message key="solicitacaoServico.tipo"/> </label>
									<div class="controls">
								...
								<div class='row-fluid'>
									<div class="span6">
										<label class="control-label"><i18n:message key="servico.nome"/></label>
										<div class="controls">
								...
								<div class="control-group row-fluid">
									<label class='control-label'><i18n:message key="solicitacaoServico.descricao"/></label>
									<div class="controls">
						...
						<div id='divBotoes'>
							...
							<button type="button" data-dismiss="modal" class="btn  btn-primary required " onclick='salvar();' id="btGravar"><i18n:message key="citcorpore.comum.gravar" /></button>
						</div>
					</div>
				</div>
				<!--  Fim conteudo-->
