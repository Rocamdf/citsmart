		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$("#btAnexos").click(function() {
					...
					//document.formAnexos.fireEvent("restore");
...
/* 
				...
				$("#btRelacionarSolicitacaoFechar").click(function() {
 				...
 				$("#btErroConhecido").click(function() {
 					//dialog tratado pelo PopupManager.js
 					$("#popupCadastroRapido").dialog({height : $(window).height()-100,width :"90%"});
 					popupBarraFerramenta.titulo = "<i18n:message key='categoriaProblema.consultaAErrosConhecidos' />";
	...
	<body>
		...
		<input type="hidden" id="idRequisicaoProblema" />		<!-- value="1"  -->
		<div align="center" id="barraFerramentasProblemas">
			<ul class="menu_horizontal">
				...
				<li style="cursor: pointer;" class="li_menu tooltip_bottom" id="btErroConhecido" title='<i18n:message key="baseConhecimento.erroConhecido" />'>
					<img src="<%= br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO") %>/template_new/images/icons/small/grey/note_book.png" >
					<div class="name"><i18n:message key="baseConhecimento.erroConhecido" /></div>
				</li>
...
<!-- 				</li> -->
		...
		<div id="POPUP_menuAnexos" class="POPUP_UPLOADREQUISICAOPROBLEMA" title="<i18n:message key="citcorpore.comum.anexos" />(s)" style="display:none">
			<form name='formUploadRequisicaoProblema' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/uploadRequisicaoProblema/uploadRequisicaoProblema' enctype="multipart/form-data">
		...
		<div class="POPUP_barraFerramentasProblemas" id="POPUP_menuOcorrencias" title="<i18n:message key='citcorpore.comum.ocorrencia' />">		
			<!-- Conteudo -->
				...
				<div class="box grid_16 tabs">
					...
					<div class="toggle_container">
						<form name="formOcorrenciaProblema" method="post" 
							action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/ocorrenciaProblema/ocorrenciaProblema">
							...
							<div id="tabs-2" class="block">
								<div class="section">
									...
									<div class="columns clearfix">
										<div class="col_20">
											<fieldset>
												<label class="campoObrigatorio"><i18n:message key="ocorrenciaProblema.tempoGasto" /></label>
												<div>
										...
										<div class="col_50">
											<fieldset>
												<label class="campoObrigatorio"><i18n:message key="ocorrenciaProblema.registradopor" /></label>
												<div>
