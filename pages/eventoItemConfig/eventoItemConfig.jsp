...
// 		}
	...
	function addLinhaTabelaGrupoItemConfig(id, desc, valida) {
		...
		contGrupo++;
		coluna.innerHTML = '<img id="imgDelGrupo' + contGrupo + '" style="cursor: pointer;" title="Clique para excluir o grupo!" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="removeLinhaTabela(\'tblGrupo\', this.parentNode.parentNode.rowIndex);">';
	...
	function addLinhaTabelaItemConfig(id, desc, valida) {
		...
		var coluna = row.insertCell(0);
		contIConfig++;
		coluna.innerHTML = '<img id="imgDelItemConfig' + contIConfig + '" style="cursor: pointer;" title="Clique para excluir o item de configuração!" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="removeLinhaTabela(\'tblIConfig\', this.parentNode.parentNode.rowIndex);">';
		coluna = row.insertCell(1);
	...
	function alteraLinhaTabela(idTabela, rowIndex, hiddenIndex){
		...
		if (eval('document.getElementById("comandoLinux' + hiddenIndex + '").value') != '') {
			document.form.eLinux.checked = true;
	    	mostrarDivLinux();
			document.form.linhaComandoLinux.value = eval('document.getElementById("comandoLinux' + hiddenIndex + '").value');
		}
	...
	function addItemConfig() {
		...
		var coluna = row.insertCell(0);
		contItemConfig++;
		coluna.innerHTML = '<img id="imgAltItemConfig' + contItemConfig + '" style="cursor: pointer;" title="Clique para alterar o item de configuração!" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/edit.png" onclick="alteraLinhaTabela(\'tblItemConfig\', this.parentNode.parentNode.rowIndex, ' + contItemConfig + ');">';
		coluna = row.insertCell(1);
		coluna.innerHTML = '<img id="imgDelItemConfig' + contItemConfig + '" style="cursor: pointer;" title="Clique para excluir o item de configuração!" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="removeLinhaTabela(\'tblItemConfig\', this.parentNode.parentNode.rowIndex);">';
...
<body>
	...
	<div class="flat_area grid_16">
		<h2><i18n:message key="eventoItemConfiguracao.eventos" /></h2>						
	</div>
	
	<div class="box grid_16 tabs">
		<ul class="tab_header clearfix">
			<li>
				<a href="#tabs-1"><i18n:message key="eventoItemConfiguracao.cadastro" /></a>
			</li>
			<li>
				<a href="#tabs-2" class="round_top"><i18n:message key="eventoItemConfiguracao.pesquisa" /></a>
			</li>
		</ul>
	...
	<div class="section">											
	<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/eventoItemConfig/eventoItemConfig'>
	<div class="columns clearfix">
		...
		<div class="col_66">
			<fieldset>
				...
				<div>
					<input type='text' id="descricao" name="descricao" maxlength="100" class="Valid[Required] Description[citcorpore.comum.descricao]" />
				</div>
			</fieldset>
		</div>
		<div class="col_33">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.ligarMaquina" /></label>
				<div class="inline clearfix">
					<label><input type='radio' id="ligarCasoDesl" name="ligarCasoDesl" value="S" class="Valid[Required] Description[eventoItemConfiguracao.ligarMaquina]" /><i18n:message key="eventoItemConfiguracao.ligarMaquinaSim" /></label>
					<label><input type='radio' id="ligarCasoDesl" name="ligarCasoDesl" value="N" class="Valid[Required] Description[eventoItemConfiguracao.ligarMaquina]" /><i18n:message key="eventoItemConfiguracao.ligarMaquinaNao" /></label>
				</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="columns clearfix">
		<div class="col_50">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.usuario" /></label>
				<div>
					<input type='text' id="usuario" name="usuario" maxlength="100" class="Valid[Required] Description[eventoItemConfiguracao.usuario]" />
				</div>
			</fieldset>
		</div>
		<div class="col_50">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.senha" /></label>
				<div>
					<input type="password" id="senha" name="senha" maxlength="100" class="Valid[Required] Description[eventoItemConfiguracao.senha]" />
				</div>
			</fieldset>
		</div>
	</div>
	
	<h2 class="section"><i18n:message key="eventoItemConfiguracao.alvos" /></h2>
	
	<div class="columns clearfix">
		<div class="col_100">
			<fieldset>
				<label class="campoObrigatorio" id="addGrupoItemConfig" style="cursor: pointer;" title="Clique para adicionar um grupo de item de configuração!"><i18n:message key="eventoItemConfiguracao.grupo" /><img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"></label>
				<div>
					<table class="table" id="tblGrupo" style="display: none;">
						<tr>
							<th style="width: 1%;"></th>
							<th style="width: 99%;"><i18n:message key="eventoItemConfiguracao.grupos" /></th>
						</tr>
					</table>
				</div>
			</fieldset>
	...
	<div class="columns clearfix">
		<div class="col_100">
			<fieldset>
				<label class="campoObrigatorio" id="addItemConfig" style="cursor: pointer;" title="Clique para adicionar um item de configuração!"><i18n:message key="eventoItemConfiguracao.itensConfiguracao" /><img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"></label>
				<div>
					<table class="table" id="tblIConfig" style="display: none;">
						<tr>
							<th style="width: 1%;"></th>
							<th style="width: 99%;"><i18n:message key="eventoItemConfiguracao.itensConfiguracao" /></th>
						</tr>
					</table>
				</div>
			</fieldset>
	...
	<h2 class="section"><i18n:message key="eventoItemConfiguracao.itensExecucao"/></h2>
	
	<div class="columns clearfix">
		<div class="col_33">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.tipoExecucao"/></label>
				<div class="inline clearfix">
					<label><input type='radio' id="tipoExec" name="tipoExec" value="I" onchange="limpaCamposItemConfig(this);" /><i18n:message key="eventoItemConfiguracao.instalacao"/></label>
					<label><input type='radio' id="tipoExec" name="tipoExec" value="D" onchange="limpaCamposItemConfig(this);" /><i18n:message key="eventoItemConfiguracao.desinstalacao"/></label>
		...
		<div class="col_66">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.identificacao"/></label>
				<div>
	...
	<div class="columns clearfix">
		<div class="col_33">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.gerarQuando"/></label>
				<div class="inline clearfix">
					<label><input type="radio" id="gerarQuando" name="gerarQuando" value="A" onchange="camposDisabled(false);" /><i18n:message key="eventoItemConfiguracao.agora"/></label>
					<label><input type="radio" id="gerarQuando" name="gerarQuando" value="F" onchange="camposDisabled(true);" /><i18n:message key="eventoItemConfiguracao.dataFutura"/></label>
				</div>
			</fieldset>
		</div>
		<div class="col_33">
			<fieldset>
				<label><i18n:message key="eventoItemConfiguracao.data"/></label>
				<div>
		...
		<div class="col_33">
			<fieldset>
				<label><i18n:message key="eventoItemConfiguracao.hora"/></label>
				<div>
	...
	<div class="columns clearfix">
		...
		<div class="col_33">
			<fieldset>
				<label ><i18n:message key="eventoItemConfiguracao.linhaComando"/></label>
				<div class="inline clearfix">
					<label><input type="checkbox" id="eLinux" name="eLinux" onclick="verificarComandoLinux(event)" /><i18n:message key="eventoItemConfiguracao.eLinux"/></label>
				</div>
			</fieldset>
		</div>
		<div class="col_33" id="divComandoLinux" style="display: none;">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.linhaComandoLinux"/></label>
				<div>
					<input type='text' id="linhaComandoLinux" name="linhaComandoLinux" maxlength="200" title="Linha de comando que virá antes do nome do arquivo de instalação no Linux" />
				</div>
			</fieldset>
		</div>
		<div class="col_66" id="divComando">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.linhaComando"/></label>
				<div>
	...
	<button type='button' id="btnAdicionar" name='btnAdicionar' class="light" onclick="addItemConfig()">
		<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/computer_imac.png">
		<span><i18n:message key="eventoItemConfiguracao.adicionar"/></span>
	</button>
	...
	<div class="columns clearfix" id="dvItemConfig" style="display: none;">
		<div class="col_100">
			<fieldset>
			<label><i18n:message key="eventoItemConfiguracao.itensAdicionados"/></label>
				<div>
				<table class="table" id="tblItemConfig">
					<tr>
						<th style="width: 1%;"></th>
						<th style="width: 1%;"></th>
						<th style="width: 12%;"><i18n:message key="eventoItemConfiguracao.tipoExecucao"/></th>
						<th style="width: 25%;"><i18n:message key="eventoItemConfiguracao.identificacao"/></th>
						<th style="width: 8%;"><i18n:message key="eventoItemConfiguracao.gerarQuando"/></th>
						<th style="width: 7%;"><i18n:message key="eventoItemConfiguracao.data"/></th>
						<th style="width: 6%;"><i18n:message key="eventoItemConfiguracao.hora"/></th>
						<th style="width: 20%;"><i18n:message key="eventoItemConfiguracao.linhaComando"/></th>
						<th style="width: 20%;"><i18n:message key="eventoItemConfiguracao.linhaComandoLinux"/></th>
					</tr>
				</table>
				</div>
			</fieldset>
