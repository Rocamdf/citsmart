...
<body>
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="relatorioRetorno.quantidadeSolicitacoesRetorno" /></a></li>
				</ul>
				...
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/relatorioQuantitativoRetorno/relatorioQuantitativoRetorno'>
	...
	<div id="POPUP_USUARIO" title="<i18n:message key="citcorpore.comum.pesquisacolaborador" />" style="height:40%;">
		<div class="box grid_16 tabs">
			<div class="toggle_container">
