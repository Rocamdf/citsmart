...
<!-- Conteudo -->
	...
	<a href="#" class="toggle">&nbsp;</a>
					...
					<div id="tabs-1" class="block">
						<div class="section">											
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/admissaoEmpregado/admissaoEmpregado'>
							<div class="columns clearfix">
								...
								<div  class="col_25">
									<fieldset style="height: 70px;">
										<label class="campoNaoObrigatorio"><i18n:message key="colaborador.tipoColaborador"/></label>
						       ...
						       <div id="informacaoPagamento" class="columns clearfix">
						        <div class="col_33">  
						        <fieldset style="height: 70px;">
									<label ><i18n:message key="colaborador.valorSalario"/>(R$)</label>
										<div>
								...
								<div class="col_33">
								<fieldset style="height: 70px;">
									<label ><i18n:message key="colaborador.valorProdutividadeMedia"/>(R$)</label>
										<div>
								...
								<div class="col_33">
						        <fieldset style="height: 70px;">
									<label ><i18n:message key="colaborador.valorPlanoSaude"/>(R$)</label>
										<div>
								...
								<div class="col_33">
								<fieldset style="height: 70px;">
									<label ><i18n:message key="colaborador.valorValeTransporte"/>(R$)</label>
										<div>
								...
								<div class="col_33">
								<fieldset style="height: 70px;">
									<label ><i18n:message key="colaborador.valorValeRefeicaoAlim"/>(R$)</label>
										<div>
								...
								<div class="col_33">
								<fieldset style="height: 70px;">
									<label><i18n:message key="colaborador.custoHora"/>(R$)</label>
										<div>
	...
	<div id="POPUP_ENTREVISTAS_NAO_ADMITIDAS" title="<i18n:message key="citcorpore.comum.pesquisa" />">
        <div class="box grid_16 tabs">
            <div class="toggle_container">
