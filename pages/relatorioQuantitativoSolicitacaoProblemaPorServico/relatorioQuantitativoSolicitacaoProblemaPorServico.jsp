	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2><i18n:message key="relatorioQuantitativoSolicitacaoProblemaPorServico.relatorioQuantitativoSolicitacaoProblemaPorServico"/></h2>						
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="relatorioQuantitativoSolicitacaoProblemaPorServico.relatorioQuantitativoSolicitacaoProblemaPorServico" /></a></li>
				</ul>
				<a href="#" class="toggle">&nbsp;</a>
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name="form" action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/relatorioQuantitativoSolicitacaoProblemaPorServico/relatorioQuantitativoSolicitacaoProblemaPorServico">
