		...
		<div id="wrapper">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">
					<h2><i18n:message key="itemConfiguracao.itemConfiguracao"/></h2>						
				</div>
				
				<div class="box grid_16 tabs">
					<ul class="tab_header clearfix">
						<li>
							<a href="#tabs-1"><i18n:message key="itemConfiguracao.cadastro"/></a>
						</li>
						<li>
							<a href="#tabs-2" class="round_top"><i18n:message key="itemConfiguracao.pesquisa"/></a>
						</li>
					</ul>				
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">											
								<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/itemConfiguracao/itemConfiguracao'>
									<div class="columns clearfix">
										...
										<div class="col_33">				
											<fieldset>
											<label ><i18n:message key="itemConfiguracao.opcao" /></label>
											<div style="height: 35px"  class="inline clearfix">
												<label>
												<input type="radio" checked="checked" id="opcaoItemConfiguracaoPai" value="1" name="opcao" onclick="limpar(); ocultarItemConfiguracao(); " /><i18n:message  key="itemConfiguracao.itemConfiguracaoPai" /></label> 
												<label>
												<input type="radio" id="opcaoItemConfiguracaoFilho" name="opcao" value="2" onclick="limpar();visualizarItemConfiguracaoPai()" /><i18n:message key="itemConfiguracao.itemConfiguracaoFilho" /></label>
											</div>
											</fieldset>
										</div>
										<div class="col_16">				
											<fieldset>
												<label class="campoObrigatorio"><i18n:message key="itemConfiguracao.itemConfiguracao"/></label>
													<div>
											...
											<fieldset>
													<label>Grupo:</label>
														<div>
															...
															<img onclick="consultarGrupoItemConfiguracao()" style=" vertical-align: middle;" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/magnifying_glass.png">
														</div>
												</fieldset>
										</div>
									</div>
									<div id="divItemConfiguracaoPai" class="col_25">
											<fieldset>
												<label class="campoObrigatorio"><i18n:message key="itemConfiguracao.itemConfiguracaoPai" /></label>
										...
										<div id="gridCaracteristica" class="columns clearfix" style="display: none;">
											<table class="table" id="tabelaCaracteristica" style="width: 100%">
												<tr>
													...
													<th style="width: 30%;"><i18n:message key="citcorpore.comum.caracteristica"/></th>
										...
										<div class="columns clearfix">
											<div class="col_100" style="padding-left: 20px; padding-top: 10px;">
												<button id="addCaracteristica" type='button' name='botaoCaracteristica' class="light">
													...
													<span><i18n:message key="citcorpore.comum.caracteristica"/></span>
												</button>
