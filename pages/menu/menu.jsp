						...
						<div class="innerLR">
							<div class="widget">
								<div class="widget-head">
									<h4 class="heading"><i18n:message key="menu.menu"/></h4>
								</div>
								<div class="widget-body collapse in">		
									<div class="tabsbar">
										<ul>
											<li class="active"><a href="#tab1-3" data-toggle="tab"><i18n:message key="menu.cadastroMenu"/></a></li>
											<li><a href="#tab2-3" data-toggle="tab" ><i18n:message key="menu.pesquisaMenu"/></a></li>
										</ul>
									</div>
									<div class="tab-content">
										<div class="tab-pane active" id="tab1-3">
											<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/menu/menu'>
													...
													<div class='span12'>
														<div class='row-fluid'>
															<div class='span6'>
																...
																<input id="nome" name="nome" type='text' maxlength="80" class="span12 Valid[Required] Description[citcorpore.comum.nome]" />
															</div>
															<div class='span6'>
																<label class="campoObrigatorio"><i18n:message key="citcorpore.comum.descricao" /></label>
																<input id="descricao" type="text" name="descricao" maxlength="50" class="span12 Valid[Required] Description[citcorpore.comum.descricao]" />
															</div>
														</div>
													</div>
												</div>
												<div class='row-fluid'>
													<div class='span12'>
														<div class='row-fluid'>
															<div class='span4'>
																<label> <i18n:message key="menu.menuPai" /></label>
															...
															<div class='span4'>
																...
																<input id="link" type="text" name="link" maxlength="255" class="span12 Description[menu.link]" />
															</div>
															<div class='span4'>
													...
													<div class='span12'>
														<div class="uniformjs">
															<label class="checkbox">
																...
																<i18n:message key="menu.menuRapido"/>
															</label>
														</div>
													</div>
												</div>	
