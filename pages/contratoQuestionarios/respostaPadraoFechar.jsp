...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<script>
			function emitir(){
				document.formImprimirForm.action='<%=Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/contratoQuestionarios/contratoQuestionarios';
				...
				document.formImprimirForm.action='<%=Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/contratoQuestionarios/contratoQuestionarios.event';
		...
		<form name='formImprimirForm' method="POST" action="<%=Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/ASO/ASO">
