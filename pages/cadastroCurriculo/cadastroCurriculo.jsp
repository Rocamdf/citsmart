...
<%@include file="/include/security/security.jsp" %>
	...
	<script>
	    ...
	    function gerarImgFicha(row, obj) {
            row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/documents.png" onclick="abrePopup('+obj.idCurriculo+','+obj.idTriagem+', \'RH\')"/>'
            row.cells[1].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/cracha.png" onclick="abrePopupCurriculo()"/>';
    	}
	    
	    function abrePopup(idCurriculo, idTriagem, tipoEntrevista) {
	    	document.getElementById('fichaEntrevista').src = '<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/entrevistaCandidato/entrevistaCandidato.load?idCurriculo=' + idCurriculo + '&idTriagem=' + idTriagem + '&tipoEntrevista=' + tipoEntrevista;
	  ...
	  //--------------------------------------- TELEFONE ---------------------------------------
     	marcaTelefone = function(row, obj){
			if (row.cells[0].innerHTML != '' && row.cells[0].innerHTML != '&nbsp;'){
				...
				HTMLUtils.setValueColumnTable('tblTelefones', '&nbsp;', 1, null, 0);
				row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/excluirPeq.gif" border="0"/>';
			}		
		};
		...
		addEmail = function(){
			...
			if (document.getElementById('email#principal').checked){
				...
				obj.imagemEmailPrincipal = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/ok.png" border="0"/>';
				obj.principal = 'S';
			}else{
		...
		addEndereco = function(){
			...
			if (document.getElementById('endereco#correspondencia').checked){
				HTMLUtils.setValueColumnTable('tblEnderecos', '&nbsp;', 1, null, 1);
				...
				obj.correspondencia = 'S';
				obj.imagemEnderecoCorrespondencia = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/accept.png" border="0"/>';
			}else{
				obj.imagemEnderecoCorrespondencia = '';
				obj.correspondencia = 'N';
			}
			...
			HTMLUtils.addRow('tblEnderecos', document.form, 'endereco', obj, ['', 'imagemEnderecoCorrespondencia', 'descricaoTipoEndereco', 'detalhamentoEndereco'], null, '', null, marcaEndereco, null, false);
		...
		atuEndereco = function(){
			...
			if (document.getElementById('endereco#correspondencia').checked){
				...
				obj.correspondencia = 'S';
				obj.imagemEnderecoCorrespondencia = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/ok.png" border="0"/>';
			}else{
				obj.correspondencia = '';
				obj.imagemEnderecoCorrespondencia = '';
			}
			...
			HTMLUtils.updateRow('tblEnderecos', document.form, 'endereco', obj, ['', 'imagemEnderecoCorrespondencia', 'descricaoTipoEndereco', 'detalhamentoEndereco'], null, '', null, marcaEndereco, null, index, false);
		...
		marcaEndereco = function(row, obj){
			if (row.cells[0].innerHTML != '' && row.cells[0].innerHTML != '&nbsp;'){
				...
				HTMLUtils.setValueColumnTable('tblEnderecos', '&nbsp;', 1, null, 0);
				row.cells[0].innerHTML = '<img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/excluirPeq.gif" border="0"/>';
				HTMLUtils.setValues(document.form, 'endereco', obj);	
				if (obj.correspondencia == 'S'){
					document.getElementById('endereco#correspondencia').checked = true;
				}else{
					document.getElementById('endereco#correspondencia').checked = false;
				}
...
<!-- Conteudo -->
	<div id="main_container" class="main_container container_16 clearfix">
		...
		<div class="flat_area grid_16">
				<h2><i18n:message key="curriculo.cadastroCurriculo"/></h2>						
		</div>
		<div class="box grid_16 tabs">
			<ul class="tab_header clearfix">
				<li>
					<a href="#tabs-1"><i18n:message key="curriculo.cadastroCurriculo"/></a>
				</li>
				<li><a href="#tabs-2" class="round_top"><i18n:message key="curriculo.pesquisa" />
				</a></li>
			</ul>				
			...
			<div class="toggle_container">
			    <div id="tabs-1" class="block">
				   <div class="section">										
						<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/cadastroCurriculo/cadastroCurriculo'>
				        	...
				        	<div class="col_100">
				        		<div class="col_80">
				        	 		<div class="col_100">				        		
						        	    <div class="col_15">
						        	         <fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="CPF" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_66">
						        	         <fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Nome" /></label>
						                         <div>
							        	 ...
							        	 <div class="col_15">
						        	         <fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Data de nascimento" /></label>
						                         <div>
				        	 		...
				        	 		<div class="col_100">				        		
						        	    <div class="col_15">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Sexo" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_20">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Estado Civil" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_16">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Possui filho(s)" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_15" id="divFilhos" style="display: none;">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Quantos" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_30">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Naturalidade" /></label>
						                         <div>
						        	 ...
						        	 <div class="col_100">
						        	    <div class="col_40">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Cidade Natal" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_33">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Portador de necessidades especiais" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_20" id="divDeficiencias" style="display: none;">
						        	    	<fieldset style="height: 70px;">
						                         <label class="campoObrigatorio"><i18n:message key="Qual" /></label>
						                         <div>
				        	 ...
				        	 <div class="col_100">
				        	 	<div class="col_33">
				        	 	  <fieldset style="height: auto; border: solid 1px #ccc">
				  					<label class="campoObrigatorio" style='font-size:16px'><i18n:message key="Email's" /></label>
				  					<table style="width: 100%;">
				  						...
				  						<tr>
				  							...
				  							<td>
				  							   <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"  onclick='addEmail();' style="cursor: pointer;" />
				  							</td>
				  							<td>
				  							   <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png"  onclick='excluirEmail();' style="cursor: pointer;" />
				  							</td>												  							
				  						</tr>
				  					</table>
				  				</fieldset>
								...
								<div class="col_33">
								  <fieldset style="height: 250px;">
				  					<label class="campoObrigatorio" style='font-size:16px'><i18n:message key="Telefones" /></label>
				  					<table style="width: 100%;">
				  						<tr>
				  							<td class="campoEsquerdaSemTamanho">
				  								Tipo:
				  						...
				  						<tr>
				  							...
				  							<td>
				  							   <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"  onclick='addTelefone();' style="cursor: pointer;" />
				  							</td><td>
				  							   <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png"  onclick='excluirTelefone();' style="cursor: pointer;" />
				  							</td>												  							
				  						</tr>
				  					</table>
				  				</fieldset>
				        	 	...
				        	 	<div class="col_33">
				        	 	  <fieldset style="height: 250px;">
				  					<label style='font-size:16px'><i18n:message key="Certificações" /></label>
				  					<table style="width: 100%;">
					  						<tr>
					  							<td class="campoEsquerdaSemTamanho">
					  								Descrição:
					  						...
					  						<tr>
					  							...
					  							<td>
				  							       <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"  onclick='addCertificacao();' style="cursor: pointer;" />
				  							    </td>	
				  							    <td>
				  							       <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png"  onclick='excluirCertificacao();' style="cursor: pointer;" />
				  							    </td>										  							
					  						</tr>
					  					</table>
					  				</fieldset>
				        	 ...
				        	 <div class="col_100">
				        	    <div class="col_33">
				        	       <fieldset style="height: 430px;">
				  					<label class="campoObrigatorio" style='font-size:16px'><i18n:message key="Endereços" /></label>
				  					<table style="width: 100%;">
				 						<tr>
				 							<td class="campoEsquerdaSemTamanho">
				 								Tipo de Endereço:
				 						...
				 						<tr>
				 							<td>
				 							  ...
				 							  <td>
				 								 <input type='checkbox' name='endereco#correspondencia' value="S"/>Endereço de correspondência ?
				 							  </td>
				 						</tr>											  						
				 						<tr>
				 							<td class="campoEsquerdaSemTamanho">
				 						...
				 						<tr>
											...
											<td>
				  							   <div id='divAdd'>
				  							     <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"  onclick='addEndereco();' style="cursor: pointer;" />
				  							   </div>
				  							   <div id='divAltera' style='display:none;'>
				  							   	 <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/refresh.png"  onclick='atuEndereco();' style="cursor: pointer;" />
				  							   </div>
				  							</td>
				  							<td>
				  							    <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png"  onclick='excluirEndereco();' style="cursor: pointer;" />
				  							</td>
				 						</tr>										  																  																	  						
				 					</table>
				 				</fieldset>
				    			...
				    			<div class="col_33">
				    				<fieldset style="height: 430px;">
				  					<label  style='font-size:16px'><i18n:message key="Idiomas" /></label>
				  					<table style="width: 100%;" width='100%'>
				  						...
				  						<tr>
				  							...
				  							<td>
				  							   <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"  onclick='addIdioma();' style="cursor: pointer;" />
				  							</td>
				  							<td>
				  							   <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png"  onclick='excluirIdioma();' style="cursor: pointer;" />
				  							</td>												  							
				  						</tr>
				  					</table>
				  				</fieldset>
				             	...
				             	<div class="col_33">
				             		<fieldset style="height: 430px;">
				  					<label class="campoObrigatorio" style='font-size:16px'><i18n:message key="Formação" /></label>
				  					<table style="width: 100%;">
					  						<tr>
					  							<td class="campoEsquerdaSemTamanho">
					  								Formação:*
					  						...
					  						<tr>
					  						   ...
					  						   <tr>
					  							...
					  							<td>
				  							      <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"  onclick='addFormacao();' style="cursor: pointer;" />
				  							    </td>
				  							    <td>
				  							       <img src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png"  onclick='excluirFormacao();' style="cursor: pointer;" />
				  							    </td>
					  						</tr>							  																  																	  						
					  					</table>
					  				</fieldset>
				             ...
				             <div class="col_100">
				               <fieldset style="height: 130px;">
				             	<label><i18n:message key="entrevista.observacoes" /></label>
		             		...
		             		<div class="col_66">
								<div class="col_100">
										<fieldset>
										    <label  style='font-size:16px'><i18n:message key="Currículo"/></label>	
		    			...
		    			<div id="POPUP_FOTO" title="<i18n:message key="citcorpore.comum.pesquisa" />">
