				...
				<div class="box grid_16 tabs">
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">		
								<form name="form" action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/templateImpressao/templateImpressao'>
									<div class="columns clearfix">
										...
										<div class="columns clearfix">
											<div class="col_100">				
												<fieldset>
													<label><i18n:message key="templateProjeto.cabecalho"/></label>
														<div>
										...
										<div class="columns clearfix">
											<div class="col_100">				
												<fieldset>
													<label><i18n:message key="templateProjeto.corpo"/></label>
														<div>
										...
										<div class="columns clearfix">
											<div class="col_100">				
												<fieldset>
													<label><i18n:message key="templateProjeto.rodape"/></label>
														<div>
										...
										<div class="columns clearfix">
											<div class="col_50">				
												<fieldset>
													<label><i18n:message key="templateProjeto.tamanhoCabecalho"/></label>
														<div>
											...
											<div class="col_50">				
												<fieldset>
													<label><i18n:message key="templateProjeto.tamanhoRodape"/></label>
														<div>
