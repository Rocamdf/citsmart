					...
					<div class="box-generic">
						...
						<div class="row-fluid">
							<div class='span4'>
								...
								<select name='tipoContratacao' class="Valid[Required] Description[Tipo de contratação]" disabled="disabled"></select>
							</div>
							<div class='span4'>
								<label ><i18n:message key="requisicaoPessoal.motivoContratacao" /></label>
								<select name='motivoContratacao' class="Valid[Required] Description[Tipo de contratação]" disabled="disabled">
                               	      <option value=''><i18n:message key="citcorpore.comum.selecione" /></option>
						...
						<div class="row-fluid">
							<div class='span4'>
								<label ><i18n:message key="Lotação" /></label>
								<select name='idUnidade' class="Valid[Required] Description[Lotação]" disabled="disabled"></select>
							</div>
							<div class='span4'>
