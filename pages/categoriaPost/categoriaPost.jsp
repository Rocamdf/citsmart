	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="categoriaPost.cadastroCategoriaPost" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message	key="categoriaPost.categoriaPost" /></a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="categoriaPost.pesquisaCategoriaPost" />	</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/categoriaPost/categoriaPost'>
								<div class="columns clearfix">
									...
									<div class="col_66">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="categoriaPost.nomeCategoria" /></label>
											<div>
									...
									<div class="col_66">
										<fieldset style="height: 61px">
											<label><i18n:message key="categoriaPost.categoriaPostPai" /></label>
											<div>
