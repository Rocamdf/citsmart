...
/* Não retirar porque em algumas telas fica faltando esta configuração */
 #modal_Telefonia{
...
<script>
		...
		/**
		* Motivo: Depois de adicionado a url o parametro 'modalAsterisk=true' o callback da solicitação chama a função abaixo
		* Autor: flavio.santana
		* Data/Hora: 11/12/2013 10:00
		**/
		function fecharModalSolicitacaoAsterisk() {
			 /**
			* Motivo: Fecha o modal telefonia em qualquer das circunstâncias
			* Autor: flavio.santana
			* Data/Hora: 11/12/2013 10:00
			**/
