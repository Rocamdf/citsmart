	...
	<div id="corpo" >
		<div id="page" class="hidden">
			<form id="form" name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/pesquisaSatisfacao/pesquisaSatisfacao'>
				...
				<ul class="menu">
		    		<li <% if (locale.equalsIgnoreCase("")) { %> class="active" <% } %> onclick="internacionalizar('');return false;"><a href="" title="Portugues" ><img onclick="internacionalizar('');return false;" src="../../novoLayout/common/theme/images/lang/br.png" alt="Portugues"> Português BR</a></li>
