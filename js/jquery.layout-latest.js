...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	,	spacing_open:			13			// space between pane and adjacent panes - when pane is 'open'
	...
	,	liveContentResizing:	true		// true = re-measure header/footer heights as resizer is dragged
	,	liveResizingTolerance:	100			// how many px change before pane resizes, to control performance
	//	SLIDING OPTIONS
	...
	,	preventPrematureSlideClose: true	// handle incorrect mouseleave trigger, like when over a SELECT-list in IE
	...
	,	fxSpeed:				1200		// slow, normal, fast, 200, nnn - if passed, will OVERRIDE fxSettings.duration
