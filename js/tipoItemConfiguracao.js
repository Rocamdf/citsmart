...
function insereRow(id, desc) {
	...
	coluna.innerHTML = '<img id="imgExcluiCaracteristica'
			+ countCaracteristica
			+ '" style="cursor: pointer;" title="Excluir Característica!" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="removeLinhaTabela(\'tabelaCaracteristica\', this.parentNode.parentNode.rowIndex);">';
