var MONTH_NAMES=new Array('Janeiro','Fevereiro','Março','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro','Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez');var DAY_NAMES=new Array('Domingo','Segunda','Terça','Quarta','Quinta','Sexta','Sabado','Dom','Seg','Ter','Qua','Qui','Sex','Sab');function LZ(x){return(x<0||x>9?"":"0")+x}
...
if(hora.length!=5){alert('Formato de hora inválido (hh:mm)');return false;}
var h=hora.substring(0,2);var m=hora.substring(3,5);if(h>23||h<0){alert('Hora inválida(de 00 a 23)');return false;}
if(m>59||m<0){alert('Minuto inválido(de 00 a 59)');return false;}
return true;}
