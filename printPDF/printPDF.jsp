...
<%@page import="br.com.citframework.util.Constantes"%><html>
		...
		<tr>
			<td width="100%">
				<input type='button' style="background-color: #ffff00" name='btnRecarregar' value='Caso não seja apresentado o documento, clique aqui para recarregar o documento'
						onclick='recarrega();'/>
				<input type='button' style='color: #444; font-weight: bold; background: url("<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/fecharLookup.gif") no-repeat scroll top left' name='btnFechar' value='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fechar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
						onclick='fechar();'/>
			</td>
		</tr>
		<tr>
