!function($) {
    ...
    Selectpicker.prototype = {
            ...
            var template =
                "<div class='btn-group bootstrap-select'>" +
                    "<button class='btn dropdown-toggle clearfix' data-toggle='dropdown'>" +
                        "<span class='filter-option pull-left'>"+ i18n_message("citcorpore.comum.selecione") +"</span>&nbsp;" +
        ...
        createLi: function(template) {
            ...
            if (_li.length > 0) {
                template = template.replace(i18n_message('citcorpore.comum.selecione'), _li[_selected_index]);
                for (var i = 0; i < _li.length; i++) {
