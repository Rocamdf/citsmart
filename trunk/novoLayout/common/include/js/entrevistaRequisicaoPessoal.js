 ...
 **/
	function incluirCurriculo(curriculoStr) {
	    ...
	    triagem.strDetalhamento += '<label><b><i18n:message key="citcorpore.comum.dataNascimento"/>:</b>&nbsp;' +curriculo.dataNascimentoStr+ '</label>';
	    triagem.strDetalhamento += '<label><b><i18n:message key="citcorpore.comum.estadoCivil"/>:</b>&nbsp;' +curriculo.estadoCivilExtenso+ '</label>';
