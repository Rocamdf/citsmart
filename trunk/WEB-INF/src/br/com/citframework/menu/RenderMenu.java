...
public class RenderMenu {
	...
	public static String render(Collection colMenus, String contextName) throws Exception{
		...
		StringBuffer sMenuSubNiveis = new StringBuffer("");
	...
	private static String renderItens(MenuItem m, int iItem, ItemController itemController, StringBuffer sMenuSubNiveis, boolean subMenu, String contextName) throws Exception{
		if (m == null) return "";
