...
public class UtilStrings {
	...
	public static String negritaPalavraHtml(String frase,String palavra){
		...
		String result= "";
		StringBuffer tmpAux = new StringBuffer(frase);
		StringBuffer tmpFrase = new StringBuffer(UtilStrings.removeCaracteresEspeciais(frase).toUpperCase()); 
		...
		while(tmpFrase.indexOf(tmpPalavra)>-1){
			...
			tmpFrase = new StringBuffer(tmpFrase.substring(indice+tmpPalavra.length()));
			...
			tmpAux= new StringBuffer(tmpAux.substring(tmpAux.indexOf(wk)+wk.length()));
