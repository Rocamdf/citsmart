...
public class CargoAtitudeIndividualDao extends CrudDaoDefaultImpl {
	
	public CargoAtitudeIndividualDao() {
	...
	public String getTableName() {
		return "RH_CargoAtitudeIndividual";
	}
	...
	public Class getBean() {
		...
		return CargoAtitudeIndividualDTO.class;
	}


    public Collection list() throws Exception {
        List list = new ArrayList();
        list.add(new Order("idAtitudeIndividual"));
