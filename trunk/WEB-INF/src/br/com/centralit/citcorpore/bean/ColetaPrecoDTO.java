...
public class ColetaPrecoDTO implements IDto {
    ...
    private Double prazoMedioPagto;
    ...
    private Double resultPrazoEntrega;
    private Double resultPrazoPagto;
    ...
    public Double getPrazoMedioPagto() {
        return prazoMedioPagto;
    }
    public void setPrazoMedioPagto(Double prazoMedioPagto) {
    ...
    public Double getResultPrazoPagto() {
        return resultPrazoPagto;
    }
    public void setResultPrazoPagto(Double resultPrazoPagto) {
    ...
    public Double getResultPrazoEntrega() {
        return resultPrazoEntrega;
    }
    public void setResultPrazoEntrega(Double resultPrazoEntrega) {
