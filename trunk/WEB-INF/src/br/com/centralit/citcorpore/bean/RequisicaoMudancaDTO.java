...
public class RequisicaoMudancaDTO extends ObjetoNegocioFluxoDTO {
	...
	public void setIdCategoriaMudanca(Integer idCategoriaMudanca) {
		this.idCategoriaMudanca = idCategoriaMudanca;
	}
	 */
	...
	public void setDataHoraConclusao(Timestamp dataHoraConclusao) {
		...
		if(dataHoraConclusao != null){
			...
			this.dataConclusaoStr = fData.format(dataHoraConclusao);
		}
	}
	...
	/**
	 * @param sequenciaMudanca the sequenciaMudanca to set
	 */
	...
	/**
	 * @param nomeCategoriaMudanca the nomeCategoriaMudanca to set
	 */
	...
	/**
	 * @param listRequisicaoMudancaServicoDTO the listRequisicaoMudancaServicoDTO to set
	 */
	...
	/**
	 * @param listRequisicaoMudancaItemConfiguracaoDTO the listRequisicaoMudancaItemConfiguracaoDTO to set
	 */
	...
	/**
	 * @param idGrupoComite the idGrupoComite to set
	 */
	...
	/**
	 * @param listAprovacaoMudancaDTO the listAprovacaoMudancaDTO to set
	 */
	...
	/**
	 * @param enviaEmailGrupoComite the enviaEmailGrupoComite to set
	 */
	...
	/**
	 * @param dataInicioStr the dataInicioStr to set
	 */
	...
	/**
	 * @param dataTerminoStr the dataTerminoStr to set
	 */
	...
	/**
	 * @param dataHoraInicioAgendada the dataHoraInicioAgendada to set
	 */
	...
	/**
	 * @param dataHoraTerminoAgendada the dataHoraTerminoAgendada to set
	 */
	...
	public void setLiberacoesRelacionadosSerializado(
			String liberacoesRelacionadosSerializado) {
	...
	public void setListRequisicaoMudancaLiberacaoDTO(
			List<RequisicaoMudancaLiberacaoDTO> listRequisicaoMudancaLiberacaoDTO) {
	...
	public void setQuantidadeMudancaSemAprovacaoPorPeriodo(
			Integer quantidadeMudancaSemAprovacaoPorPeriodo) {
	...
	public void setListAprovacaoPropostaDTO(
			List<AprovacaoPropostaDTO> listAprovacaoPropostaDTO) {
	...
	public void setListRequisicaoMudancaDTO(
			List<RequisicaoMudancaDTO> listRequisicaoMudancaDTO) {
	...
	public void setListLiberacaoMudancaDTO(
			List<LiberacaoMudancaDTO> listLiberacaoMudancaDTO) {
	...
	public void setColResponsaveis(
			Collection<RequisicaoMudancaResponsavelDTO> colResponsaveis) {
	...
	public void setHiddenDescricaoItemConfiguracao(
			String hiddenDescricaoItemConfiguracao) {
	...
	public void setColUploadPlanoDeReversaoGED(
			Collection colUploadPlanoDeReversaoGED) {
	...
	public void setListGrupoRequisicaoMudancaDTO(
			List<GrupoRequisicaoMudancaDTO> listGrupoRequisicaoMudancaDTO) {
