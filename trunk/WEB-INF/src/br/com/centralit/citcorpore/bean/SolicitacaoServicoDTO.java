...
public class SolicitacaoServicoDTO extends ObjetoNegocioFluxoDTO {
	...
	public void setDataHoraInicioSLA(Timestamp dataHoraInicioSLA) {
		...
		if (dataHoraInicioSLA != null) {
			...
			this.dataHoraInicioSLAStr = format.format(dataHoraInicioSLA);
		}
	}
	...
	public void setDataHoraSolicitacao(Timestamp parm) {
		...
		if (parm != null) {
			SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm");
			this.dataHoraSolicitacaoStr = format.format(dataHoraSolicitacao);
		}
	}
	...
	public void setColItensBaseConhecimento(
			List<BaseConhecimentoDTO> colItensBaseConhecimento) {
