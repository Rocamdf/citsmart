...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("a[id=itemMM1]")).click();
	   	...
	   	js.executeScript("chamaItemMenu('/citsmart/pages/unidade/unidade.load')");
	    ...
	    driver.findElement(By.partialLinkText("Pesquisa de Unidade")).click();
	    driver.findElement(By.id("pesqLockupLOOKUP_UNIDADE_nome")).clear();
	    driver.findElement(By.id("pesqLockupLOOKUP_UNIDADE_nome")).sendKeys("testando");
