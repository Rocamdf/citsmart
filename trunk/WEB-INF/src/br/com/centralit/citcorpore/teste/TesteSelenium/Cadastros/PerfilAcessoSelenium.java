...
public class PerfilAcessoSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("a[id=itemMM1]")).click();
	   	...
	   	js.executeScript("chamaItemMenu('/citsmart/pages/perfilAcesso/perfilAcesso.load')");
	    driver.findElement(By.id("nomePerfilAcesso")).clear();
	    driver.findElement(By.id("nomePerfilAcesso")).sendKeys("testando");
	    driver.findElement(By.id("btnGravar")).click();
	    driver.switchTo().alert().getText().endsWith("Registro inserido com sucesso");
	    Thread.sleep(2000L); 
	    driver.switchTo().alert().accept();
	    driver.findElement(By.partialLinkText("Pesquisa de Perfil de Acesso")).click();
	    driver.findElement(By.id("pesqLockupLOOKUP_PERFILACESSO_nome")).clear();
	    driver.findElement(By.id("pesqLockupLOOKUP_PERFILACESSO_nome")).sendKeys("testando");
