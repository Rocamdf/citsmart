...
public class JustificativaParecerSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
    ...
    driver.findElement(By.cssSelector("a[id=itemMM50]")).click();
   	...
   	js.executeScript("chamaItemMenu('/citsmart/pages/justificativaParecer/justificativaParecer.load')");
    driver.findElement(By.id("descricaoJustificativa")).clear();
    driver.findElement(By.id("descricaoJustificativa")).sendKeys("teste");
    driver.findElement(By.id("aplicavelRequisicao")).click();
    driver.findElement(By.id("aplicavelCotacao")).click();
    driver.findElement(By.id("aplicavelInspecao")).click();
    js.executeScript("document.form.save();");
    driver.switchTo().alert().getText().endsWith("Registro inserido com sucesso");
    Thread.sleep(2000L); 
    driver.switchTo().alert().accept();
    driver.findElement(By.partialLinkText("Pesquisa Justificativa Parecer")).click();
    driver.findElement(By.id("pesqLockupLOOKUP_JUSTIFICATIVAPARECER_descricaoJustificativa")).clear();
    driver.findElement(By.id("pesqLockupLOOKUP_JUSTIFICATIVAPARECER_descricaoJustificativa")).sendKeys("teste");
