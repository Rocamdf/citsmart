...
public class GrupoAtivPeriodicaSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("a[id=itemMM50]")).click();
	   	...
	   	js.executeScript("chamaItemMenu('/citsmart/pages/dinamicViews.load?identificacao=grupoAtividadePeriodica')");
	    driver.findElement(By.id("NOMEGRUPOATVPERIODICA")).clear();
	    driver.findElement(By.id("NOMEGRUPOATVPERIODICA")).sendKeys("teste");
	    ...
	    driver.findElement(By.linkText("Pesquisa Grupo Atividade Períodica")).click();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_17")).clear();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_17")).sendKeys("teste");
	    driver.findElement(By.id("btn_REFRESH_VIEW")).click();
	    driver.findElement(By.cssSelector("div.datagrid-cell.datagrid-cell-c5-NOMEGRUPOATVPERIODICA")).click();
