...
public class JustificativaSolicitacaoSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("a[id=itemMM50]")).click();
	   	...
	   	js.executeScript("chamaItemMenu('/citsmart/pages/dinamicViews.load?identificacao=justificativaSolicitacao')");
	    driver.findElement(By.id("DESCRICAOJUSTIFICATIVA")).clear();
	    driver.findElement(By.id("DESCRICAOJUSTIFICATIVA")).sendKeys("teste");
	    driver.findElement(By.xpath("(//input[@id='SUSPENSAO'])[2]")).click();
	    ...
	    driver.findElement(By.linkText("Pesquisa Justificativa Solicitação")).click();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_18")).clear();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_18")).sendKeys("teste");
	    driver.findElement(By.id("btn_REFRESH_VIEW")).click();
	    driver.findElement(By.cssSelector("div.datagrid-cell.datagrid-cell-c5-DESCRICAOJUSTIFICATIVA")).click();
	    driver.findElement(By.id("btnLimpar")).click();
	    driver.findElement(By.xpath("//div[@id='tabs']/div/div[3]/ul/li[2]/a/span[2]")).click();
	    driver.findElement(By.cssSelector("div.datagrid-cell.datagrid-cell-c5-DESCRICAOJUSTIFICATIVA")).click();
