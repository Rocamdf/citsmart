...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    new Select(driver.findElement(By.id("idJustificativa"))).selectByVisibleText("Aguardando Resposta do Usuário");
	    js.executeScript("gravar();");
	    driver.switchTo().alert().getText().endsWith("Confirma a mudança de SLA");
	    Thread.sleep(2000L); 
