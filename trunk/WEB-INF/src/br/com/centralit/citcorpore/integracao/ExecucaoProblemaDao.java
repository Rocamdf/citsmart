...
public class ExecucaoProblemaDao extends CrudDaoDefaultImpl {
	...
	public ExecucaoProblemaDTO findByIdInstanciaFluxo(Integer idInstanciaFluxo) throws Exception {
	...
	public Collection<ExecucaoProblemaDTO> listByIdProblema(Integer idProblema) throws Exception {
		List condicao = new ArrayList();
	...
	public ExecucaoProblemaDTO findByProblema(ExecucaoProblemaDTO execucaoProblemaDTO) throws Exception {
        List condicao = new ArrayList();
        List ordenacao = new ArrayList();
