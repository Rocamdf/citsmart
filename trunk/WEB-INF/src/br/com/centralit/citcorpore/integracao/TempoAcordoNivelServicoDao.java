...
public class TempoAcordoNivelServicoDao extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = 3296468503680752691L;
	...
	public void deleteByIdAcordo(Integer idAcordoNivelServico) throws Exception {
		List condicao = new ArrayList();
		condicao.add(new Condition("idAcordoNivelServico", "=", idAcordoNivelServico));
		super.deleteByCondition(condicao);
	}

	public Collection findByIdAcordo(Integer idAcordoNivelServico) throws Exception {
		List condicao = new ArrayList();
