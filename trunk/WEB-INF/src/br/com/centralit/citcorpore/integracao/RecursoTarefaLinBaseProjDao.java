...
public class RecursoTarefaLinBaseProjDao extends CrudDaoDefaultImpl {
	...
	public Collection findByIdTarefaLinhaBaseProjetoAndIdEmpregado(Integer parm, Integer idEmpregado) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList(); 
		condicao.add(new Condition("idTarefaLinhaBaseProjeto", "=", parm)); 
	...
	public void deleteByIdLinhaBaseProjeto(Integer idLinhaBaseProjeto) throws Exception {
