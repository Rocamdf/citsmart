...
public class NetMapDao extends CrudDaoDefaultImpl {
	...
	public Collection verificarExistenciaIp(NetMapDTO bean) throws Exception {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Collection listIpByDataInventario(Date dataInventario) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Collection listByDataIp(Date dataInventario, String ip) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
