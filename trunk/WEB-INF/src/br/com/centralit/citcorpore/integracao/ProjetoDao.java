...
public class ProjetoDao extends CrudDaoDefaultImpl {
    ...
    public Collection<ProjetoDTO> findSemPai(Integer idCliente) throws Exception {
        Integer cli = -1;
        if (idCliente != null)
            cli = idCliente;
    ...
    public Collection<ProjetoDTO> findByIdPai(Integer idPai, Integer idCliente) throws Exception {
        List condicao = new ArrayList();
        List ordenacao = new ArrayList(); 
