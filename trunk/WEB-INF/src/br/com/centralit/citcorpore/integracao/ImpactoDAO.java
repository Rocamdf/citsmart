...
public class ImpactoDAO extends CrudDaoDefaultImpl {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2031958484591667181L;
	...
	public List<ImpactoDTO> restoreBySigla(String siglaImpacto) throws Exception{
		List condicao = new ArrayList();
		condicao.add(new Condition("siglaImpacto", "=", siglaImpacto));
		return (List<ImpactoDTO>) super.findByCondition(condicao, null);
	}
	
	public List<ImpactoDTO> restoreByNivel(String nivelImpacto) throws Exception{
		List condicao = new ArrayList();
