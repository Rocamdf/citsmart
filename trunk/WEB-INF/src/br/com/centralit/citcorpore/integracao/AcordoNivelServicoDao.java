...
public class AcordoNivelServicoDao extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = -657489526828512321L;
	 ...
	 * @author rodrigo.oliveira
	 */
	public boolean verificaSeNomeExiste(String tituloSLA) throws Exception {
	 ...
	 * @author euler.ramos
	 */
	public List<AcordoNivelServicoDTO> findByIdAcordoSemVinculacaoDireta(Integer id) throws Exception {
		List resp = new ArrayList();
	 ...
	 * @author euler.ramos
	 */
	public List<AcordoNivelServicoDTO> findByTituloSLA(String titulo) throws Exception {
		List resp = new ArrayList();
	...
	public void updateTemposAcoes(AcordoNivelServicoDTO acordoNivelServicoDTO) throws Exception {
	...
	public void updateNotNull(AcordoNivelServicoDTO acordoNivelServicoDTO) throws Exception {
