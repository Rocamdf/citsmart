...
public class CentreonLogDao extends CrudDaoDefaultImpl {
	...
	public Collection findByHostServiceStatus(String hostName, String serviceName, String status, Date dataInicial, Date dataFinal) throws Exception {
	...
	public Collection findByHostServiceStatusAndServiceNull(String hostName, String status, Date dataInicial, Date dataFinal) throws Exception {
		List parametros = new ArrayList();
		String sql = "select " + this.getNamesFieldsStr() + " from " + this.getTableName() + " ";
		sql = sql + "where 1 = 1 ";
