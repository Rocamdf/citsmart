...
public class ContratoDao extends CrudDaoDefaultImpl {
	...
	/*
	 * public Collection<RelatorioAcompanhamentoDTO> getnumeros() throws Exception{ StringBuffer sql = new StringBuffer(); List listaRetorno = new ArrayList();
	...
	public Double consultaComplexidade(Integer idServicoContrato, String complexidade) throws Exception {
	...
	private Integer consultaIdContrato(Integer idServicoContrato) throws Exception {
