...
public class PastaDAO extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = 1072513216201646772L;
	 ...
	 * @author valdoilo.damasceno
	 */
	public Collection<PastaDTO> consultarPastasAtivas() throws Exception {
		List ordenacao = new ArrayList();
	 ...
	 * @author valdoilo.damasceno
	 */
	public Collection<PastaDTO> listPastaSuperiorSemPai() throws Exception {
	 ...
	 * @author valdoilo.damasceno
	 */
	public boolean isEmUso(PastaDTO pastaBean) throws Exception {
	 ...
	 * @throws Exception
	 */
	public List<PastaDTO> listPastaByPerfilAcessoUsuario(UsuarioDTO usuario) throws Exception {
	 ...
	 * @throws Exception
	 */
	public boolean verificarSePastaPossuiFaq(PastaDTO pastaDto) throws Exception {
	 ...
	 * @throws Exception
	 */
	public boolean verificarSePastaPossuiErroConhecido(PastaDTO pastaDto) throws Exception {
