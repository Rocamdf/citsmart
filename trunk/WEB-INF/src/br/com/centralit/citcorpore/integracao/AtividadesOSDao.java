...
public class AtividadesOSDao extends CrudDaoDefaultImpl {
	 ...
	 * @throws Exception
	 */
	public Collection listOSNumeroAtividade(Integer idAtividadesOS) throws Exception {
	 ...
	 * @throws Exception
	 */
	public boolean atualizaObservacao(Integer idatividadeservicocontrato, String observacao, List<OSDTO> os) throws Exception {
		int resp = 0;
		for (OSDTO osdto : os) {
	...
	public Collection findByIdOsServicoContratoContabil(Integer idOS, Integer idServicoContratoContabil) throws Exception {
		List condicao = new ArrayList();
