...
public class SolicitacaoServicoMudancaDao extends CrudDaoDefaultImpl {
	...
	public List<SolicitacaoServicoMudancaDTO> listByIdMudanca(Integer parm) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
		condicao.add(new Condition("idRequisicaoMudanca", "=", parm));
	...
	public List<SolicitacaoServicoDTO> listSolicitacaoByIdMudanca (Integer idMudanca) throws Exception {
