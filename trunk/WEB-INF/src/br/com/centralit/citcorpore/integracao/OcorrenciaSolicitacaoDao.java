...
public class OcorrenciaSolicitacaoDao extends CrudDaoDefaultImpl {
	...
	public OcorrenciaSolicitacaoDTO findUltimoByIdSolicitacaoServico(Integer idSolicitacaoServicoParm) throws Exception {
		...
		if(CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.POSTGRESQL) || CITCorporeUtil.SGBD_PRINCIPAL.toUpperCase().equals(SQLConfig.MYSQL)){
			...
			sql.append("select o.idocorrencia, o.idjustificativa, o.idsolicitacaoservico, o.iditemtrabalho, o.dataregistro, o.horaregistro, o.registradopor, "
					...
					+ " o.categoria, o.origem, o.tempogasto, o.ocorrencia, o.idcategoriaocorrencia, o.idorigemocorrencia "
					+ " from ocorrenciasolicitacao o "
					+ " where o.idsolicitacaoservico = ? and rownum = 1 "
	...
	public OcorrenciaSolicitacaoDTO findUltimoByIdSolicitacaoServicoAndOcorrencia(Integer idSolicitacaoServico) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
	...
	public Collection findOcorrenciaDoTesteByIdSolicitacaoServico(Integer idSolicitacaoServicoParm) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
		...
		sql.append("select o.ocorrencia, u.idusuario from ocorrenciasolicitacao o "
				...
				+ " inner join usuario u on o.registradopor = u.login "
				+ " where o.ocorrencia like '%" + string + "%' and s.idsolicitacaoservico = ?");
	...
	public Collection<OcorrenciaSolicitacaoDTO> listByIdSolicitacaoAndCategoria(Integer idSolicitacaoServico, CategoriaOcorrencia categoria) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
	...
	public Collection<OcorrenciaSolicitacaoDTO> findByIdPessoaEDataAtendidasGrupoTeste(Integer idPessoa, Date dataInicio, Date dataFim) throws Exception{
		...
		sql.append("select solicitacaoservico.idsolicitacaoservico, usuario.nome, historicosolicitacaoservico.idresponsavelatual, solicitacaoservico.urgencia "
				...
				+ " and solicitacaoservico.datahorafim < solicitacaoservico.datahoralimite "
				+ " and historicosolicitacaoservico.idresponsavelatual = ? "
				+ " group by solicitacaoservico.idsolicitacaoservico "
