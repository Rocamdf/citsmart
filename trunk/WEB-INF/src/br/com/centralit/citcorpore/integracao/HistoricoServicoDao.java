...
public class HistoricoServicoDao extends CrudDaoDefaultImpl {
	 ...
	 * @throws Exception
	 */
	public Collection findByNome(HistoricoServicoDTO servicoDTO) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
	...
	public Collection<HistoricoServicoDTO> findByServico(Integer idServico) throws Exception {
	...
	public Collection<HistoricoServicoDTO> findByServico(Integer idServico, String nome) throws Exception {
		List parametro = new ArrayList();
		List fields = new ArrayList();
		List list = new ArrayList();
		String sql = "   select nometiposervico, nomeservico, nomecategoriaservico, idServico from servico " + "inner join tiposervico  on servico.idtiposervico = tiposervico.idtiposervico "
