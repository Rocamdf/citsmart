...
public class ValorDao extends CrudDaoDefaultImpl {
    ...
    private static final long serialVersionUID = 2735109661395349256L;
     ...
     */
    public Collection findByIdItemConfiguracao(Integer idItemConfiguracao) throws Exception {
     ...
     * @author valdoilo.damasceno
     */
    public ValorDTO restore(boolean isItemConfigruacao, Integer idBaseItemConfiguracao, Integer idCaracteristica) throws Exception {
	List condicao = new ArrayList();
    ...
    public ValorDTO restoreValorByIdItemConfiguracao(Integer idItemConfiguracao, Integer idCaracteristica, String valor) throws Exception {
		List condicao = new ArrayList();
		condicao.add(new Condition("idItemConfiguracao", "=", idItemConfiguracao));
		condicao.add(new Condition("idCaracteristica", "=", idCaracteristica));
     ...
     * @author valdoilo.damasceno
     */
    public Collection<ValorDTO> findByItemAndTipoItemConfiguracao(ItemConfiguracaoDTO itemConfiguracao, TipoItemConfiguracaoDTO tipoItemConfiguracao) throws Exception {
     ...
     * @author valdoilo.damasceno
     */
    private void gerarSqlFindByItemAndTipoItemConfiguracao(ItemConfiguracaoDTO itemConfiguracao, TipoItemConfiguracaoDTO tipoItemConfiguracao, StringBuffer sql, List parametro) {
		String sqlHardware = "";
    ...
    public Collection listUniqueValuesByTagCaracteristica(String tag) throws Exception {
		String sql = "SELECT DISTINCT valorstr FROM valor INNER JOIN caracteristica ON valor.idcaracteristica = caracteristica.idcaracteristica  where datafim is null AND tagcaracteristica = ? AND valorstr <> '' ORDER BY 1";
