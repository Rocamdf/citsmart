...
public class RegraEscalonamentoDAO extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = -1267367172061471163L;
	 ...
	 * 3- Mudança
	 */
	public Collection findByTipoSolicitacao(int idTipoGerenciamento) throws Exception{
	...
	public Collection<RegraEscalonamentoDTO> findRegraBySolicitacao(SolicitacaoServicoDTO solicitacaoServicoDTO, Integer idTipoGerenciamento) throws Exception{
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		StringBuffer sql = new StringBuffer();
	...
	public Collection<RegraEscalonamentoDTO> findRegraByRequisicaoMudanca(RequisicaoMudancaDTO requisicaoMudancaDTO, Integer idTipoGerenciamento) throws Exception{
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		StringBuffer sql = new StringBuffer();
	...
	public Collection<RegraEscalonamentoDTO> findRegraByProblema(ProblemaDTO problemaDTO, Integer idTipoGerenciamento) throws Exception{
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		StringBuffer sql = new StringBuffer();
		boolean temContrato = false, temSolicitante = false, temGrupo = false, temImpacto = false, temUrgencia = false;
