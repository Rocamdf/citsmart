...
public class BaseConhecimentoDAO extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = 929260496705140718L;
	 ...
	 * @throws Exception
	 */
	public List<BaseConhecimentoDTO> findByServico(SolicitacaoServicoDTO solicitacaoServicoDto) throws Exception {
	...
	public BaseConhecimentoDTO findByIdSolicitacaoServico(SolicitacaoServicoDTO solicitacaoServicoDto) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
		StringBuffer sql = new StringBuffer();
	 ...
	 */
	public boolean verificaSeBaseConhecimentoExiste(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
	...
	public Collection<BaseConhecimentoDTO> listaBaseConhecimento(BaseConhecimentoDTO baseConhecimento) throws Exception {
		...
		sql.append("select  baseconhecimento.idbaseconhecimento,baseconhecimento.titulo,baseconhecimento.versao,baseconhecimento.datainicio,baseconhecimento.conteudo, baseconhecimento.nome,");
		sql.append("baseconhecimento.dataexpiracao,baseconhecimento.status,baseconhecimento.datapublicacao,baseconhecimento.conteudosemformatacao");
		...
		sql.append(" baseconhecimento.dataexpiracao,CASE WHEN baseconhecimento.status ='S' THEN 'Publicado' WHEN baseconhecimento.status ='N' THEN 'Não Publicado' ELSE baseconhecimento.status END as status,baseconhecimento.datapublicacao,baseconhecimento.conteudosemformatacao, baseconhecimento.datafim ");
	...
	public Collection<BaseConhecimentoDTO> listaBaseConhecimentoTotal(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception{
		List ordenacao = new ArrayList();
		ordenacao.add(new Order("idBaseConhecimento"));
		return super.list(ordenacao);
	}
	
	public Collection<BaseConhecimentoDTO> consultaConhecimentoPorAutor(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception{
		List parametro = new ArrayList();
		List list = new ArrayList();
		List listRetornor = new ArrayList();
		StringBuffer sql = new StringBuffer();
		
		sql.append("select u.nome, count(b.titulo) ")
		.append("from usuario u ")
		.append("inner join baseconhecimento b on u.idusuario = b.idusuarioautor ")
		.append("where b.datainicio between ? and ? and b.datafim is null and b.arquivado = ? ")
		.append("group by u.nome ")
	...
	public Collection<BaseConhecimentoDTO> consultaConhecimentoPorAprovador(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception{
		List parametro = new ArrayList();
		List list = new ArrayList();
		List listRetornor = new ArrayList();
		StringBuffer sql = new StringBuffer();
		...
		sql.append("select u.nome, count(b.titulo) ")
		.append("from usuario u ")
		.append("inner join baseconhecimento b on u.idusuario = b.idusuarioaprovador ")
		.append("where b.datainicio between ? and ? and b.datafim is null and b.arquivado = ? ")
		.append("group by u.nome ")
		.append("order by u.nome ");
	...
	public Collection<BaseConhecimentoDTO> consultaConhecimentosPublicadosPorOrigem(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception{
		...
		sql.append("select origem, count(*) ")
		.append("from "+this.getTableName()+" ")
		.append("where datapublicacao between ? and ? and datafim is null and arquivado = ? ")
		.append("group by origem ")
	...
	public Collection<BaseConhecimentoDTO> consultaConhecimentosNaoPublicadosPorOrigem(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception{
		...
		sql.append("select origem, count(*) ")
		.append("from "+this.getTableName()+" ")
		.append("where datainicio between ? and ? and datafim is null and arquivado = ? and datapublicacao is null ")
		.append("group by origem ")
		.append("order by origem ");
	...
	public Collection<BaseConhecimentoDTO> consultaConhecimentoQuantitativoEmLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		sql.append("select b.idbaseconhecimento, b.titulo ")
		.append("from "+this.getTableName()+" b ")
		.append("where b.datainicio between ? and ? and b.datafim is null and b.arquivado = ? ")
	...
	public Collection<BaseConhecimentoDTO> consultaIncidenteLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		sql.append("select b.idbaseconhecimento, b.titulo, ss.idsolicitacaoservico ")
		.append("from "+this.getTableName()+" b ")
		.append("inner join conhecimentosolicitacaoservico css ")
		.append("on css.idbaseconhecimento = b.idbaseconhecimento ")
		.append("INNER JOIN solicitacaoservico ss ")
		.append("ON ss.idsolicitacaoservico = css.idsolicitacaoservico ")
		.append("INNER JOIN tipodemandaservico tds ")
		.append("ON tds.idtipodemandaservico = ss.idtipodemandaservico ")
		.append("AND tds.classificacao = 'I' ")
		.append("where b.idbaseconhecimento = ? ")
	...
	public Collection<BaseConhecimentoDTO> consultaRequisicaoLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		.append("INNER JOIN tipodemandaservico tds ")
		.append("ON tds.idtipodemandaservico = ss.idtipodemandaservico ")
		.append("AND tds.classificacao = 'R' ")
		.append("where b.idbaseconhecimento = ? ")
		.append("order by b.idbaseconhecimento; ");
	...
	public Collection<BaseConhecimentoDTO> consultaProblemaLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		sql.append("select b.idbaseconhecimento, b.titulo, p.idproblema ")
		.append("from "+this.getTableName()+" b ")
		.append("inner join conhecimentoproblema cp ")
		.append("on cp.idbaseconhecimento = b.idbaseconhecimento ")
		.append("inner join problema p ")
		.append("on p.idproblema = cp.idproblema ")
		.append("where b.idbaseconhecimento = ? ")
		.append("order by b.idbaseconhecimento; ");
	...
	public Collection<BaseConhecimentoDTO> consultaMudancaLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		sql.append("select b.idbaseconhecimento, b.titulo, rm.idrequisicaomudanca ")
		.append("from "+this.getTableName()+" b ")
		.append("inner join conhecimentomudanca cm ")
		.append("on cm.idbaseconhecimento = b.idbaseconhecimento ")
		.append("inner join requisicaomudanca rm ")
		.append("on rm.idrequisicaomudanca = cm.idbaseconhecimento ")
		.append("where b.idbaseconhecimento = ? ")
		.append("order by b.idbaseconhecimento; ");
	...
	public Collection<BaseConhecimentoDTO> consultaItemConfiguracaoLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		sql.append("select b.idbaseconhecimento, b.titulo, ic.identificacao ")
		.append("from "+this.getTableName()+" b ")
		.append("inner join conhecimentoic cic ")
		.append("on cic.idbaseconhecimento = b.idbaseconhecimento ")
		.append("inner join itemconfiguracao ic ")
		.append("on ic.iditemconfiguracao = cic.iditemconfiguracao ")
		.append("where b.idbaseconhecimento = ? ")
		.append("order by b.idbaseconhecimento; ");
	...
	public Collection<BaseConhecimentoDTO> consultaServicoLista(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception {
		...
		sql.append("select b.idbaseconhecimento, b.titulo, ")
		.append("case ")
			.append("when s.idbaseconhecimento is null ")
				.append("then 'n' ")
			.append("else ")
				.append("'s' ")
		.append("end ")
		...
		.append("on b.idbaseconhecimento = s.idbaseconhecimento ")
		.append("where b.idbaseconhecimento = ? ")
		.append("order by b.idbaseconhecimento; ");
	...
	public Collection<BaseConhecimentoDTO> listarBaseConhecimentoFAQ() throws Exception {
		...
		List fields = new ArrayList();
		List list = new ArrayList();
		String sql = " select idBaseConhecimento, titulo, conteudo from baseconhecimento where faq = 'S' and datafim is null  ";
	 ...
	 * @throws Exception 
	 */
	public List<BaseConhecimentoDTO> findByIdBaseConhecimento(Integer id) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public List<BaseConhecimentoDTO> findByBaseConhecimento(String titulo) throws Exception {
		List resp = new ArrayList();
