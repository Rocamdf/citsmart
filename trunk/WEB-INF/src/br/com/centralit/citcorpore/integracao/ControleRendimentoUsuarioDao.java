...
public class ControleRendimentoUsuarioDao extends CrudDaoDefaultImpl{
	...
	public Collection<ControleRendimentoUsuarioDTO> findByIdControleRendimentoUsuario (Integer idGrupo, String mes, String ano) throws Exception{
	...
	public Collection<ControleRendimentoUsuarioDTO> findByIdControleRendimentoMelhoresUsuario (Integer idGrupo, String mesInicio, String mesFim, String anoInicio, String anoFim, Boolean deUmAnoParaOutro) throws Exception{
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
	...
	public Collection<ControleRendimentoUsuarioDTO> findIdsControleRendimentoUsuarioPorPeriodo (Integer idGrupo, String mesInicio, String mesFim, String anoInicio, String anoFim, Boolean deUmAnoParaOutro) throws Exception{
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
