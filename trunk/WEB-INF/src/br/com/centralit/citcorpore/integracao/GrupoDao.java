...
public class GrupoDao extends CrudDaoDefaultImpl {
	 ...
	 * @author thays.araujo
	 */
	public Collection listarGrupoEmpregado() throws Exception {
	 ...
	 * @author thays.araujo
	 */
	public Collection listarGrupoUsuario() throws Exception {
	 ...
	 * @throws Exception
	 */
	public Collection getGruposByIdEmpregadoAll(Integer idEmpregado) throws Exception {
		Object[] objs = new Object[] { idEmpregado };
	...
	public GrupoDTO restoreBySigla(String sigla) throws Exception {
		List ordem = new ArrayList();
	...
	public GrupoDTO restoreBySigla(GrupoDTO grupoDto) throws Exception {
	 ...
	 */
	public Collection<GrupoDTO> listGruposPorUsuario(int idUsuario) throws Exception {
		List parametro = new ArrayList();
	 ...
	 * @throws Exception
	 */
	public List<String> listarEmailsPorGrupo(Integer idGrupo) throws Exception {
		StringBuffer sql = new StringBuffer();
	...
	public List<String> listarPessoasEmailPorGrupo(Integer idGrupo) throws Exception {
		StringBuffer sql = new StringBuffer();
