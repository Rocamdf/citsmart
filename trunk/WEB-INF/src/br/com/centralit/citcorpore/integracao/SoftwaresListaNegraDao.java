...
public class SoftwaresListaNegraDao extends CrudDaoDefaultImpl {
	 ...
	 * @author ronnie.lopes
	 */
	public String recuperaStringSoftwaresListaNegra() throws Exception {
	 ...
	 * @author ronnie.lopes
	 */
	public Collection<SoftwaresListaNegraDTO> recuperaCollectionSoftwaresListaNegra() throws Exception {
		List lista = new ArrayList();
		StringBuilder sql = new StringBuilder();
		List  listRetorno = new ArrayList();
