...
public class PerfilAcessoUsuarioDAO extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = -7679812216612525151L;
	...
	public Collection listPerfilByIdUsuario(UsuarioDTO usuarioDTO) throws Exception {
		List list = new ArrayList();
		List fields = new ArrayList();
	...
	public void updateDataFim(PerfilAcessoUsuarioDTO obj) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void update(PerfilAcessoUsuarioDTO perfilAcessoUsuario) throws Exception {
	...
	public IDto restorePerfilAcessoUsuario(IDto obj) throws Exception {
		PerfilAcessoUsuarioDTO perfilAcessoUsuarioDTO = (PerfilAcessoUsuarioDTO) obj;
		List fields = gerarFieldsRetornoPerfilAcessoUsuario();
