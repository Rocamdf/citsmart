...
public class GrupoEmpregadoDao extends CrudDaoDefaultImpl {
	...
	public void deleteByIdEmpregado(Integer idEmpregado) throws Exception {
	...
	public Collection findAtivosByIdEmpregado(Integer idEmpregado) throws Exception {
		Object[] objs = new Object[] { idEmpregado };
	 ...
	 * @author valdoilo.damasceno
	 */
	public Collection<GrupoEmpregadoDTO> findGrupoEmpregadoHelpDeskByIdContrato(Integer idContrato) throws Exception {
	...
	public boolean grupoempregado (Integer idEmpregado, Integer idGrupo) throws Exception {
		...
		sql.append(" select * from gruposempregados ge where ge.idempregado=? and ge.idgrupo=?  ");
