...
public class EntregaItemRequisicaoDao extends CrudDaoDefaultImpl {
    ...
    public Collection findDisponiveisInspecaoByIdSolicitacaoServico(Integer idSolicitacaoServico) throws Exception {
    ...
    public void excluiRelacionamentos(Collection<EntregaItemRequisicaoDTO> col) throws Exception {
        if (col == null)
            return;
    ...
    public Collection findByIdItemRequisicaoAndIdColetaPreco(Integer idItemRequisicaoProduto, Integer idColetaPreco) throws Exception {
        List condicao = new ArrayList();
        List ordenacao = new ArrayList(); 
    ...
    public void deleteByIdItemRequisicaoAndIdColetaPreco(Integer idItemRequisicaoProduto, Integer idColetaPreco) throws Exception {
    ...
    private StringBuffer getSQLRestoreAll() {
        ...
        sql.append("       ei.situacao, ei.idParecer, ped.numeroPedido, ped.dataEntrega, item.descricaoItem, forn.cnpj, forn.nomeFantasia ");
    ...
    public Collection<EntregaItemRequisicaoDTO> findNaoAprovadasEDisponiveisByIdSolicitacaoServico(Integer idSolicitacaoServico) throws Exception {
        List condicao = new ArrayList();
        List ordenacao = new ArrayList(); 
        condicao.add(new Condition("idSolicitacaoServico", "=", idSolicitacaoServico)); 
