...
public class EventoItemConfigDao extends CrudDaoDefaultImpl {
    ...
    public ValorDTO pegarSistemaOperacionalEmpregado(Integer idEmpregado) throws Exception {
    ...
    public ValorDTO pegarCaminhoItemConfig(String nomeBaseItemConfig) throws Exception {
    ...
    /*public Collection<CaracteristicaDTO> pegarNetworksEmpregado(Integer idEmpregado) throws Exception {
    ...
    public Integer getIdItemConfiguracaoPai(Integer idEmpregado) throws Exception {
    ...
    public Collection<CaracteristicaDTO> pegarNetworksItemConfiguracao(Integer idItemConfiguracao) throws Exception {
     ...
     * @throws Exception
     */
    public String pegarSistemaOperacionalItemConfiguracao(Integer idItemConfiguracao) throws Exception {
