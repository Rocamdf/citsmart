...
public class ColetaPrecoDao extends CrudDaoDefaultImpl {
	...
	public void excluiRelacionamentos(Collection<ColetaPrecoDTO> col) throws Exception {
        if (col == null)
            return;
    ...
    public Collection findByIdItemCotacaoAndPontuacao(Integer idItemCotacao, Double pontuacao) throws Exception {
        List condicao = new ArrayList();
        List ordenacao = new ArrayList(); 
    ...
    public Collection findHabilitadasByIdItemCotacao(Integer parm) throws Exception {
        List parametro = new ArrayList();
    ...
    public void atualizaResultadoCalculo(ColetaPrecoDTO coletaPrecoDto) throws Exception {
        StringBuffer sql = new StringBuffer();
    ...
    public void atualizaResultadoFinal(ColetaPrecoDTO coletaPrecoDto) throws Exception {
        StringBuffer sql = new StringBuffer();
