...
public class RequisicaoLiberacaoItemConfiguracao extends AjaxFormAction implements IRequisicaoMudancaRelacionamento{
	...
	public void gravarRelacionamentos(Integer idRequisicaoLiberacao, Collection listaDeserializada) throws RemoteException, LogicException, ServiceException, Exception{		
