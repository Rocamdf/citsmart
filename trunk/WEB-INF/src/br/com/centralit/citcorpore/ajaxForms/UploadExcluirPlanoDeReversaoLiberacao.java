...
public class UploadExcluirPlanoDeReversaoLiberacao extends AjaxFormAction {
	...
	public void load(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		request.getSession(true).setAttribute("colUploadPlanoDeReversaoLiberacaoGED", col2);
	}
}
