...
public class RelatorioBaseConhecimento extends AjaxFormAction {
	...
	public void preencherComboAprovadas(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		comboAprovados.addOption("Publicado",UtilI18N.internacionaliza(request, "pesquisaBaseConhecimento.publicado"));
		comboAprovados.addOption("Não Publicado",UtilI18N.internacionaliza(request, "pesquisaBaseConhecimento.naoPublicado"));
