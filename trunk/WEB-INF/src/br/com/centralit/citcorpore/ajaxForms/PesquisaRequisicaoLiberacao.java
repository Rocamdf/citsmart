...
//		ArrayList<RequisicaoLiberacaoDTO> listaSolicitacaoServicoPorCriterios = (ArrayList<RequisicaoLiberacaoDTO>) requisicaoLiberacaoService.listaRequisicaoLiberacaoPorCriterios(pesquisaRequisicaoLiberacaoDto);
	...
	private String montaHTMLResumoSolicitacoes(List<RequisicaoLiberacaoDTO> resumo, StringBuffer script, HttpServletRequest request, HttpServletResponse response) throws ServiceException, Exception {
		usuario = WebUtil.getUsuario(request);
...
//            reqDto.setIdRequisicaoLiberacao(r.getIdRequisicaoLiberacao());
			...
			html.append("<td>" + UtilDatas.formatTimestamp(r.getDataHoraCaptura()) + "</td>");
...
//			html.append("<td>" + r.getNomeServico().replace(".", ". ") + "</td>");
			...
			if (r.getDataHoraInicioAgendada() != null)
			    html.append("<td>" + UtilDatas.formatTimestamp(r.getDataHoraInicioAgendada()) + "</td>");
			else
			    html.append("<td>&nbsp;</td>");
			if(r.getDataHoraTerminoAgendada() != null)
				html.append("<td>" + UtilDatas.formatTimestamp(r.getDataHoraTerminoAgendada())+ "</td>");
			else
				html.append("<td>&nbsp;</td>");
