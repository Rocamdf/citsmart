...
public class Empregado extends AjaxFormAction {
	...
	public void delete(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		GrupoEmpregadoDTO grupoEmpregadoDTO = new GrupoEmpregadoDTO();
		GrupoEmpregadoService grupoEmpregadoService = (GrupoEmpregadoService) ServiceLocator.getInstance().getService(GrupoEmpregadoService.class, WebUtil.getUsuarioSistema(request));
		...
		if (this.getEmpregadoBean().getIdEmpregado() != null)
		{
			...
			if (this.getEmpregadoBean().getIdEmpregado().intValue() > 0) 
			{
				...
				Collection<GrupoEmpregadoDTO> empregadosDeGrupo = (Collection<GrupoEmpregadoDTO>) grupoEmpregadoService.findByIdEmpregado(idEmpregado);
				
				if (empregadosDeGrupo != null) {
					for (GrupoEmpregadoDTO grupoEmpregado : empregadosDeGrupo) {
						grupoEmpregadoService.deleteByIdGrupoAndEmpregado(grupoEmpregado.getIdGrupo(), grupoEmpregado.getIdEmpregado());
					}
				}
				...
				empregadoService.deleteEmpregado(getEmpregadoBean());
			}
	...
	/**
	 * Retorna instância de EmpregadoService.
	 * 
	...
	/**
	 * Atribui valor de EmpregadoBean.
	 * 
	 * @param empregado
	 */
	public void setEmpregadoBean(IDto empregado) {
		this.empregadoBean = (EmpregadoDTO) empregado;
	}

	/**
	 * Retorna bean de empregado.
	 * 
	 * @return EmpregadoDTO
	 */
	public EmpregadoDTO getEmpregadoBean() {
