...
public class ControleFinanceiroViagem extends AjaxFormAction {
	...
	public void restore(DocumentHTML document, HttpServletRequest request, HttpServletResponse response,RequisicaoViagemDTO requisicaoViagemDTO) throws ServiceException, Exception{
		...
		if(requisicaoViagemDTO.getIdSolicitacaoServico()!=null){
			...
			if(requisicaoViagemDTO!=null){
				this.geraGridControleFinancerio(document, request, response,requisicaoViagemDTO);
			}
			if(requisicaoViagemDTO != null){
	...
	public void geraGridControleFinancerio(DocumentHTML document, HttpServletRequest request, HttpServletResponse response, RequisicaoViagemDTO requisicaoViagemDTO) throws ServiceException, Exception{
		RequisicaoViagemService reqViagemService = (RequisicaoViagemService) ServiceLocator.getInstance().getService(RequisicaoViagemService.class, null);
		...
		if(colIntegrantes != null){
			...
			tblControleFinaceiro.addRowsByCollection(colIntegrantes, new String[]{"","nome"}, null, null, new String[]{"gerarImg"}, "addItemIntegrante", null);			
		}
