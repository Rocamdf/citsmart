...
public class IncidentesRelacionados extends AjaxFormAction {
	...
	private String montaHTMLResumoSolicitacoes(Collection<SolicitacaoServicoDTO> listSolicitacaoServicoRelacionada, StringBuffer script, HttpServletRequest request) {
	...
	private String montaHTMLSolicitacoesServicoEmAndamento(Collection<SolicitacaoServicoDTO> resumo, StringBuffer script, HttpServletRequest request) {
		StringBuffer html = new StringBuffer();
		SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
