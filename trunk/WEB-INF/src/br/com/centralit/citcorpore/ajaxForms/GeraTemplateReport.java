...
public class GeraTemplateReport extends AjaxFormAction{
	...
	public void load(DocumentHTML document, HttpServletRequest request,
		...
		String strCabecalho = UtilTratamentoArquivos.getStringTextFromFileTxt(strPathTemplateCAB);
		
		request.setAttribute("htmlProcess", strCabecalho);
