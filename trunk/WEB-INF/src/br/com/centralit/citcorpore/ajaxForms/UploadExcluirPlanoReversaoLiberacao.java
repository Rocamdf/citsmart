...
public class UploadExcluirPlanoReversaoLiberacao extends AjaxFormAction {
	...
	public void load(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Collection colUploadsGED = (Collection) request.getSession(true).getAttribute("colUploadPlanoReversaoGED");
		...
		request.getSession(true).setAttribute("colUploadPlanoReversaoGED", col2);
	}
}
