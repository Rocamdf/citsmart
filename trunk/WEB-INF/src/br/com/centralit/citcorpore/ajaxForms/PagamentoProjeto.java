...
public class PagamentoProjeto extends AjaxFormAction {
	...
	* Motivo/Comentário: Mesclado coluna pagamento e situação pois estavam redundantes */
	public void getInformacoes(DocumentHTML document, HttpServletRequest request,
		...
		StringBuffer strBufferPags =  new StringBuffer();
		...
		if (colPags != null && colPags.size() > 0){
			...
			for (Iterator it = colPags.iterator(); it.hasNext();){
				...
				strBufferPags.append("<tr>");		
				strBufferPags.append("<td>" + UtilDatas.dateToSTR(pagamentoProjetoAux.getDataPagamento()) + "</td>");
				...
				strBufferPags.append("<td>" + UtilDatas.dateToSTR(pagamentoProjetoAux.getDataUltAlteracao()) + " " + pagamentoProjetoAux.getHoraUltAlteracao() + "</td>");
...
//					}
					...
					strBuffer.append("<td>" + UtilDatas.dateToSTR(tarefaLinhaBaseProjetoDTO.getDataInicio()) + "</td>");
					strBuffer.append("<td>" + UtilDatas.dateToSTR(tarefaLinhaBaseProjetoDTO.getDataFim()) + "</td>");
					...
					strBuffer2.append("<td>" + UtilDatas.dateToSTR(tarefaLinhaBaseProjetoDTO.getDataInicio()) + "</td>");
					strBuffer2.append("<td>" + UtilDatas.dateToSTR(tarefaLinhaBaseProjetoDTO.getDataFim()) + "</td>");
