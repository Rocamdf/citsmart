...
public class ControleContratoTreinamentoServiceEjb extends CrudServicePojoImpl implements
ControleContratoTreinamentoService {

    protected CrudDAO getDao() throws ServiceException {
	return new ControleContratoTreinamentoDao();
    }
	...
	public void deleteByIdControleContrato(ControleContratoDTO controleContrato)
			throws Exception {
		ControleContratoTreinamentoDao dao = new ControleContratoTreinamentoDao();
