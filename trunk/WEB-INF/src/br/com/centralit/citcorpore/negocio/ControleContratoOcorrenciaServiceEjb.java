...
public class ControleContratoOcorrenciaServiceEjb extends CrudServicePojoImpl implements
ControleContratoOcorrenciaService {

    protected CrudDAO getDao() throws ServiceException {
	return new ControleContratoOcorrenciaDao();
    }
	...
	public void deleteByIdControleContrato(ControleContratoDTO controleContrato)
			throws Exception {
		ControleContratoOcorrenciaDao dao = new ControleContratoOcorrenciaDao();
