...
public interface ProblemaService extends CrudServiceEjb2 {
...
//	public Collection<ProblemaDTO> listProblemasFilhos() throws Exception;
	 ...
	 * Retorna um objeto(RelatorioProblemaIncidentesDTO) contendo todos os incidentes relacionados ao problema
	 */
