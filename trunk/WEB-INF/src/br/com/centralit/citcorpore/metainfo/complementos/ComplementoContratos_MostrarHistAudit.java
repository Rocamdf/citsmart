					...
					for (Iterator it = col.iterator(); it.hasNext();){
						...
						strTable += "<td style='border:1px solid black'>";
							if (contratoHistoricoDTO.getDataContrato() != null){
								strTable += "" + UtilDatas.dateToSTR(contratoHistoricoDTO.getDataContrato()) + "";
							}else{
								strTable += "&nbsp;";
							}
						strTable += "</td>";
						...
						strTable += "<td style='border:1px solid black'>";
							if (contratoHistoricoDTO.getDataFimContrato() != null){
								strTable += "" + UtilDatas.dateToSTR(contratoHistoricoDTO.getDataFimContrato()) + "";
							}else{
								strTable += "&nbsp;";
							}
						strTable += "</td>";						
						...
						strTable += "</td>";	
						strTable += "<td style='border:1px solid black'>";
							strTable += "" + UtilDatas.dateToSTR(contratoHistoricoDTO.getModificadoEm()) + "";
						strTable += "</td>";	
						strTable += "</tr>";	
