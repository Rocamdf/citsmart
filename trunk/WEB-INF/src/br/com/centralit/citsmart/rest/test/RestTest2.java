...
public class RestTest2 {
	...
	public static String autenticacaoComJSON() throws Exception {
       ...
       HttpPost req = new HttpPost("http://localhost:8080/citsmart/services/login");
	...
	public static String addServiceRequestComXML() throws Exception {
		String json = autenticacaoComJSON();
		CtLoginResp login = new Gson().fromJson(json, CtLoginResp.class);
       ...
       DefaultHttpClient client = new DefaultHttpClient();
       HttpPost req = new HttpPost("http://localhost:8080/citsmart/services/xml/addServiceRequest");
