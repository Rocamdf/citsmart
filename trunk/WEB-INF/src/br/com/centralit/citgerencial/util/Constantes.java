...
public class Constantes 
{
	...
	public static final String VERSAO     = "Citsaude V.3.5.1 Express";
	...
	public static String RAIZ_SITE  = "http://localhost/citsaude";
	
	public static String RAIZ_CITSAUDE  = "/citsaude";
	...
	public static String ENDERECO_SITE = "localhost"; 
	...
	public static void load(){
		...
		try{
			...
			*/
			Constantes.IMPRIMIR_FORMULARIO_POSTADO = CITGerencialUtil.DEBUG;
			LOADED = true;
			...
			System.out.println("IMPRIMIR_FORMULARIO_POSTADO = " + CITGerencialUtil.DEBUG);
