...
public class ControleGenerateSLAPorAcordoNivelServicoEmAndamento {
	public List execute(Integer idAcordoNivelServico)
...
*/
		...
		sql = sql + "WHERE (sol.idacordonivelservico = ?) and sol.situacao = 'EmAndamento' ";
