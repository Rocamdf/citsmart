			...
			if (listaDados != null && !listaDados.isEmpty()) {
				for (int i = 0; i < listaDados.size(); i++) {
					...
					if (dataHoraCaptura != null) {
						dataHoraCapturaStr = UtilDatas.formatTimestamp(dataHoraCaptura);
					}
					...
					lstRetorno.add(new Object[] { row[0] + "", row[1], row[2], UtilDatas.formatTimestamp(dataHoraSol), dataHoraLimiteStr, dataHoraFimStr, prioridadeStr, dataHoraCapturaStr,
