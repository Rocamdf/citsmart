 ...
 * @since 14/08/2012
 */
public class GenerateServiceRequisicoesPorTipoServico extends GerencialGenerateService {
	...
	public List execute(HashMap parametersValues, Collection paramtersDefinition) throws ParseException {
		...
		try {
			col = graficosDao.consultaIncidentesPorTipoServico(getNovoParametro(), "R");
		} catch (Exception e) {
			e.printStackTrace();
		}
