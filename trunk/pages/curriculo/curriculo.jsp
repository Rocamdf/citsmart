...
<body>	
    <div class="box grid_16 tabs" style='margin: 0px 0px 0px 0px;'>
			<div class="columns clearfix">											
				<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/curriculo/curriculo'>
				        	...
				        	<div class="col_100">
				        		<div class="col_80">
				        	 		<div class="col_100">				        		
						        	    <div class="col_15">
						        	         <fieldset style="height: 70px;">
						                         <label ><i18n:message key="CPF" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_66">
						        	         <fieldset style="height: 70px;">
						                         <label ><i18n:message key="Nome" /></label>
						                         <div>
							        	 ...
							        	 <div class="col_15">
						        	         <fieldset style="height: 70px;">
						                         <label ><i18n:message key="Data de nascimento" /></label>
						                         <div>
				        	 		...
				        	 		<div class="col_100">				        		
						        	    <div class="col_15">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Sexo" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_20">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Estado Civil" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_16">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Possui filho(s)" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_15" id="divFilhos" style="display: none;">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Quantos" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_30">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Naturalidade" /></label>
						                         <div>
						        	 ...
						        	 <div class="col_100">
						        	    <div class="col_40">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Cidade Natal" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_33">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Portador de necessidades especiais" /></label>
						                         <div>
						        	    ...
						        	    <div class="col_20" id="divDeficiencias" style="display: none;">
						        	    	<fieldset style="height: 70px;">
						                         <label ><i18n:message key="Qual" /></label>
						                         <div>
				             ...
				             <div class="col_100">
				        	 	<div class="col_33">
				        	 	  <fieldset>
				  					<label  style='font-size:16px'><i18n:message key="Emails" /></label>
				        	 	...
				        	 	<div class="col_33">
				        	 	  <fieldset>
				  					<label  style='font-size:16px'><i18n:message key="Telefones" /></label>
		  								<div style='height: 100px; overflow: auto; border: 1px solid black'>
				        	 ...
				        	 <div class="col_100">
				        	    <div class="col_33">
				        	       <fieldset>
				  					<label  style='font-size:16px'><i18n:message key="Endereços" /></label>
					  								<div style='height: 100px; overflow: auto; border: 1px solid black'>
				    			...
				    			<div class="col_33">
				             	...
				             	<div class="col_33">
				             		<fieldset>
				  					<label  style='font-size:16px'><i18n:message key="Formação" /></label>
					  								<div style='height: 100px; overflow: auto; border: 1px solid black'>
								...
								<div class="col_100">
										<fieldset>
											...
											<cit:uploadControl  style="height:50%;width:100%; border-bottom:1px solid #DDDDDD ; border-top:1px solid #DDDDDD "  title="<i18n:message key='citcorpore.comum.anexos' />" id="uploadAnexos" form="document.form" action="/pages/upload/upload.load" disabled="true" />
										</fieldset>
								</div>	
				         </form>
		 </div>
