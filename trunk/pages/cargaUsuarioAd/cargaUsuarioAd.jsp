...
<body>
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="carga.usuarios_ad" />
				</h2>
			</div>
			...
			<div class="box grid_16 tabs">
				...
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="carga.usuarios_ad" /></a></li>
				</ul>
						...
						<div class="section">
							...
							<div class="columns clearfix">
								...
								<div id='divEnviarArquivo' style='display:block; padding: 5px;'>
									...
									<form name='form' method="post" ENCTYPE="multipart/form-data" action='<%=Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/cargaUsuarioAd/cargaUsuarioAd.load'>
