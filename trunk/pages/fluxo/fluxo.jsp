...
<script>
	...
	function load() {
		...
		popup.titulo = "<i18n:message key='citcorpore.comum.pesquisarapida' />";
			...
			<div class="box grid_16 tabs">
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/fluxo/fluxo'>
