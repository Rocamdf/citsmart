	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="softwaresListaNegra.softwaresListaNegra" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="softwaresListaNegra.cadastro" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="softwaresListaNegra.pesquisa" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/softwaresListaNegra/softwaresListaNegra'>
								<input type='hidden' name='idSoftwaresListaNegra' /> 
								<div class="columns clearfix">
									<div class="col_66">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="softwaresListaNegra.nome" /></label>
											<div>
