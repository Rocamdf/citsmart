...
<script>
	...
	function fPesquisar(){
		...
		document.form.action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/osFinanceiro/osFinanceiro.load';
					...
					<tr>
						<td width="100%">
							<div id='areaUtilAplicacao'>   
								<!-- ## AREA DA APLICACAO ## -->
								<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/osFinanceiro/osFinanceiro' method="POST">
