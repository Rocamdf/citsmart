...
<table cellpadding="0" cellspacing="0" width="100%" style='width: 98%'>
	<tr style='text-align: center;' class=''>
		...
		<td class="linhaSubtituloGrid">
			<b style='line-height: 25px;font-size:13px; padding:0.5em;font-family: arial;'><i18n:message key="citcorpore.comum.datainicio"/></b>
		</td>
		<td class="linhaSubtituloGrid">
			<b style='line-height: 25px;font-size:13px; padding:0.5em;font-family: arial;'><i18n:message key="citcorpore.comum.datafim"/></b>
		</td>				
	</tr>
	<%
	String corLinha = "";
