...
<script>
    ...
    function gerarSelecaoItemRequisicao(row, obj){
        ...
        detalhes += "</table>";       
        row.cells[0].innerHTML = "<input type='checkbox' name='chkSel_"+obj.idItemRequisicaoProduto+"' id='chkSel_"+obj.idItemRequisicaoProduto+"' onclick='marcarDesmarcar(this,"+row.rowIndex+",\"tblItensRequisicao\")' title=\"header=[<i18n:message key='cotacao.detalhesDoItem'/>] body=[" + detalhes + "]\"/>";
                                // "<img style='cursor: pointer;' src='<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/viewCadastro.png' title=\"header=[<i18n:message key='cotacao.detalhesDoItem'/>] body=[" + detalhes + "]\" />";
    }
            ...
            <div class="col_100">
                ...
                <div class="col_25">
                       <button type='button' name='btnPesquisarRequisicao' id='btnPesquisarRequisicao'  class="light"
                           ...
                           <span><i18n:message key="cotacao.pesquisarRequisicaoProduto" />
                           </span>
                       </button>
                </div>
            </div>
            <h2 class="section">
                <i18n:message key="cotacao.itensCotacao" />
            </h2>
...
<div id="POPUP_ITENS_REQUISICAO" title="<i18n:message key="cotacao.pesquisarRequisicaoProduto" />"  style="overflow: hidden;">
               ...
               <div class="col_100" style='height:200px;overflow:auto;border:1px solid'>
                   <table id="tblItensRequisicao" class="table">
                       <tr>
                           ...
                           <th width="15%"><i18n:message key="centroResultado.custo" /></th>
                           <th width="15%"><i18n:message key="requisicaoProduto.projeto" /></th>
						   <th width="15%"><i18n:message key="requisicaoProduto.enderecoEntrega" /></th>
...
<div id="POPUP_ITEM_COTACAO" title="<i18n:message key="itemCotacao.tituloEspecificacao"/>"  style="overflow: hidden;">
