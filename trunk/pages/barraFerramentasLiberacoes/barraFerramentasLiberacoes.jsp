...
<html>
	<head>
		...
		<style>
			#barraFerramentasLiberacoes ul li.li_menu {
				float: left;
				width: 85px;
				height: 50px;
			}
...
/* 
	...
	<body>
		...
		<input type="hidden" id="idRequisicaoLiberacao" />		<!-- value="1"  -->
...
<!-- 				</li> -->
		...
		<div class="POPUP_barraFerramentasLiberacoes" id="POPUP_menuAnexos" style="display:none">		
			<form name="formUpload" method="post" enctype="multipart/form-data" id='formularioDeAnexos'>
				<div  id="msgGravarDadosFalha" style="display:none">
					<h2><font color="red"><i18n:message key="baseconhecimento.pastaNaoCriada" /></font><br /></h2>
				</div>
		...
		<div class="POPUP_barraFerramentasLiberacoes" id="POPUP_menuOcorrencias" title="<i18n:message key='citcorpore.comum.ocorrencia' />">		
			<!-- Conteudo -->
			...
			<div id="main_container" class="container_16 clearfix">
				<div class="box grid_16 tabs">
					...
					<div class="toggle_container">
						<form name="formOcorrenciaLiberacao" method="post" 
							action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/ocorrenciaLiberacao/ocorrenciaLiberacao">
