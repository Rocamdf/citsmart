		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li>
						<a href="#tabs-1"><i18n:message key="moeda.cadastro" /></a>
					</li>
					<li>
						<a href="#tabs-2" class="round_top"><i18n:message key="moeda.pesquisa" /></a>
					</li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/moeda/moeda'>
										...
										<div class="col_40">
											<fieldset>
												<label class="campoObrigatorio">
													<i18n:message key="moeda.nomeMoeda" />
												</label>
												<div>
													<input type='text' id="nomeMoeda" name="nomeMoeda" maxlength="50" size="50"	class="Valid[Required] Description[<i18n:message key="moeda.nomeMoeda"/>]" />
												</div>
											</fieldset>
										</div>
										<div class="col_40">
											<fieldset>
												<div>
													...
													<i18n:message key="moeda.usarCotacao" />
												</div>
											</fieldset>
										</div>
									</div>
								...
								<button type='button' name='btnGravar' class="light"
									...
									<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/pencil.png"> <span><i18n:message key="citcorpore.comum.gravar" /></span>
								</button>
