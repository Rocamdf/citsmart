...
<head>
 ...
 <%@include file="/novoLayout/common/include/libCabecalho.jsp" %>
	...
	$(function() {
        ...
        function limpar(){
    	  window.location = '<%=Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/analiseSolicitacaoCargo/analiseSolicitacaoCargo.load';
        } 
    ...
    <div class="box grid_16 tabs" style='margin: 0px 0px 0px 0px;'>
        <div class="toggle_container">
            <div id="tabs-2" class="block" style="overflow: hidden;">
                        <form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/analiseSolicitacaoCargo/analiseSolicitacaoCargo'>
								...
								<div class="col_100">
								<h2 id="tituloSituacao" class="section"><i18n:message key="Análise"/></h2>
								</div>
								<div class="col_100">				
									<fieldset>
											<div>
												<label style="cursor: pointer"><input type='radio' style="cursor: pointer" name='situacao' value='A' class='Valid[Required] Description[Situação da solicitação]' onclick='configuraSituacao()'/><i18n:message key="analiseSolicitacaoCargo.aprovada"/></label>
	                                            <label style="cursor: pointer"><input type='radio' style="cursor: pointer" name='situacao' value='X' class='Valid[Required] Description[Situação da solicitação]' onclick='configuraSituacao()'/><i18n:message key="analiseSolicitacaoCargo.naoAprovada"/></label>
											</div>
		...
		<div id='divSelecao' style='height:180px;width:340px;overflow: auto;'>
			<table class="table" id="tblSelecao">
				<tr>
					...
					<th style="width: 49%;"><i18n:message key="rh.detalhes"/></th>
				</tr>
			</table>
		</div>
