			...
			<div id="wrapper">
				...
				<div id="">
					<div class='box-generic'>
						<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/historicoAcaoCurriculo/historicoAcaoCurriculo'>
					...
					<div class="widget-head">
						<ul>
							<li class="active"><a class="glyphicons coffe_cup" href="#tab-1" data-toggle="tab"><i></i>Ações do currículo</a></li>
							<li class=""><a class="glyphicons list" href="#tab-2" data-toggle="tab"><i></i>Histórico de ações</a></li>
						</ul>
					</div>
					...
					<div class="widget-body">
						<div class="tab-content">
							...
							<div class='row-fluid'>
								...
								<div class='span12'>
									<label class='strong'>Por favor, informe a Justificativa*</label>
									<select id='idJustificativaAcaoCurriculo' name='idJustificativaAcaoCurriculo' class='Valid[Required] Description[Justificativa]'>
									</select>
								</div>
								<div class='span12'>
									<label class='strong'>Por favor, informe o complemento da justificativa*</label>
									<textarea rows="3" cols="70" class='span6 Valid[Required] Description[Complemento da Justificativa]' id='complementoJustificativa' name='complementoJustificativa' onkeyup="contCaracteres(this.value)" onkeydown="contCaracteres(this.value)" onFocus="contCaracteres(this.value)"> </textarea>
								</div>
								<div class='span8'>(caracteres restantes: <span id="cont">200</span>)<br></div>
							
							</div>
							<div style="margin: 0;" class="form-actions">
								<div id='divInserirListaNegra'>
								<!-- S = Está na lista negra  -->
									<button type="button" id='btnInserirListaNegra' class='btn btn-warning' data-loading-text='Inserido.' onclick="gravar('S')">Inserir na lista Negra</button>
								</div>
								<div id='divRetirarListaNegra' >
								<!-- N = Não está na lista negra  -->
									<button type="button" id='btnRetirarListaNegra' class='btn btn-primary' data-loading-text='Retirado.' onclick="gravar('N')">Remover da lista Negra</button>
								</div>
							</div>
							</div>
