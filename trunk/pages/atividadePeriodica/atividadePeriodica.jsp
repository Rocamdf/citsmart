		...
		<script type="text/javascript">
			...
			exibeIconesOS = function(row, obj) {
	        	...
	        	if (document.form.idSolicitacaoServico.value == undefined 
	        		...
	        		row.cells[0].innerHTML = '<img src="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/imagens/excluirPeq.gif" border="0" onclick="excluiOS(' 
			...
			exibeIconesAgendamento = function(row, obj) {
	        	...
	        	if (document.form.idSolicitacaoServico.value == undefined 
	        		...
	        		|| document.form.idSolicitacaoServico.value == ''
	        		|| document.form.idSolicitacaoServico.value == '0') {
		        	row.cells[0].innerHTML = '<img src="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/imagens/edit.png" border="0" onclick="exibeAgendamento(' 
		        			+ row.rowIndex + ')" style="cursor:pointer" />';
		        	row.cells[1].innerHTML = '<img src="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/imagens/excluirPeq.gif" border="0" onclick="excluiAgendamento(' 
		        			+ row.rowIndex + ', this)" style="cursor:pointer" />';
				}
			};
		...
		<div id="wrapper">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">					
					<h2><i18n:message key="citcorpore.ui.pagina.atividadePeriodica.titulo" /></h2>
				</div>								
				<div class="box grid_16 tabs">
					<ul class="tab_header clearfix">						
						...
						<li>
							<a href="#tabs-2" class="round_top"><i18n:message key="citcorpore.ui.aba.titulo.Pesquisa" /></a>
						</li>
					</ul>
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">
								<form name="form" action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/atividadePeriodica/atividadePeriodica">
									...
									<table id="tabFormulario" cellpadding="0" cellspacing="0">
										<tr>											
											<td class="campoEsquerda campoObrigatorio"><i18n:message key="citcorpore.ui.rotulo.Cadastro" />:</td>											
											<td>
										...
										<tr>											
											<td class="campoEsquerda campoObrigatorio"><i18n:message key="citcorpore.ui.rotulo.Grupo_de_Atividades" />:</td>
											<td>
												<select name="idGrupoAtvPeriodica" class="Valid[Required] Description[citcorpore.ui.rotulo.Grupo_de_Atividades]"></select>
											</td>
										</tr>
										<tr>											
											<td class="campoEsquerda campoObrigatorio"><i18n:message key="citcorpore.ui.rotulo.Titulo_da_Atividade" />:</td>
											<td>
										...
										<tr>											
											<td class="campoEsquerda" style="vertical-align: middle;"><i18n:message key="citcorpore.ui.rotulo.mudanca" />:</td>
											<%
											...
											<td>
												<table>
													<tr>
														...
														<td>
															<img src='<%=Constantes.getValue("SERVER_ADDRESS")%><%=Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/clear.png' style='cursor:pointer' border='0' onclick='limparMudanca()'/>
														</td>
													</tr>
												</table>
										...
										<tr>											
											<td class="campoEsquerda"><i18n:message key="citcorpore.ui.rotulo.blackout" />:</td>
											<td>
												<input type="checkbox" name="blackout" value="S"/>
											</td>
										</tr>
										<tr>											
											<td class="campoEsquerda"><i18n:message key="citcorpore.ui.rotulo.Descricao_da_Atividade" />:</td>
											<td><textarea name="descricao" cols="70" rows="5" style="border: 1px solid black"></textarea></td>
										</tr>
										<tr>											
											<td class="campoEsquerda"><i18n:message key="citcorpore.ui.rotulo.Orientacao_Tecnica" />:</td>
										...
										<tr>
											<td colspan="2" style="text-align: left;" id="tdBotaoNovaOs">
												<button type="button" 
													...
													<span style="font-size: 12px !important;"><i18n:message key="citcorpore.ui.botao.rotulo.Vincular_OS" /></span>													
												</button>
											</td>
										</tr>
										<tr>
												...
												<div id="divOS"	style="height: 120px; width: 940px; overflow: auto; border: 1px solid black;">
													<table id="tblOS" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															...
															<td></td>															
													 		<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Numero" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Area_requisitante" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Tarefa_Demanda" /></td>
														</tr>
													</table>
												</div>
											</td>
										...
										<tr>
											<td colspan="2" style="text-align: left;" id="tdBotaoNovoAgendamento">
												<button type="button" 
													...
													class="light img_icon has_text">
													<img src="<%= br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO") %>/template_new/images/icons/small/grey/pencil.png">													
													<span style="font-size: 12px !important;"><i18n:message key="citcorpore.ui.botao.Novo_Agendamento" /></span>
												</button>
											</td>
										</tr>
										<tr>
												...
												<div id="divAgendamentos" style="height: 120px; width: 940px; overflow: auto; border: 1px solid black;">
													<table id="tblAgendamentos" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td style="text-align: center" class="linhaSubtituloGrid" width="16px">&nbsp;</td>
															<td style="text-align: center" class="linhaSubtituloGrid" width="16px">&nbsp;</td>											
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Tipo_de_agendamento" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Atividade_OS" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Data_inicio" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Detalhamento" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Duracao_estimada" /></td>
															<td class="linhaSubtituloGrid"><i18n:message key="citcorpore.ui.tabela.coluna.Repeticao" /></td>
														</tr>
													</table>
												</div>
											</td>
														...
														<tr>
															<td id="tdBotaoGravar">
																<button type="button" 
																	...
																	<img src="<%= br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO") %>/template_new/images/icons/small/grey/pencil.png" />																	
																	<span>
																		<i18n:message key="citcorpore.ui.botao.rotulo.Gravar" />
																	</span>
																</button>
															</td>
															<td>
						...
						<div id="tabs-2" class="block">
							<div class="section">
								<i18n:message key="citcorpore.ui.aba.titulo.Pesquisa" />
...
<!-- </body> -->
		<div id="POPUP_OS" title=<i18n:message key="citcorpore.ui.janela.popup.titulo.Adicionar_OS" />>
			<form name="formOS" action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/os/os">
		...
		<div id="POPUP_MUDANCA" title=<i18n:message key="solicitacaoServico.adicionarMudanca" />>
			<form name="formMudanca" action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/os/os">
		...
		<div id="POPUP_AGENDAMENTO" title=<i18n:message key="citcorpore.ui.janela.popup.titulo.Agendamento" />>
			<form name="formAgendamento" action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/programacaoAtividade/programacaoAtividade">
				...
				<input type="hidden" name="sequencia" id="sequencia" />
		 		...
		 		<div class='row-fluid'>
	 				<div class='span12 innerAll'>
			 			<div class='row-fluid'>
			 				<div class='span12'>
								<label class="campoObrigatorio"><i18n:message key="citcorpore.ui.rotulo.Tipo_de_agendamento" /></label>
								<select name="tipoAgendamento" id="tipoAgendamento" onchange="configuraAgendamento(this);">
									<option value="D">
										<i18n:message key="citcorpore.texto.frequencia.diariamente" />
									</option>
									<option value="S">
										<i18n:message key="citcorpore.texto.frequencia.semanalmente" />
									</option>
									<option value="M">
										<i18n:message key="citcorpore.texto.frequencia.mensalmente" />
									</option>
									<option value="U">
										<i18n:message key="citcorpore.texto.frequencia.umaVez" />
									</option>
								</select>
							</div>
			 			</div>
						<div class='row-fluid'>
			 				<div class='span12'>
								<label class="campoObrigatorio"><i18n:message key="citcorpore.agendamento.Inicia_em" /></label>
								...
								<b><i18n:message key="citcorpore.agendamento.as" /></b>
						...
						<div id="divDataFinal" class='row-fluid'>
			 				<div class='span4'>
								<label><i18n:message key="citcorpore.agendamento.Expira_em" /></label>
								<input type="text" name="dataFim" id="dataFim" size="10" maxlength="10" class="Format[Date] text datepicker" />
							</div>
						</div>
						<div class='row-fluid'>
							<div class='span12'>
								<label class="campoObrigatorio"><i18n:message key="citcorpore.agendamento.Duracao_estimada" /></label>
								<div class='displayInBk'>
									<input type="text" name="duracaoEstimada" id="duracaoEstimada" size="5" maxlength="5" class="Format[Numero] text" />
								</div>
								<b><i18n:message key="citcorpore.texto.tempo.minutoS" /></b>
							</div>
						</div>
						<div id="divConfigTarefaD" class='row-fluid'>
			 				<div class='span6'>
								<label><i18n:message key="citcorpore.agendamento.Agendar_atividade_diaria" /></label>
								<i18n:message key="citcorpore.agendamento.atividade.A_cada" />
								<div class='displayInBk'>
									<input type="text" name="periodicidadeDiaria" size="5" maxlength="5" class="Format[Numero] text" />
								</div>
								<i18n:message key="citcorpore.texto.tempo.diaS" />
							</div>
						</div>
						<div id="divConfigTarefaS" class='row-fluid hide'>
							 <div class='span6'>
								<label><i18n:message key="citcorpore.agendamento.Agendar_atividade_semanal" /></label>
								
								<i18n:message key="citcorpore.agendamento.atividade.A_cada" />
								<div class='displayInBk'>
									<input type="text" name="periodicidadeSemanal" size="5" maxlength="5" class="Format[Numero]" />
								</div>
								<i18n:message key="citcorpore.agendamento.atividade.semanaS_na_BARRA_no" />
							</div>
							 <div class='span6'>
								<table cellpadding="0" cellspacing="0">
									<tr>
										<td width="70px">												
											<input type="checkbox" name="seg" id="seg" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.segundaFeira" /></span>
										</td>
										<td>												
											<input type="checkbox" name="sex" id="sex" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.sextaFeira" /></span>
										</td>
									</tr>
									<tr>
										<td>
											<input type="checkbox" name="ter" id="ter" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.tercaFeira" /></span>
										</td>
										<td>
											<input type="checkbox" name="sab" id="sab" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.sabado" /></span>
										</td>
									</tr>
									<tr>
										<td>
											<input type="checkbox" name="qua" id="qua" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.quartaFeira" /></span>
										</td>
										<td>
											<input type="checkbox" name="dom" id="dom" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.domingo" /></span>
										</td>
									</tr>
									<tr>
										<td>
											<input type="checkbox" name="qui" id="qui" value="S" /><span class="campoEsquerda"><i18n:message key="citcorpore.texto.abreviado.diaSemana.quintaFeira" /></span>
										</td>
									</tr>
								</table>
							</div>
						...
						<div id="divConfigTarefaM" class='row-fluid hide'>
							 <div class='span12'>
								<label><i18n:message key="citcorpore.agendamento.Agendar_atividade_mensal" /></label>
								<div class='row-fluid'>
							 		<div class='span2 uniformjs'>
										<label class="radio">
											<input type="radio" style="cursor: pointer" name="periodicidadeMensal" value="1" />
											<i18n:message key="citcorpore.texto.tempo.Dia" />
										</label>
							 		</div>
							 		<div class='span3'>
										...
										%>
											<option value="99">
												<i18n:message key="citcorpore.texto.adjetivo.ultimo" />
											</option>
										</select>
									</div>
									<div class='span7'>
										<i18n:message key="citcorpore.agendamento.atividade.dos_meses_selecionados" />
							 		</div>
						 		</div>
						 		<div class='row-fluid'>
							 		<div class='span2 uniformjs'>
										<label class="radio">
											...
											<i18n:message key="citcorpore.agendamento.atividade.O" />
										</label>
							 		</div>
							 		<div class='span3'>
											...
											<%
												for (int i = 1; i <= 23; i++) {
													...
													switch (i) {
														case 1:
											%>
															<i18n:message key="citcorpore.texto.sufixo.ordemNumero.primeiro" /></option>										
											<%
														break;
														case 2:
											%>
															<i18n:message key="citcorpore.texto.sufixo.ordemNumero.segundo" /></option>										
											<%
														break;
														case 3:
											%>
															<i18n:message key="citcorpore.texto.sufixo.ordemNumero.terceiro" /></option>										
											<%
														break;										
														default:
											%>
															<i18n:message key="citcorpore.texto.sufixo.ordemNumero.masculino" /></option>
											<%												 		
													}
												}
											%>
									...
									<div class='span7'>
										<i18n:message key="citcorpore.agendamento.atividade.dia_util_meses_dos_selecionados" />
							 		</div>
						 		</div>
						 		...
						 		<div class='row-fluid'>
							 		<div class='span2 uniformjs'>
										<label class="radio">
											...
											<i18n:message key="citcorpore.agendamento.atividade.A_BARRA_O" />
										</label>
							 		</div>
							 		<div class='span3'>
										<select name="seqDiaSemana" id="seqDiaSemana">
											<option value="1"><i18n:message key="citcorpore.texto.numeral.ordinal.primeraO" /></option>
											<option value='2'><i18n:message key="citcorpore.texto.numeral.ordinal.segundaO" /></option>
											<option value='3'><i18n:message key="citcorpore.texto.numeral.ordinal.terceiraO" /></option>
											<option value='4'><i18n:message key="citcorpore.texto.numeral.ordinal.quartaO" /></option>
											<option value='5'><i18n:message key="citcorpore.texto.adjetivo.ultimaO" /></option>
										</select> 
										<select name='diaSemana'>
											<option value='2'>
												<i18n:message key="citcorpore.texto.diaSemana.segundaFeira" />
											</option>
											<option value='3'>
												<i18n:message key="citcorpore.texto.diaSemana.tercaFeira" />
											</option>
											<option value='4'>
												<i18n:message key="citcorpore.texto.diaSemana.quartaFeira" />
											</option>
											<option value='5'>
												<i18n:message key="citcorpore.texto.diaSemana.quintaFeira" />
											</option>
											<option value='6'>
												<i18n:message key="citcorpore.texto.diaSemana.sextaFeira" />
											</option>
											<option value='7'>
												<i18n:message key="citcorpore.texto.diaSemana.sabado" />
											</option>
											<option value='1'>
												<i18n:message key="citcorpore.texto.diaSemana.domingo" />
											</option>
										</select>
									</div>
									<div class='span7'>
						 		...
						 		<div class='row-fluid'>
							 		<div class='span12'>
							 			<div class='row-fluid'>
									 		<div class='span12'>
										 		<i18n:message key="citcorpore.agendamento.atividade.Selecione_meses_atividade_executada" />									 			
									 		</div>
								 		</div>
							 			<div class='row-fluid'>
									 		<div class='span6'>
												<label class="radio">
													...
													<i18n:message key="citcorpore.texto.mes.janeiro" />
												</label>
									 		</div>
									 		<div class='span6'>
												<label class="radio">
													<input type="checkbox" name="jul" id="jul" value="S" />
													<i18n:message key="citcorpore.texto.mes.julho" />
												</label>
									 		</div>
									 	</div>
									 	<div class='row-fluid'>
									 		<div class='span6'>
												<label class="radio">
													...
													<i18n:message key="citcorpore.texto.mes.fevereiro" />
												</label>
									 		</div>
									 		<div class='span6'>
												<label class="radio">
													<input type="checkbox" name="ago" id="ago" value="S" />
													<i18n:message key="citcorpore.texto.mes.agosto" />
												</label>
									 		</div>
									 	</div>
									 	<div class='row-fluid'>
									 		<div class='span6'>
												<label class="radio">
													...
													<i18n:message key="citcorpore.texto.mes.marco" />
												</label>
									 		</div>
									 		<div class='span6'>
												<label class="radio">
													<input type="checkbox" name="set" id="set" value="S" />
													<i18n:message key="citcorpore.texto.mes.setembro" />
												</label>
									 		</div>
									 	</div>
									 	<div class='row-fluid'>
									 		<div class='span6'>
												<label class="radio">
													...
													<i18n:message key="citcorpore.texto.mes.abril" />
												</label>
									 		</div>
									 		<div class='span6'>
												<label class="radio">
													<input type="checkbox" name="out" id="out" value="S" />
													<i18n:message key="citcorpore.texto.mes.outubro" />
												</label>
									 		</div>
									 	</div>
									 	<div class='row-fluid'>
									 		<div class='span6'>
												<label class="radio">
													...
													<i18n:message key="citcorpore.texto.mes.maio" />
												</label>
									 		</div>
									 		<div class='span6'>
												<label class="radio">
													<input type="checkbox" name="nov" id="nov" value="S" />
													<i18n:message key="citcorpore.texto.mes.novembro" />
												</label>
									 		</div>
									 	</div>
									 	<div class='row-fluid'>
									 		<div class='span6'>
												<label class="radio">
													...
													<i18n:message key="citcorpore.texto.mes.junho" />
												</label>
									 		</div>
									 		<div class='span6'>
												<label class="radio">
													<input type="checkbox" name="dez" id="dez" value="S" />
													<i18n:message key="citcorpore.texto.mes.dezembro" />
												</label>
									 		</div>
									 	</div>
						...
						<div class='row-fluid'>
					 		<div class='span12'>
								<label class="radio">
									...
									<i18n:message key="citcorpore.agendamento.atividade.Repetir_agendamento_no_dia" />
								</label>
					 		</div>
					 	</div>
					 		...
					 		<div class='span6'>
								...
								<div class='displayInBk'>
									<select name="repeticaoTipoIntervalo" id="repeticaoTipoIntervalo">
										<option value="M">
											<i18n:message key="citcorpore.texto.tempo.minutos" />
										</option>
										<option value="H">
											<i18n:message key="citcorpore.texto.tempo.horas" />
										</option>
									</select>
								</div>
							</div>
							<div class='span6'>
								<i18n:message key="citcorpore.texto.Ate" />
					 	...
					 	<div class='row-fluid'>
					 		<div class='span12'>
								<button type="button" id="btnGravarAgendamento"	name="btnGravarAgendamento"	style="margin-top: 5px; margin-left: 3px;"	class="light img_icon has_text" onclick="atualizaAgendamento();">
									<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/pencil.png">
									<span> <i18n:message key="citcorpore.ui.botao.rotulo.Gravar" /></span>
								</button>
								...
								<button type="button" id="btnFecharAgendamento"	name="btnFecharAgendamento"	style="margin-top: 5px; margin-left: 3px;"	class="light img_icon has_text" onclick="fecharAgendamento()">
									<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/clear.png">
									<span> <i18n:message key="citcorpore.ui.botao.rotulo.Fechar" />	</span>
								</button>
							</div>
					 	</div>
					</div>					
