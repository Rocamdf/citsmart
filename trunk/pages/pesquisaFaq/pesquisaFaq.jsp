...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			pesquisarFaq = function() {
				...
				$('#conhecimento').hide();
				document.formPesquisa.fireEvent('pesquisaBaseConhecimentoTipoFaq');
	...
	<div class="ui-layout-north">
		...
		<div class="ui-layout-west">
			   <div  class="pastas">
					<form name='form2' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/pesquisaFaq/pesquisaFaq'>
					...
					<div class="toggle_container" >
						...
						<div id="tabs-1" class="block">
							...
							<div id="divpesquisa" class="section">
								<form name='formPesquisa' id='formPesquisa' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/pesquisaFaq/pesquisaFaq'>
								...
								<div class="section" id="conhecimento">
									<form id="form" name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/pesquisaFaq/pesquisaFaq'>
										...
										<div class="columns clearfix">
											...
											<div class="columns clearfix">
												<div  class="col_50">			
													<fieldset >
													<label ><i18n:message key="citcorpore.comum.resposta"/></label>	
														<div  id="conteudo">
														</div>
													</fieldset>
												</div>
