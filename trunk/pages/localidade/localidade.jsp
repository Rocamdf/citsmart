	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="localidadeFisica.localidadeFisica" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="localidadeFisica.cadastro" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="localidadeFisica.pesquisa" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/localidade/localidade'>
								<input type='hidden' name='idLocalidade' /> 
								<input type='hidden' name='dataInicio' id="dataInicio" />
								<input type='hidden' name='dataFim' id="dataFim" />
								<div class="columns clearfix">
									<div class="col_66">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="localidadeFisica.nomeLocalidade" /></label>
											<div>
												<input type='text' id="nomeLocalidade" name="nomeLocalidade" maxlength="255" class="Valid[Required] Description[localidadeFisica.nomeLocalidade]" />
											</div>
										</fieldset>
									</div>
								</div>
					...
					<div id="tabs-2" class="block">
						<div class="section">
							...
							<form name='formPesquisa'>
								<cit:findField formName='formPesquisa'lockupName='LOOKUP_NOVALOCALIDADE' id='LOOKUP_LOCALIDADE' top='0'left='0' len='550' heigth='400' javascriptCode='true' htmlCode='true' />
							</form>
						</div>
					</div>
