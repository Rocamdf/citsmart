		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="relatorioAcompanhamento.relatorioAcompanhamento" /></a></li>
				</ul>
				<div class="toggle_container">
					<div class="block" >
						...
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/relatorioAcompanhamento/relatorioAcompanhamento'>
								<div class="columns clearfix">
									<div class="col_25">
										<fieldset style="height: 53px">
											<label class="campoObrigatorio"><i18n:message key="contrato.contrato" /></label>
											<div>
												<select class="Valid[Required] Description[contrato.contrato]" id="idContrato"  name="idContrato"></select   >
											</div>
										</fieldset>
									</div>
								</div>
								<div class="col_100">
									...
									<button type='button' name='btnRelatorio' class="light"
											onclick="imprimirRelatorioDeAcompanhamento()"
										...
										<button type='button' name='btnRelatorio' class="light"
											onclick="imprimirRelatorioDeAcompanhamentoXls()"
											style="margin: 20px !important;">
											<img
