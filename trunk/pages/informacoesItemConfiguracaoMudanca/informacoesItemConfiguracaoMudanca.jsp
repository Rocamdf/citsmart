...
<title><i18n:message key="citcorpore.comum.title" /></title> <%@include file="/include/noCache/noCache.jsp" %> <%@include file="/include/header.jsp" %> <%@include file="/include/javaScriptsComuns/javaScriptsComuns.jsp"%>
	...
	<body id="bodyInf">	
		...
		<div class="tabs">
			<ul class="tab_header clearfix">
				<li><a href="#tabs-1" onclick="showRelacionamentos()"><i18n:message	key="tipoItemConfiguracao.informacoesItemConfiguracao"  /></a></li>
...
<%-- 				<li><a href="#tabs-3" class="round_top"><i18n:message key="inventario.invetario" /></a></li> --%>
			...
			<div class="toggle_container">
				<div id="tabs-1" class="block">
					<div class="section">
		<form name='form'  id='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/informacoesItemConfiguracaoMudanca/informacoesItemConfiguracaoMudanca'>
			...
			<div id="principalInf" style="display: none;"></div>
				<div id="itemConfiguracaoCorpo">
					<table>
						<tr>
							...
							<%-- <td>
								<img src='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/imagens/linkimpacto.png' border='0' style='cursor:pointer' onclick='verificaImpactos()'/>
							</td> --%>
						</tr>
					</table>
					<div id="itemPai" style="line-height: 20px;display: none;">
						<input type="button" id="addItemConfiguracaoPai" name="addItemConfiguracaoPai" class="padd10 lFloat" maxlength="70" size="70" value='<i18n:message key="itemConfiguracaoTree.mudarItemRelacionado"/>' />
				...
				<div class="columns clearfix">
					...
					<div class="col_20">
						<fieldset>
							<label style="cursor: pointer;"><i18n:message key="citcorpore.comum.responsavel"/></label>
							<div> 
	...
	<div id="popupCadastroRapido">
		...
		<div id="POPUP_GRUPOITEMCONFIGURACAO" title="<i18n:message key="itemConfiguracaoTree.consultaGrupoItemConfiguracao"/>">
		...
		<div id="POPUP_ITEMCONFIGPAI" title="<i18n:message key="citcorpore.comum.identificacao" />">
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div id="tabs-2" class="block">
						<div class="section">
		...
		<div id="POPUP_TIPOITEMCONFIGURACAO" title="<i18n:message key="itemConfiguracaoTree.consultaTipoItemConfiguracao"/>" style="display: none;">
			<div class="box grid_16 tabs">
					<div class="toggle_container">
						<div id="tabs-2" class="block">
							<div class="section">
		...
		<div id="POPUP_EMPREGADO" title='<i18n:message key="itemConfiguracaoTree.pesquisaEmpregado"/>'>
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div id="tabs-2" class="block">
						<div class="section">
		...
		<div id="POPUP_RESPONSAVEL" title='<i18n:message key="citcorpore.comum.responsavel"/>'>
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div id="tabs-2" class="block">
						<div class="section">
							<div  align="right">
								<label  style="cursor: pointer; ">
									<i18n:message key="colaborador.colaborador"/>
									<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" onclick="popup.abrePopup('responsavel')">
								</label>
							</div>
						...
						<div class="section" style='overflow: auto'>
							<div  align="right">
								<label  style="cursor: pointer; ">
										...
										<img id='botaoSolicitante' src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" onclick="popupManagerSolicitacaoServico.abrePopupParms('solicitacaoServicoMultiContratos', '', '&selecaoIc=true');">
								</label>
							</div>
		...
		<div id="POPUP_PROBLEMA" title='<i18n:message key="itemConfiguracaoTree.pesquisaProblema"/>'>
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div id="tabs-2" class="block">
						<div class="section">
							<div  align="right">
								<label  style="cursor: pointer; ">
									...
									<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" onclick="popup.abrePopup('problema')">	
								</label>
							</div>
		...
		<div id="POPUP_MUDANCA" title='<i18n:message key="itemConfiguracaoTree.pesquisaMudanca"/>'>
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div id="tabs-2" class="block">
						<div class="section">
							<div  align="right">
								...
								<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" onclick="popup.abrePopup('requisicaoMudanca')">	
								</label>
							</div>
		...
		<div id="POPUP_LIBERACAO" title='<i18n:message key="gerenciarequisicao.pesquisaliberacao"/>'>
			<div class="box grid_16 tabs">
				<div class="toggle_container">
					<div id="tabs-2" class="block">
						<div class="section">
							<div  align="right">
								...
								<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" onclick="popup.abrePopup('requisicaoLiberacao')">	
								</label>
							</div>
		...
		<div id="POPUP_IMPACTO" title="<i18n:message key="itemConfiguracaoTree.impactos"/>">
