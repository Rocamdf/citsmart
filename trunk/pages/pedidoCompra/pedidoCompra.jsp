...
<%@include file="/include/javaScriptsComuns/javaScriptsComuns.jsp"%>
    <script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/cit/objects/ItemPedidoCompraDTO.js"></script>
...
<script>
	...
	var popupProduto;
    function load() {
		popupProduto = new PopupManager(1000, 680, "<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/");
    ...
    function gerarImgAlteracao(row, obj) {
        row.cells[0].innerHTML = '<img style="cursor: pointer;" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/btnAlterarRegistro.gif" />';
    }   
...
<div class="box grid_16 tabs">
    <form name='form'
        action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/pedidoCompra/pedidoCompra'>
        <div class="columns clearfix">
            ...
            <div class="section">
              <div class="col_40">
                     <h2 class="section">
                         <i18n:message key="cotacao.pedidosIncluidos" />
                     </h2>
                     <div class="col_100" style='height:190px;overflow:auto' >
                         <table id="tblPedidos" class="table">
                             <tr>
                                 <th width="1%"></th>
                                 <th width="15%"><i18n:message key="citcorpore.comum.numero" /></th>
                                 <th><i18n:message key="fornecedor" /></th>
                                 <th width="30%"><i18n:message key="citcorpore.comum.situacao" /></th>
                             </tr>
                         </table>
                     </div>
              </div>
              <div class="col_60">
                     <h2 class="section">
                         <i18n:message key="pedidoCompra" />
                     </h2>
                     <div class="col_100">
                                <div class="col_50">
                                     <fieldset >
                                         <label class="campoObrigatorio" style="cursor: pointer;"><i18n:message key="fornecedor" /></label>
                                         <div>
                                ...
                                <div class="col_25">
                                    <fieldset >
                                        <label class="campoObrigatorio"><i18n:message key="pedidoCompra.dataPedido" />
                                        </label>
                                            <div>
                     ...
                     <div class="col_100">
                                <div class="col_33">
                                    <fieldset >
                                        <label class="campoObrigatorio"><i18n:message key="pedidoCompra.dataPrevistaEntrega" />
                                        </label>
                                            <div>
                                ...
                                <div class="col_33">
                                    <fieldset >
                                        <label><i18n:message key="pedidoCompra.identificadorEntrega" />
                                        </label>
                                        <div>
                               ...
                               <div class="col_33">
                                    <fieldset >
                                        <label ><i18n:message key="pedidoCompra.numeroNF" />
                                        </label>
                                        <div>
                     ...
                     <div class="col_100">
                                <div class="col_80">
                                     <fieldset >
                                         <label class="campoObrigatorio" style="cursor: pointer;"><i18n:message key="requisicaoProduto.enderecoEntrega" /></label>
                                         <div>
                                ...
                                <div class="col_20">
                                    <fieldset >
                                        <label ><i18n:message key="pedidoCompra.valorFrete" />
                                        </label>
                                        <div>
                     ...
                     <div class="col_100">
                         <fieldset>
                             <label><i18n:message key="citcorpore.comum.observacoes" />
                             </label>
                             <div>
                     ...
                     <div class="col_100">
                         <div class="col_60">
                             <h2 class="section">
                                 <i18n:message key="pedidoCompra.itens" />
                             </h2>
                         </div>
                         <div id="divCarregarItens" class="col_20" style='margin-top:10px'>
                             <label  style="cursor: pointer;" onclick='carregarItens();'>
                                 <img  src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/list.png" /><span><b><i18n:message key="pedidoCompra.carregarItens" /></b></span>
                             </label>
                         </div>                         
                     ...
                     <div class="col_100" class="col_100" style='height:150px;overflow:auto;'>
                         <table id="tblItensPedido" class="table">
                             <tr>
                                 ...
                                 <th width="10%"><i18n:message key="itemPedidoCompra.valorTotal" /></th>
                             </tr>
                         </table>
                     </div>
                     <div class="col_100">
                          <fieldset>
                           <label ><h2><i18n:message key="citcorpore.comum.anexos"/></h2></label>   
                               <cit:uploadControl  style="height:10%;width:100%; border-bottom:1px solid #DDDDDD ; border-top:1px solid #DDDDDD "  title="<i18n:message key='citcorpore.comum.anexos' />" id="uploadAnexos" form="document.form" action="/pages/upload/upload.load" disabled="false"/>
                          </fieldset>
                     </div> 
                     <div class="col_100">
                           <button type='button' name='btnGravar' id='btnGravar' class="light" style='margin-top: 10px !important'
                               onclick='gravar();'>
                               <img
                                   src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/create_write.png">
...
<div id="POPUP_ITEM_PEDIDO" title="<i18n:message key="pedidoCompra.itens" />"  style="overflow: hidden;">
    <form name='formItemPedido'>
        ...
        <div class="col_100"> 
            <div class="col_75">
                <fieldset >
                    <label class="campoObrigatorio" style="cursor: pointer;"><i18n:message key="coletaPreco.item" /></label>
                    <div>
            ...
            <div class="col_25">
                <fieldset >
                    <label class="campoObrigatorio"><i18n:message key="itemPedidoCompra.quantidade" />
                    </label>
                    <div>
        ...
        <div class="col_100">            
            <div class="col_33">
                <fieldset >
                    <label ><i18n:message key="itemPedidoCompra.valorTotal" />
                    </label>
                    <div>
            ...
            <div class="col_33">
                <fieldset >
                    <label ><i18n:message key="itemPedidoCompra.valorDesconto" />
                    </label>
                    <div>
                       <input id="item#valorDesconto" type='text' name="item#valorDesconto" class="Format[Moeda] Description[itemPedidoCompra.valorDesconto]"  readonly="readonly"/>     
                    </div>
                </fieldset>
            </div>
            <div class="col_33">
       ...
       <!-- <div class="col_100"> 
            <div class="col_33">
                <fieldset >
                    <label ><i18n:message key="itemPedidoCompra.baseCalculoIcms" />
                    </label>
                    <div>
            ...
            <div class="col_33">
                <fieldset >
                    <label ><i18n:message key="itemPedidoCompra.aliquotaICMS" />
                    </label>
                    <div>
            ...
            <div class="col_33">
                <fieldset >
                    <label ><i18n:message key="itemPedidoCompra.aliquotaIPI" />
                    </label>
                    <div>
