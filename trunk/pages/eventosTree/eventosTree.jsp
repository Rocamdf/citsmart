...
<body>
		...
		<div class="col_33">
			<fieldset>
				...
				<div class="inline clearfix">
					<label><input type='radio' id="ligarCasoDesl" name="ligarCasoDesl" value="S" class="Valid[Required] Description[Ligar a máquina]" /><i18n:message key="eventoItemConfiguracao.ligarMaquinaSim" /></label>
					<label><input type='radio' id="ligarCasoDesl" name="ligarCasoDesl" value="N" class="Valid[Required] Description[Ligar a máquina]" /><i18n:message key="eventoItemConfiguracao.ligarMaquinaNao" /></label>
				</div>
			</fieldset>
		</div>
	</div>
	...
	<div class="columns clearfix">
		<div class="col_100">
			<fieldset>
				<label class="campoObrigatorio" id="addGrupoItemConfig" style="cursor: pointer;" title="Clique para adicionar um grupo de item de configuração!"><i18n:message key="eventoItemConfiguracao.grupos" /><img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png"></label>
				<div>
	...
	<div class="columns clearfix">
		...
		<div class="col_33" id="divComandoLinux" style="display: none;">
			<fieldset>
				<label class="campoObrigatorio"><i18n:message key="eventoItemConfiguracao.linhaComandoLinux"/><img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/help_ico.gif" title="Linha de comando que virá antes do nome do arquivo de instalação no Linux"></label>
				<div>
