	...
	function addLinhaTabelaAtributosLdap(id, atributoLdap, valorAtributoLdap){
		...
		coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoLdap' + countAtributo + '" name="idAtributoLdap" value="' + id + '" />' + atributoLdap;
		coluna = row.insertCell(1);
		coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoLdap' + countAtributo + '" name="valorAtributoLdap" value="' + valorAtributoLdap + '"/>';
	}
	...
	function addLinhaEmail(id, atributo, valor, check){
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoEmail' + countEmail + '" name="idAtributoEmail" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoEmail' + countEmail + '" name="idAtributoEmail" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoEmail' + countEmail + '" size="40" name="valorAtributoEmail" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoEmail' + countEmail + '"  ' + checked + ' name="valorAtributoEmail" value="' + valor + '"/>';
		}
	}
	...
	function addLinhaLog(id, atributo, valor, check, required, func, valorFunc){
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoLog' + countLog + '" name="idAtributoLog" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoLog' + countLog + '" name="idAtributoLog" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoLog' + countLog + '" '+func+'='+valorFunc+' ' + require + ' size="40" name="valorAtributoLog" value="' + valor + '"/>';
		} else {
			if(valor=='true')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoLog' + countLog + '"  ' + checked + ' '+f+' name="valorAtributoLog" value="' + valor + '"  class="not" />';
		}
	}
	...
	function addLinhaGed(id, atributo, valor, check, required, func, valorFunc){
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoGed' + countGed + '" name="idAtributoGed" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoGed' + countGed + '" name="idAtributoGed" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoGed' + countGed + '" '+func+'='+valorFunc+' ' + require + '  size="40" name="valorAtributoGed" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoGed' + countGed + '"  ' + checked + ' '+func+'='+valorFunc+' name="valorAtributoGed" value="' + valor + '"/>';
		}
	}
	...
	function addLinhaSMTP(id, atributo, valor, check, arrClass){
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoSMTP' + countSMTP + '" name="idAtributoSMTP" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoSMTP' + countSMTP + '" name="idAtributoSMTP" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		var classes = setValid(arrClass);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoSMTP' + countSMTP + '" size="40" class="'+classes+'" name="valorAtributoSMTP" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoSMTP' + countSMTP + '"  ' + checked + ' name="valorAtributoSMTP" value="' + valor + '"/>';
		}
	}
	
	var countIC = 0;
	function addLinhaParametrosIC(id, atributo, valor, check, required, func, valorFunc, arrClass) {
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoIC' + countIC + '" name="idAtributoIC" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoIC' + countIC + '" name="idAtributoIC" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" class="'+classes+'" id="valorAtributoIC' + countIC + '" '+func+'='+valorFunc+' ' + require + '  size="40" name="valorAtributoIC" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoIC' + countIC + '" '+func+'='+valorFunc+' ' + checked + ' name="valorAtributoIC" value="' + valor + '"/>';
		}
	}
	
	var countBase = 0;
	function addLinhaParametrosBase(id, atributo, valor, check, required, func, valorFunc, arrClass){
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoBase' + countBase + '" name="idAtributoBase" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoBase' + countBase + '" name="idAtributoBase" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text"  maxlength="200" class="'+classes+'"  id="valorAtributoBase' + countBase + '" '+func+'='+valorFunc+' ' + require + ' size="40" name="valorAtributoBase" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoBase' + countBase + '" '+func+'='+valorFunc+' '  + checked + ' name="valorAtributoBase" value="' + valor + '"/>';
		}
	}
	
	var countGeral = 0;
	function addLinhaParametrosGerais(id, atributo, valor, check){
		...
		var checked = '';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoGeral' + countGeral + '" name="idAtributoGeral" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoGeral' + countGeral + '" name="idAtributoGeral" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoGeral' + countGeral + '" size="40" name="valorAtributoGeral" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoGeral' + countGeral + '"  ' + checked + ' name="valorAtributoGeral" value="' + valor + '"/>';
		}
	}
	...
	function serializaAtributosLdap() {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoLdap' + i) != "" && document.getElementById('idAtributoLdap' + i) != null) {
		...
		document.frmLDAP.listAtributoLdapSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosEmail() {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoEmail' + i) != "" && document.getElementById('idAtributoEmail' + i) != null) {
		...
		document.frmEmail.listAtributoEmailSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosLog () {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoLog' + i) != "" && document.getElementById('idAtributoLog' + i) != null) {
		...
		document.frmLog.listAtributoLogSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosGed () {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoGed' + i) != "" && document.getElementById('idAtributoGed' + i) != null) {
		...
		document.frmGed.listAtributoGedSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosSMTP() {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoSMTP' + i) != "" && document.getElementById('idAtributoSMTP' + i) != null) {
		...
		document.frmSMTP.listAtributoSMTPSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosIC() {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoIC' + i) != "" && document.getElementById('idAtributoIC' + i) != null) {
		...
		document.frmIC.listAtributoICSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosBase() {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoBase' + i) != "" && document.getElementById('idAtributoBase' + i) != null) {
		...
		document.frmBase.listAtributoBaseSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function serializaAtributosGerais() {
		...
		for ( var i = 1; i < count; i++) {
			if (document.getElementById('idAtributoGeral' + i) != "" && document.getElementById('idAtributoGeral' + i) != null) {
		...
		document.frmGeral.listAtributoGeraisSerializado.value = ObjectUtils.serializeObjects(listAtributos);
	}
	...
	function changeCheck() {
		...
		/*recarrega as configurações do defines*/
	...
	/** Autor: Thiago Matias
	 * Data: 30/08/2013
	 * Filtra todos os dados contidos na div
	 * deve ser chamada no input via onkeyup
	 * campoBusca: valor digitado no campo de filtro
	 * 	 
	 * **/
	...
	/** Autor: Thiago Matias
	 * Data: 09/09/2013
	 * Contador para textarea, informando e limitando a quantidade de caracteres digitados.
	 * Exemplo: catalogoServico.jsp
	 * **/
	...
	/** Autor: Thiago Matias
	 * Data: 11/09/2013
	 * Limpando textos salvos no banco com tags html.
	 * id = id do elemento a ser tratado
	 * texto = o texto que contem tags para ser retirados.
	 *
	 * **/
