		...
		<%if (iframe == null) {%>
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="cargos.cadastro" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="cargos.pesquisa" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/cargos/cargos'>
								...
								<div class="columns clearfix">
									<div class="col_66">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message key="cargos.nome" /></label>
											<div>
												<input type='text' name="nomeCargo" maxlength="256" class="Valid[Required] Description[cargos.nome]" onkeypress="return tratarEnter(this, event);"/>
											</div>
										</fieldset>
									</div>
								</div>
					...
					<div id="tabs-2" class="block">
						<div class="section">
							...
							<form name='formPesquisa'>
								<cit:findField formName='formPesquisa'lockupName='LOOKUP_CARGOS' id='LOOKUP_CARGOS' top='0'left='0' len='550' heigth='400' javascriptCode='true' htmlCode='true' />
							</form>
						</div>
					</div>
