...
<script charset="ISO-8859-1"  type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/js/PopupManager.js"></script>
    <script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/cit/objects/RequisicaoMudancaDTO.js"></script>
    <script type="text/javascript" src="../../cit/objects/HistoricoLiberacaoDTO.js"></script>
    <script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/cit/objects/ProblemaDTO.js"></script>
    <script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/cit/objects/RequisicaoLiberacaoResponsavelDTO.js"></script>
    <script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/cit/objects/RequisicaoLiberacaoRequisicaoComprasDTO.js"></script>
	<script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/cit/objects/RequisicaoLiberacaoMidiaDTO.js"></script>
	<script  charset="ISO-8859-1" type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/js/PopupManager.js"></script>
...
var popup3;
	...
	function load() {
		popup3 = new PopupManager(900, 450, "<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/");
		popupMidia = new PopupManager("98%" , $(window).height()-100, "<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/");
...
/*         var str = desc.split('-');
		...
		if(validaData(dataInicio,dataFim)){
			serializa(); 
 			var mudancas = HTMLUtils.getObjectsByTableId('tblMudancas');
 			 if(mudancas == ""){
  				alert("<i18n:message key="requisicaoLiberacao.vincularMudanca" />");
 				$('.tabs').tabs('select', 0);
	...
	function deleteLinha(table, index){
	 ...
	 function gerarImgDelProblema(row, obj){
	        row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" style="cursor: pointer;" onclick="excluirProblema('+row.rowIndex+')"/>';
	    };
	    
    function gerarImgDel(row, obj){
        row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" style="cursor: pointer;" onclick="deleteLinha(\'tblMudancas\', this.parentNode.parentNode.rowIndex);"/>';
    };
    
    function gerarImgDelIc(row, obj){
        row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" style="cursor: pointer;" onclick="deleteLinha(\'tblICs\', this.parentNode.parentNode.rowIndex);"/>';
    };
	...
	$(function() {
		...
		$("#POPUP_INFO_BASELINE").dialog({
			...
			hide: "fade",
			buttons: {
				<i18n:message key="citcorpore.comum.gravar" />: function() {
...
/* 	addGridIcs = function(id, desc) {
	 ...
	 /*Gravar baseline*/
		...
		function inventario() {
			document.getElementById('iframeAtivos').src ='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/inventarioNew/inventarioNew.load?iframe=' + true;
...
// 			document.form.servicoBusca.value = '';
		...
		exibeIconesMidia = function(row, obj){
		    ...
		    row.cells[0].innerHTML = '<img src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/imagens/delete.png" border="0" onclick="excluiMidia('+ row.rowIndex + ',this)" style="cursor:pointer"/>';
		}
		...
		exibeIconesResponsavel = function(row, obj){
	        ...
	        obj.sequenciaLiberacao = row.rowIndex; 
		    row.cells[0].innerHTML = '<img src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/imagens/delete.png" border="0" onclick="excluiResponsavel('+ row.rowIndex + ',this)" style="cursor:pointer"/>';
		}
	   ...
	   function addRequisicaoCompras(id, nomeservico, situacaoservico ){
	    ...
	    function gerarImgDelRequisicaoCompras(row, obj){
	        row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" style="cursor: pointer;"  onclick="deleteLinha(\'tblRequisicaoCompra\', this.parentNode.parentNode.rowIndex);"/>';
	    };
	    
	  //geber.costa
	    function gerarImgpopup(row, obj){
	    row.cells[5].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/edit.png" style="cursor: pointer;" onclick="alterarFechamentoMudanca('+row.rowIndex+')"/>';
	    };
	  //murilo.pacheco
	    function geraImgPlanoReversao(row, obj){
	    row.cells[6].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/paperclip.png" style="cursor: pointer;" onclick="listarPlanosDeReversao('+obj.idRequisicaoMudanca+')"/>';
	    };
 ...
 */
	     ...
	     function informaNumeroSolicitacao(numero){
				document.getElementById('divTituloLiberacao').innerHTML = 
					'<h2><i18n:message key="requisicaoLiberacao.requisicaoLiberacaoNumero"/>&nbsp;' + numero + '</h2>';   
			}
	     ...
	     function listarPlanosDeReversao(idMudanca){
	    	...
	    	<%--  document.getElementById('iframePlanoReversao').src ='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/uploadPlanoDeReversao/uploadPlanoDeReversao.load?idMudancaLiberacao=' + idMudancaLiberacao; --%>	
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="liberacao.cadastro" /></a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="liberacao.pesquisa" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					...
					<div id='divTituloLiberacao' class="flat_area grid_16" style="text-align:right;">
									<h2><i18n:message key="requisicaoLiberacao.requisicaoLiberacao" /></h2>
					</div>
					<div class="box grid_16 tabs">
						<div class="toggle_container">
							<div class="section">
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/requisicaoLiberacao/requisicaoLiberacao'>
								<div class="section">
									...
									<div class="col_100">
										<fieldset>
											...
											<div>
											<select  id="idContrato" onchange="setaValorLookup(this);" onclick= "document.form.fireEvent('carregaUnidade');"  name='idContrato' class=" Valid[Required] Description[<i18n:message key='contrato.contrato' />]" >
                                        ...
                                        <div class="col_60" >
                                             <fieldset style="height: 60px;">
                                                 <label class="campoObrigatorio" style="cursor: pointer; " >
                                                     <i18n:message key="liberacao.solicitadaPor" /> 
                                                 </label>
                                                 <div>
...
<%--                                        	<div class="col_40" style="height: 60px;">
											<fieldset style="height: 60px;">
												<label class="campoObrigatorio"> <i18n:message key="citcorpore.comum.grupoaprovador" /></label>
												<div>
								...
								<div class="col_100">
									<div class="col_15">
											<fieldset style="height: 60px;">
												<label class="campoObrigatorio"><i18n:message key="citcorpore.comum.situacao"/>
												</label>
												<div>
										...
										<div class="col_15">
		                                    <fieldset style="height: 60px;">
		                                        <label class="campoObrigatorio"><i18n:message key="liberacao.dataInicial" />
		                                        </label>
		                                            <div>
										...
										<div class="col_15">
											<fieldset>
												<label class="campoObrigatorio"><i18n:message key="requisicaoMudanca.horaAgendamentoInicial"/></label>
												<div>
										...
										<div class="col_15">
	                                        <fieldset style="height: 60px;">
	                                            <label class="campoObrigatorio"><i18n:message key="liberacao.dataFinal" />
	                                            </label>
	                                                <div>
										...
										<div class="col_15">
											<fieldset>
												<label class="campoObrigatorio"><i18n:message key="requisicaoLiberacao.horaFinal"/></label>
												<div>
										...
										<div class="col_25">
											<fieldset>
												<label class="campoObrigatorio" style="cursor: pointer;"><i18n:message key='gerenciaservico.agendaratividade.crupoatividades' /></label>
											<div> 
							        ...
							        <div class="col_100">
                                        <div class="col_40">
                                            <fieldset style="height: 120px;">
                                                <label class="campoObrigatorio"><i18n:message key="liberacao.titulo" />
                                                </label>
                                                    <div>
					                    ...
					                    <div class="col_60">
					                         <fieldset style="height: 120px;">
					                             <label class="campoObrigatorio"><i18n:message key="liberacao.descricao" />
					                             </label>
					                             <div>
									...
									<div>
										<h2 class="section">
											<i18n:message key="requisicaoLiberacao.informacaoRequisicao" />
										</h2>
									</div>
                                    <div class="col_100">
							        <div class="col_50">
							        <div class="col_100">
				                       <div class= "col_25">
                                        ...
                                        <div class="col_25">
                                            <fieldset>
                                                <label id="dtLiberacao" ><i18n:message key="liberacao.dataLiberacao" />
                                                </label>
                                                    <div>
                                        ...
                                        <div class="col_25">
                                            <fieldset>
                                                <label ><i18n:message key="liberacao.versao" />
                                                </label>
                                                    <div>
                                        ...
                                        <div class="col_25">
                                            <fieldset>
                                                <label class="campoObrigatorio"><i18n:message key="liberacao.risco"/>
                                                </label>
                                                <div>
                                                    <select id='risco' name='risco' class="Valid[Required] Description[liberacao.risco]" >
                                                        ...
                                                        <option value='B'><i18n:message key="liberacao.riscoBaixo"/></option>
                                                        <option value='M'><i18n:message key="liberacao.riscoMedio"/></option>
                                                        <option value='A'><i18n:message key="liberacao.riscoAlto"/></option>
                                                    </select>
                                                </div>
                                            </fieldset>
                                        </div>
							        	...
							        	<div class="col_100">
					        				<div class="col_25">
												<fieldset>
													<label class="campoObrigatorio"> <i18n:message key="citcorpore.comum.grupoExecutor" /></label>
													<div>
									...
									<div id="divNotificacaoEmail" class="col_50" >
										<fieldset>
											...
											<label style='cursor:pointer'><input type='checkbox' value='S' name='enviaEmailCriacao' checked="checked"/><i18n:message key="requisicaoLiberacao.enviaEmailCriacao"/></label><br>
											<label style='cursor:pointer'><input type='checkbox' value='S' name='enviaEmailFinalizacao' checked="checked"/><i18n:message key="requisicaoLiberacao.enviaEmailFinalizacao"/></label><br>
											<label style='cursor:pointer'><input type='checkbox' value='S' name='enviaEmailAcoes'/><i18n:message key="requisicaoLiberacao.enviaEmailAcoes"/></label>
								...
								<div  id="abas" class="formRelacionamentos">
									<div id="tabs" class="block">
										<ul class="tab_header clearfix">
											<li><a href="#relacionarMudancas"><i18n:message key="requisicaoMudanca.relacionarMudancas"/></a></li>
											...
											<%-- <li><a href="#relacionarLiberacoes"><i18n:message key="requisicaoMudanca.relacionarLiberacoes"/></a></li> --%>
											<li><a href="#relacionarDocsLegais"><i18n:message key="requisicaoMudanca.documentosLegais"/></a></li>
											<li><a href="#midiaDefinitiva"><i18n:message key="requisicaoMudanca.midiaDefinitiva"/></a></li>
											<li><a href="#documentosGerais"><i18n:message key="requisicaoLiberacao.documentosGerais"/></a></li>
											<li><a href="#responsavel"><i18n:message key="requisicaoLiberacao.papeisResponsabilidades"/></a></li>
											<li><a href="#requisicaoCompras"><i18n:message key="requisicaoLiberacao.requisicaoComprasVinculadas"/></a></li>
											<%if (!tarefaAssociada.equalsIgnoreCase("N")) {%>
												<li><a href="#checklist" onclick="carregaQuestionario('<%=br.com.centralit.citcorpore.util.Enumerados.Aba.LIBERCAOTESTE.getId()%>')"><i18n:message key="requisicaoLiberacao.checklist"/></a></li>
											<%}%>																				
										...
										<div id="relacionarMudancas">
											<div  style="width: 15%; float: left;" align="center" >
												...
												<i18n:message key="liberacao.adicionarMudanca" />
											...
											<div  style="width: 15%; float: left;" align="center" >
												...
												<i18n:message key="situacaoLiberacaoMudanca.cadastroSituacao" />
												<img  src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" />
												</label>
											</div>
				                             ...
				                             <div class="col_100">
				                                 	<table id="tblMudancas" class="table table-bordered table-striped" style="width: 100%;">
				                                       <tr>
				                                           ...
				                                           <th width="20%"><i18n:message key="liberacao.titulo" /></th>
				                                           <th width="10%"><i18n:message key="situacaoLiberacaoMudanca.status"/></th>
				                                           <th width="10%"><i18n:message key="situacaoLiberacaoMudanca.situacaoDaLiberacao"/></th>
				                                           <th width="5%"><i18n:message key="situacaoLiberacaoMudanca.alterar"/></th>
				                                           <th width="6%"><i18n:message key="citcorpore.comum.anexosPlanoRevisao"/></th>
										...
										<%-- 	<div  style="width: 15%; float: left;" align="center" >
											...
											<div  style="width: 15%; float: left;" align="center" >
												...
												<i18n:message key="requisicaoMudanca.inventario"/>
													<img  src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" />
												</label>
											</div>
											...
											<div class="formBody">
												<table id="tblICs" class="table table-bordered table-striped" style="width: 99%">
													<tr>
														<th width="2%">&nbsp;</th>
														<th width="5%"><i18n:message key="parametroCorpore.id"/></th>
														<th width="60%"><i18n:message key="citcorpore.comum.nome"/></th>
														<th width="30%"><i18n:message key="situacaoLiberacaoMudanca.status"/></th>
														<th width="2%">&nbsp;</th>
													</tr>
												</table>
											</div>
											...
											<div class="formBody">
												<table id="tblProblema" class="table table-bordered table-striped">
													<tr>
														...
														<th height="10px"width="15%"><i18n:message key="problema.status"/></th>
...
<%-- 										<div id="relacionarLiberacoes">
											...
											<div style="width: 15%; float: left;" align="center" >
												<label  style="cursor: pointer;" >
													<i18n:message key="liberacao.adicionarMidia"/>
										...
										<div id="responsavel">
											<div style="width: 20%; float: left;" align="center" >
												<label  style="cursor: pointer;" onclick='adicionarResponsavel();'>
													<i18n:message key="liberacao.adicionarPapeisResponsabilidades"/>
													<img  src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" />
												</label>
											</div>						
											<div style="width: 99%; height : 30px; float: left;"></div>						
											<div class="formBody">
												<table id="tblResponsavel" class="table table-bordered table-striped">
													<tr>
														...
														<th height="10px" width="5%"><i18n:message key="parametroCorpore.id"/></th>
														<th height="10px" width="25%"><i18n:message key="citcorpore.comum.nome"/></th>
														<th height="10px"width="15%"><i18n:message key="citcorpore.comum.cargo"/></th>
														<th height="10px" width="20%"><i18n:message key="citcorpore.comum.telefone"/></th>
														<th height="10px" width="20%"><i18n:message key="citcorpore.comum.email"/></th>
														<th height="10px" width="20%"><i18n:message key="citcorpore.comum.papel"/></th>
													</tr>
												</table>
											</div>
										</div>				
										...
										<div id="requisicaoCompras">
											...
											<div class="formBody">
												<table id="tblRequisicaoCompra" class="table table-bordered table-striped">
													<tr>
														<th height="10px" width="1%"></th>
														<th height="10px" width="5%"><i18n:message key="requisicaMudanca.numero_solicitacao"/></th>
														<th height="10px" width="40%"><i18n:message key="itemRequisicaoProduto.descrProduto"/></th>
														<th height="10px" width="20%"><i18n:message key="lookup.nomeCentroResultado"/></th>
														<th height="10px" width="20%"><i18n:message key="lookup.codigoCentroResultado"/></th>
														<th height="10px" width="20%"><i18n:message key="lookup.nomeProjeto"/></th>
														<th height="10px" width="20%"><i18n:message key="citcorpore.comum.situacao"/></th>
													</tr>
												</table>
											</div>	
									</div>
								...
								<div id="POPUP_MUDANCA_FECHAMENTO_CATEGORIA" title=<i18n:message key="situacaoLiberacaoMudanca.alterar" />>
      								 <div class="box grid_16 tabs">
       								 <div class="toggle_container">
       								 <div id="tabs-2" class="block">
        							 <div class="col_100">
										<fieldset>
										<label><i18n:message key="situacaoLiberacaoMudanca.situacao" /></label>
												<div>
...
<!-- lookup_empregado -->
    ...
    <div id="POPUP_PROBLEMA" title="<i18n:message  key="citcorpore.comum.pesquisa" />">
        <div class="box grid_16 tabs">
        <div class="toggle_container">
        <div id="tabs-2" class="block">
        <div class="section">
   ...
   <div id="POPUPITEMCONFIGURACAO" style=""  title="<i18n:message key="citcorpore.comum.pesquisa" />">
 		<table >
			<tr>
				<td>
		...
		<div id="POPUP_MIDIA" title="<i18n:message  key="citcorpore.comum.pesquisa" />">
        <div class="box grid_16 tabs">
        <div class="toggle_container">
        <div id="tabs-2" class="block">
        <div class="section">
    ...
    <div id="POPUP_REQUISICAOCOMPRAS" title="<i18n:message  key="citcorpore.comum.pesquisa" />">
        <div class="box grid_16 tabs">
        <div class="toggle_container">
        <div id="tabs-2" class="block">
       <div class="section">
	...
	<div id="POPUP_PLANOSREVERSAO" title="<i18n:message key="requisicaoLiberacao.planosReversao" />" style="overflow: hidden;">
		<form name='formUploadReversaoLiberacao' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/uploadPlanoDeReversaoLiberacao/uploadPlanoDeReversaoLiberacao' enctype="multipart/form-data">
				<input type="hidden" name="idMudanca"  id="idMudanca" />	
