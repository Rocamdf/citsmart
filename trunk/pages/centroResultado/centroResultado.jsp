...
<style>
    ...
    .linhaGrid{
		...
		function geraDatepicker(id, seq){
			if(seq == null || seq == undefined || seq == ''){
				$('#'+id).datepicker({format: 'dd/mm/yyyy',language: 'pt-BR'});
			}else{
				$('#'+id+seq).datepicker({format: 'dd/mm/yyyy',language: 'pt-BR'});
			}
		}
			var objTab = null;
		    ...
		    incluirAlcada = function() {
		        ...
		        //Atualiza a validação/formatação para elementos adicionados dinamicamente. !important
		        DEFINEALLPAGES_geraConfiguracao($('#dataInicio' + seqAlcada)[0], 'Valid[Required,Data] Description[citcorpore.comum.datainicio] Format[Data] datepicker');
		        geraDatepicker('dataInicio', seqAlcada)
		         geraDatepicker('dataFim', seqAlcada)
	...
	<body>
			...
			%>
				...
				<div class="box grid_16 tabs">
					<ul class="tab_header clearfix">
						<li>
							<a href="#tabs-1">
								<i18n:message key="centroResultado.cadastro" />
							</a>
						</li>
						<li>
							<a href="#tabs-2" class="round_top">
								<i18n:message key="centroResultado.pesquisa" />
							</a>
						</li>
					</ul>
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">
								<form name="form" action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/centroResultado/centroResultado">
									<div class="columns clearfix">
										...
										<div class="col_40">
											<fieldset>
												<label>
													<i18n:message key="centroResultado.superior" />
												</label>
												<div>
													<div>
										...
										<div class="col_60">
											<fieldset>
												<label class = "campoObrigatorio">
													<i18n:message key="centroResultado.codigo" />
												</label>
												<div>
										...
										<div class="col_20">
											<fieldset>
												<label class="campoObrigatorio" style="height: 30px;">
													<i18n:message key="centroResultado.permitirRequisicaoProduto" />
												</label>
												<div>
													<input type="radio" id="permiteRequisicaoProdutoSim" name="permiteRequisicaoProduto" value="S" checked="checked" /><i18n:message key="citcorpore.comum.sim" />
													<input type="radio" id="permiteRequisicaoProdutoNao" name="permiteRequisicaoProduto" value="N" /><i18n:message key="citcorpore.comum.nao" />
												</div>
											</fieldset>											
										</div>
										<div class="col_20">
									...
									<!-- Desenvolvedor: Pedro Lino - Data: 28/10/2013 - Horário: 17:50 - ID Citsmart: 120948 - 
									* Motivo/Comentário: Opção de adicionar muito longe da grid, Inserido proximo a citgrid e alterado para button-->
	                                    <div class="col_100">
	                                        <h2 class="section">
	                                             <i18n:message key="centroResultado.responsaveis" />
	                                        </h2>
	                                        <div id='divNovoCriterio' class="col_100">
	                                            ...
	                                            <div class="col_33">
	                                                 <button type='button' class='light img_icon has_text'  onclick='incluirAlcada();'>
	                                                     <%-- <img  src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" /><span><b> --%><i18n:message key="centroResultado.incluirResponsavel" /><!-- </b></span> -->
	                                                 </button>
	                                            </div>
	                                        </div>
                                         </div>
                                             ...
                                             <fieldset style='height:200px'>
                                               ...
                                               <cit:grid id="GRID_ALCADAS" columnHeaders="centroResultado.cabecalhoGridResponsaveis" styleCells="linhaGrid">
                                                   ...
                                                   <cit:column idGrid="GRID_ALCADAS" number="003">
                                                       <input  type='text' id="dataInicio#SEQ#"  name="dataInicio#SEQ#" maxlength="10" size="10"  class="" onfocus='geraDatepicker(this.id)' /> 
                                                   </cit:column>
                                                   <cit:column idGrid="GRID_ALCADAS" number="004">
                                                       <input  type='text' id="dataFim#SEQ#"  name="dataFim#SEQ#" maxlength="10" size="10"  class="Valid[Data] Format[Data] " onfocus='geraDatepicker(this.id)'/> 
                                                   </cit:column>
                                               </cit:grid>
                                               </div>
                                             </fieldset>
									...
									<button type="button" name="btnVisualizarHierarquia" class="light" onclick="visualizarHierarquiaCentrosResultado();">
										<img src="<%= br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO") %>/template_new/images/icons/small/grey/preview.png" />
										<span>
											<i18n:message key="centroResultado.visualizar" />
										</span>
									</button>
								</form>
							</div>
		...
		<div id="POPUP_CENTRORESULTADOPAI" class="POPUP_CENTRORESULTADOPAI" title="<i18n:message key="citcorpore.comum.pesquisa" />" >
			<div class="toggle_container">
				<div id="tabs-2" class="block">
					<div class="section" style="padding: 33px;">
						<div >
							...
							<form id="formCentroResultadoPai" name="formCentroResultadoPai" method="post" 
								action="<%= CitCorporeConstantes.CAMINHO_SERVIDOR %><%= request.getContextPath() %>/pages/centroResultado/centroResultado">
		...
		<div id="POPUP_HIERARQUIA_CENTRORESULTADO" title="<i18n:message key="centroResultado.hierarquia" />">			
			<div class="toggle_container">
				<div id="tabs-2" class="block">
					<div class="section" style="padding: 33px;">						
						<div id="divApresentacaoHierarquiaCentroResultado" title="<i18n:message key="centroResultado.hierarquia" />"></div>
					</div>
				</div>
			</div>			
		</div>			
        <div id="POPUP_EMPREGADO" title="<i18n:message key="citcorpore.comum.pesquisar" />">
            <div class="box grid_16 tabs">
                <div class="toggle_container">
                    <div id="tabs-2" class="block">
                        <div class="section">
