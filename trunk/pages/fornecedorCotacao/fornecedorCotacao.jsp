...
<script>
	...
	function load() {
		popupFornecedor = new PopupManager(1000, 680, "<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/");
		popupFornecedor.titulo = "<i18n:message key='fornecedor.cadastro' />";
		popupQualificacao = new PopupManager(1000, 680, "<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/");
		popupQualificacao.titulo = "<i18n:message key='menu.nome.qualificacaoFornecedor' />";
    ...
    function gerarImgExclusaoFornec(row, obj) {
        <%if (situacao != null && situacao.equals(SituacaoCotacao.EmAndamento)){%>
            row.cells[0].innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="excluirFornecedor(' + row.rowIndex + ')"/>';
        <%}else{%>
...
<div class="box grid_16 tabs" style='width:100%;margin: 0px 0px 0px 0px;'>
    <form name='form'
        action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/fornecedorCotacao/fornecedorCotacao'>
        <div class="columns clearfix">
            ...
            <div class="section">
                    ...
                    <div class="col_60">
                        <div style='padding: 5px 5px 5px 5px'>
                           <button type='button' name='btnCadFornecedor' class="light" onclick="popupFornecedor.abrePopup('fornecedor', '()')">
                               ...
                               <span><i18n:message key="cotacao.novoFornecedor" />
                               </span>
                           </button>
                           <button type='button' name='btnQualifFornecedor' class="light" onclick="popupQualificacao.abrePopup('avaliacaoFornecedor', '()')">
                               <img
                                   src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/facebook_like.png">
                               <span><i18n:message key="cotacao.qualificacaoFornecedor" />
                               </span>
                           </button>
                           <button type='button' name='btnAddFornecedor' class="light" id="addFornecedor">
                               ...
                               <span><i18n:message key="cotacao.adicionarFornecedor" />
                               </span>
                           </button>
                           <button type='button' name='btnSugerirFornecedores' id='btnSugerirFornecedores' class="light"
                               ...
                               <img
                                   src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/magnifying_glass.png">
                               <span><i18n:message key="cotacao.sugerirFornecedores" />
                               </span>
                           </button>
                        </div>
                    </div>
                ...
                <h2 class="section">
                    <i18n:message key="cotacao.fornecedores" />
                </h2>
               <div class="col_100" style='height:200px'>
                   <table id="tblFornecedoresCotacao" class="table">
                       <tr>
                           <th width="1%"></th>
                           <th width="15%"><i18n:message key="fornecedor.cpfcnpj" /></th>
                           <th ><i18n:message key="citcorpore.comum.nome" /></th>
                           <th width="15%"><i18n:message key="citcorpore.comum.telefone" /></th>
                           <th width="15"><i18n:message key="citcorpore.comum.email" /></th>
                           <th width="15%"><i18n:message key="fornecedor.contato" /></th>
                           <th width="5%"><i18n:message key="fornecedor.qualificado" /></th>
                       </tr>
                   </table>
               </div>
            </div>
      ...
      <div id="POPUP_SUGESTAO_FORNECEDORES" title="<i18n:message key="fornecedor.pesquisa" />"  style="overflow: hidden;">
            <div class="columns clearfix">
                <h2 class="section">
                    <i18n:message key="cotacao.fornecedoresSugeridos" />
                </h2>
