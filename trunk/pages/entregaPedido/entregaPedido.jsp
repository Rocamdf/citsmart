...
<div class="box grid_16 tabs">
	<form name='form'
		action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/entregaPedido/entregaPedido'>
		<div class="columns clearfix">
            ...
            <div class="section">
              ...
              <div class="col_60">
                     <h2 class="section">
                         <i18n:message key="pedidoCompra.entrega" />
                     </h2>
                     <div class="col_100">
			                 <fieldset >
			                     <label style="cursor: pointer;"><i18n:message key="fornecedor" /></label>
			                     <div>
                     ...
                     <div class="col_100">
                                ...
                                <div class="col_33">
                                    <fieldset >
                                        <label class="campoObrigatorio" ><i18n:message key="pedidoCompra.dataEntrega" />
                                        </label>
                                            <div>
		                    ...
		                    <div id='divNovoCriterio' class="col_100">
		                        ...
		                        <div class="col_33">
		                             <label  style="cursor: pointer;" onclick='incluirCriterio();'>
		                                 <img  src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/add.png" /><span><b><i18n:message key="cotacao.novoCriterio" /></b></span>
		                             </label>
		                        </div>
		                    </div>
		            </div>
		            <div class="col_100">
		                <fieldset style='height:200px'>
		                  <div style='width:700px;height:190px;overflow:auto;'>
		             ...
		             <div class="col_100">
		                   <button type='button' name='btnGravar' id='btnGravar' class="light" style='margin-top: 10px !important'
		                       ...
		                       <span><i18n:message key="pedidoCompra.confirmarEntrega" />
	                       </span>
		                   </button>
		             </div>
              </div>
