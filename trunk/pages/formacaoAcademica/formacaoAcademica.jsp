...
<script>
	...
	function limpar() {
	   	...
	   	limpar_LOOKUP_FORMACAO_ACADEMICA();
	}
	...
	function LOOKUP_FORMACAO_ACADEMICA_select(id, desc) {
		
		document.form.restore({
			idFormacaoAcademica : id
		});
	}
	
	function excluir() {
		
		if (document.getElementById("idFormacaoAcademica").value != "") {
	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="solicitacaoCargo.formacaoAcademica" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="solicitacaoCargo.cadastroFormacaoAcademica" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="solicitacaoCargo.pesquisaFormacaoAcademica" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					...
					<div id="tabs-1" class="block">
						...
						<div class="section">
							...
							<form id='form'
							      name='form'
								  action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/formacaoAcademica/formacaoAcademica'>
					...
					<div id="tabs-2" class="block">
						<div class="section">
							...
							<form name='formPesquisa'>
								<cit:findField formName='formPesquisa'lockupName='LOOKUP_FORMACAO_ACADEMICA' id='LOOKUP_FORMACAO_ACADEMICA' top='0'left='0' len='550' heigth='400' javascriptCode='true' htmlCode='true' />
							</form>
						</div>
					</div>
