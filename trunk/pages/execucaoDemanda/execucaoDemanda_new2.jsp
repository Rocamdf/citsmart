...
<%@include file="/include/noCache/noCache.jsp"%>
    ...
    <SCRIPT type="text/javascript" src="<%=br.com.citframework.util.Constantes
                    ...
                    .getValue("CONTEXTO_APLICACAO")%>/js/jquery.js"></SCRIPT>
    ...
    <SCRIPT type="text/javascript" src="<%=br.com.citframework.util.Constantes
                    .getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes
                    .getValue("CONTEXTO_APLICACAO")%>/slickgrid/slick.editors.js"></SCRIPT>

    <SCRIPT type="text/javascript" src="<%=br.com.citframework.util.Constantes
                    .getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes
                    .getValue("CONTEXTO_APLICACAO")%>/slickgrid/slick.grid.js"></SCRIPT>
