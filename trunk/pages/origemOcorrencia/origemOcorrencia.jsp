	...
	<body>
		...
		<%if (iframe == null) {%>
			...
			<div id="wrapper">
				...
				<div id="content">
				<%if (iframe == null) {%>
				<h3><i18n:message key="citcorpore.comum.origemOcorrencia" /></h3>
				<%}%>
				<div class="box-generic">
						...
						<div class="tabsbar">
							<ul>
								<li class="active"><a href="#tab1" data-toggle="tab"><i18n:message key="citcorpore.comum.cadastroOrigemOcorrencia" /></a></li>
								<li  class=""><a href="#tab2" data-toggle="tab"><i18n:message key="citcorpore.comum.pesquisaOrigemOcorrencia" /></a></li>
							</ul>
						</div>
						<!-- // Tabs Heading END -->
						<form name="formOrigemOcorrencia" action="<%=CitCorporeConstantes.CAMINHO_SERVIDOR %><%=request.getContextPath() %>/pages/origemOcorrencia/origemOcorrencia">
						<div class="tab-content">
							...
							<div class="tab-pane active" id="tab1">
								...
								<%-- 	<div class="control-group">
										<label class="strong"> <span><i18n:message key="citcorpore.comum.nome"/></span></label>
										<div class="span12">
									...
									<div style="margin: 0;" class="form-actions">
										<button class="btn btn-icon btn-primary glyphicons circle_ok" type="button" onclick='document.formOrigemOcorrencia.save();'><i></i><i18n:message key="citcorpore.comum.gravar" /></button>
										<button class="btn btn-icon btn-default glyphicons cleaning" type="button" onclick='document.formOrigemOcorrencia.clear();'><i></i><i18n:message key="citcorpore.comum.limpar" /></button>
