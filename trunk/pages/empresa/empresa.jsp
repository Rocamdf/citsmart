	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="empresa.empresa" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/empresa/empresa'>
								...
								<div class="columns clearfix">
									<div class="col_66">
										<fieldset>
											<label><i18n:message key="empresa.detalhamento" />
											</label>
											<div>
