...
<!-- Conteudo -->
 <div id="main_container" class="main_container container_16 clearfix">
		...
		<div class="flat_area grid_16">
				<h2><i18n:message key="requisicaoMudanca.requisicaoMudanca"/>&nbsp;Nº&nbsp;<%=idRequisicaoMudanca%></h2>						
		</div>
  <div class="box grid_16 tabs">
	 ...
	 <div class="toggle_container">
						...
						<div id="tabs-2" class="block">
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/agendarAtividadeRequisicaoMudanca/agendarAtividadeRequisicaoMudanca'>
