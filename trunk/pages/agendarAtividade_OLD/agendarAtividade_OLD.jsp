...
<script>
	...
	fechar = function(){
		parent.fecharModalAgendarAtividade();
	}
  ...
  <div class="box grid_16 tabs">
	 ...
	 <div class="toggle_container">
						...
						<div id="tabs-2" class="block">
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/agendarAtividade/agendarAtividade'>
