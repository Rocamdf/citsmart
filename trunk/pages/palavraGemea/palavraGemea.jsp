		...
		<div id="wrapper">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">
					<h2><i18n:message key="palavraGemea.palavraGemea"/></h2>						
				</div>
				
				<div class="box grid_16 tabs">
					<ul class="tab_header clearfix">
						<li>
							<a href="#tabs-1"><i18n:message key="palavraGemea.cadastro"/></a>
						</li>
						<li>
							<a href="#tabs-2" class="round_top"><i18n:message key="palavraGemea.pesquisa"/></a>
						</li>
					</ul>				
					...
					<div class="toggle_container">
						<div id="tabs-1" class="block">
							<div class="section">											
								<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/palavraGemea/palavraGemea'>
									<div class="columns clearfix">
										<input type='hidden' name='idPalavraGemea'/>
										<div class="columns clearfix">
											<div class="col_50">				
												<fieldset>
													<label class="campoObrigatorio"><i18n:message key="palavraGemea.palavra"/></label>
														<div>
														  <input type='text' name="palavra" maxlength="80" size="20" class="valid[Required] Description[palavraGemea.palavra]"/>
														</div>
												</fieldset>
											</div>										
											<div class="col_50">				
												<fieldset>
													<label class="campoObrigatorio"><i18n:message key="palavraGemea.palavraCorrespondente"/></label>
														<div>
														  <input type='text' name="palavraCorrespondente" maxlength="70" size="70" class="Valid[Required] Description[palavraGemea.palavraCorrespondente]" />
														</div>
												</fieldset>
											</div>
										</div>
