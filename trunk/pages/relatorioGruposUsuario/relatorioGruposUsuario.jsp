	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="citcorpore.comum.relatoriogrupocolaborador" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/relatorioGruposUsuario/relatorioGruposUsuario'>
								<div class="columns clearfix">
									...
									<div class="col_100">
										<fieldset style="height: 60px">
											<label><i18n:message key="menu.nome.colaborador" /></label>
											<div>
...
<div id="POPUP_COLABORADOR" title="<i18n:message key="menu.nome.colaborador" />">
	<div class="box grid_16 tabs">
		<div class="toggle_container">
