...
<script>
		...
		for(var i = 0; i < arrayServicos.length; i++){
			...
			str = str + '<tr>';
				str = str + '<td style="border:1px solid black; vertical-align: middle;">';
					str = str + '<img border="0" src="<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/edit.png" onclick="edita_POPUP_COMPL_SERVICO_CONTRATO(' + i + ')" style="cursor:pointer"/>';
				str = str + '</td>';			
				str = str + '<td style="border:1px solid black; vertical-align: middle;">';
					str = str + '<b>' + jsonObj.IDSERVICO_label + '</b>';
				str = str + '</td>';
				str = str + '<td style="border:1px solid black; vertical-align: middle;">';
					str = str + '<img border="0" src="<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/Partnership-icon.png"/>';
				str = str + '</td>';				
			str = str + '</tr>';
		}
	...
	<img src='<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/plus.png' border='0' style='cursor:pointer' onclick='mostra_POPUP_COMPL_SERVICO_CONTRATO()'/>
...
<div id="POPUP_COMPL_SERVICO_CONTRATO" style='width: 600px; height: 600px' >
	<form name='formComplServicosContratos' id='formComplServicosContratos' action='<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/dinamicViews/dinamicViews'>
	<%
