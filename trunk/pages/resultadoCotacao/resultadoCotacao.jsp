...
<div class="box grid_16 tabs" style="width:100%">
	<form name='form'
		action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/resultadoCotacao/resultadoCotacao'>
		<div class="columns clearfix">
            <div class="section">
                <div class="col_100">
	                ...
	                <div class="col_60" style='padding: 10px 0px 0px 0px'>
	                     <button type='button' name='btnCalcularResultado' class="light"
	                         ...
	                         <img
	                             src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/cog_4.png">
	                         <span><i18n:message key="cotacao.calcularResultado" />
	                         </span>
	                     </button>
	                     <button type='button' name='btnPublicarResultado' class="light"
	                         onclick='publicarResultado();'>
	                         <img
	                             src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/template_new/images/icons/small/grey/price_tags.png">
	                         <span><i18n:message key="cotacao.publicarResultado" />
	                         </span>
	                     </button>
                ...
                <div class="col_100">
		              <div class="col_40">
	                     <h2 class="section">
	                         <i18n:message key="cotacao.itens" />
	                     </h2>
	                     <div class="col_100" style='height:190px;overflow:auto' >
				               <table id="tblItensCotacao" class="table">
				                   <tr>
				                       ...
				                       <th width="10%"><i18n:message key="itemRequisicaoProduto.marca" /></th>
                      ...
                      <div class="col_60">
                         <h2 class="section">
                             <i18n:message key="cotacao.resultados" />
                         </h2>
...
<div id="POPUP_RESULTADO" title="<i18n:message key="coletaPreco.definirResultado" />"  style="overflow: hidden;">
    <form name='formResultado'
        ...
        <div class="col_100">
             <h2 class="section">
                <i18n:message key="coletaPreco.calculo" />
             </h2>
        </div> 
        <div class="col_100">
             <div class="col_33">
                 <fieldset>
                     <label style="cursor: pointer;"><i18n:message key="coletaPreco.pontuacao" /></label>
                     <div>
              ...
              <div class="col_33">
                 <fieldset>
                     <label style="cursor: pointer;"><i18n:message key="coletaPreco.resultado" /></label>
                     <div>
              ...
              <div class="col_33">
                 <fieldset>
                     <label style="cursor: pointer;"><i18n:message key="coletaPreco.quantidade" /></label>
                     <div>
        ...
        <div class="col_100">
             <h2 class="section">
                <i18n:message key="coletaPreco.definicao" />
             </h2>
        </div> 
        <div class="col_100">
             <div class="col_75" >
                 <fieldset >
                     <label style='cursor:pointer'><input type='radio' name="resultadoFinal" value="M" onclick='configurarTelaResultado();' ><i18n:message key="coletaPreco.melhorCotacao"/></label>
                     <label style='cursor:pointer'><input type='radio' name="resultadoFinal" value="D" onclick='configurarTelaResultado();' ><i18n:message key="coletaPreco.desclassificada"/></label>
                 </fieldset>
             </div>
             <div class="col_25">
                <fieldset >
        ...
        <div id="divJustificativa" class="col_100" style='display:none'>
            <div class="col_33">
                 <fieldset >
                     <label><i18n:message key="coletaPreco.justificativa" /></label>
                     <div>
            ...
            <div class="col_66">
                <fieldset >
                    <label><i18n:message key="coletaPreco.complementoJustificativa" /></label>
                    <div>
