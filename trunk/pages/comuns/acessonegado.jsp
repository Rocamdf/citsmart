...
<title><i18n:message key="citcorpore.comum.acessoNegado"/></title>
...
<script src="<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/novoLayout/common/theme/scripts/plugins/system/jquery.min.js"></script>
...
<table width="100%" border="0" id="tblAcessoNegado" align="center" cellpadding="0" cellspacing="0" bordercolor="#D3E3F0">
  ...
  <tr>
	...
	<%-- <h2 align="left" class="style5">&nbsp;<i18n:message key="citcorpore.comum.cadastroInativos"/></h2> --%>
	...
	<form name="form1" method="post" action="<%=retorno%>">
      ...
      <table width="500" align="center" cellpadding="0" cellspacing="0">
		<tr><td><div align="center" class="style4">
		  <p align="left"><h4><img border="0" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/imagens/smile_sad.png" /> <i18n:message key="citcorpore.comum.permissaoFuncionalidade"/></h4></p>
		  </div></td></tr>
      </table>
      <p align="center">
       <!--  <input type="submit" class="light img_icon has_text" name="Submit" value="Voltar"> -->
       <button id="botao" class="light img_icon has_text" title="<i18n:message key='citcorpore.comum.voltarprincipal' />" onclick="voltar(this)">
