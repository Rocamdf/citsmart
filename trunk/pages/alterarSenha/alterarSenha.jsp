	...
	<body>
		<div class="container-fluid fixed ">
			...
			<div class="widget-body">
				...
				<!-- Inicio conteudo -->
				<div id="content">
					<form style="margin: 0;" class="form-horizontal" name='form' action='<%=request.getContextPath()%>/pages/usuario/usuario'>
						<div style="padding: 0;" class="tab-content">
								...
								<div id="account-details" class="tab-pane active">
									...
									<div class="row-fluid">
										...
										<div class="span6">
											...
											<div class="control-group">
												<label class="control-label"> <span><i18n:message key="alterarSenha.novaSenha"/></span></label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label"><i18n:message key="alterarSenha.senhaNovamente"/></label>
												<div class="controls">
									...
									<div style="margin: 0;" class="form-actions">
										<button class="btn btn-icon btn-primary glyphicons circle_ok" type="button" onclick='validar();'><i></i><i18n:message key="citcorpore.comum.gravar" /></button>
										<button class="btn btn-icon btn-default glyphicons cleaning" type="button" onclick='document.form.clear();'><i></i><i18n:message key="citcorpore.ui.botao.rotulo.Limpar" /></button>
									</div>
									<!-- // Form actions END -->
				...
				<script type="text/javascript" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/alterarSenha/js/alterarSenha2.js" ></script>
			</div>
		</div>
	</body>
</html>
