	...
	<body>
		<div class="container-fluid fixed ">
			...
			<div id="wrapper">
				...
				<!-- Inicio conteudo -->
				<div id="content">
					<form name='formSugestaoCurriculos' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/triagemRequisicaoPessoal/triagemRequisicaoPessoal'>
					...
					<input type="hidden" id='curriculos_serialize' name='curriculos_serialize'>
						<div class="widget">
								<div class="widget-head">
									<h4 class="heading"><i18n:message key="rh.pesquisaCurriculo" /></h4>
								</div>
						</div>
									...
									<div class="tab-content">
										...
										<!-- Palavra chave -->
											<div class="control-group">
												<label class="strong"><i18n:message key="rh.palavraChave" />:</label>
												<div class="controls">
										...
										<!-- Palavra chave -->
												<div class="control-group">
													<label class="strong"><i18n:message key="rh.formacao" />:</label>
													<div class="controls">
											...
											<!-- Palavra chave -->
												<div class="control-group">
													<label class="strong"><i18n:message key="rh.certificacoes" />:</label>
													<div class="controls">
								...
								<!-- Column -->
									<div class="span6">
										<div class="tab-content">
											...
											<!-- Palavra chave -->
												<div class="control-group">
													<label class="strong"><i18n:message key="rh.idiomas" />:</label>
													<div class="controls">
											...
											<!-- Cidade -->
												<div class="control-group">
													<label class="strong"><i18n:message key="rh.cidade" />:</label>
													<div class="controls">
						...
						<div class="span4">
							<button style="float: left;" class="btn btn-icon btn-primary" type="button" onclick="parent.abrirTriagemManual();"><i></i><i18n:message key="citcorpore.comum.pesquisar" /></button>		
							<!-- <button class="btn btn-icon btn-primary" type="button" onclick="parent.sugereCurriculos();"><i></i>Pesquisa Automática</button>	 -->	
							<button style="float: left;" class="btn btn-icon btn-default glyphicons circle_remove" type="button" onclick="document.formSugestaoCurriculos.clear();"><i></i><i18n:message key="rh.limpar" /></button>
						</div>
							<div style="float: left; width: 230px" class='span4 topfiltro'>
							<ul>
								<li id='acoes' class='btn-group btn-block span3'>
									<div class='leadcontainer'>
									<button type='button' class='btn dropdown-lead btn-default' onclick="parent.sugereCurriculos();"><i18n:message key="rh.pesquisaAutomatica" /></button>
									</div>
									...
									<ul class="dropdownFiltro dropdown-menu pull-right">
										<li class="dropdownFiltroPesquisa">
											<div class="span4">
						                       <input type='checkbox' name='chkCertificacao' value="C"/><i18n:message key="triagem.pesquisaPorCertificacao" />
					                 	 	</div>
										</li>
										<li>
											<div class="span3">
						                       <input type='checkbox' name='chkIdioma' value="I"/><i18n:message key="triagem.pesquisaPorIdioma" />
					                 	 	</div>
										</li>
									</ul>
								</li>
						...
						<div class="widget">
							<div class="widget-head">
								<h4 class="heading"><i18n:message key="rh.resultadoBuscaCurriculos" /></h4>
								</div>
								...
								<div >
									<div class="row-fluid"> 
										...
										<table class="table table-condensed" id="tblCurriculos" >
											...
											<!-- Table heading -->
												<tr >
													<th width="23%"><i18n:message key="citcorpore.comum.nome" /></th>
													<th width="12%"><i18n:message key="citcorpore.comum.dataNascimento" /></th>
													<th width="21%"><i18n:message key="rh.cpf" /></th>
													<th width="1%"><i18n:message key="citcorpore.comum.sexo" /></th>
													<th width="27,5%" align="right"><i18n:message key="rh.acoes" /></th>
												</tr>
											<!-- // Table heading END -->
						...
						<div class="modal hide fade in" id="modal_listaNegra" aria-hidden="false">
								...
								<div class="modal-header">
									 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
									<h3><i18n:message key="rh.listaNegraCurriculo" /></h3>
								</div>
								<!-- // Modal heading END -->
								<!-- Modal body -->
								<div class="modal-body">
