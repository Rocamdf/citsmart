...
<head>
	...
	function abreFecha(nameDiv){
		if (document.getElementById(nameDiv).style.display == 'none'){
			...
			document.getElementById(nameDiv + '_CTRL').src = '<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/collapse.gif';
		}else{
			document.getElementById(nameDiv).style.display = 'none';
			document.getElementById(nameDiv + '_CTRL').src = '<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/expand.gif';
		}
	}
		...
		<div class="toggle_container">
			<div id="tabs-1" class="block">
				<div class="section" style="width: ">
					<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/inventarioAdvanced/inventarioAdvanced'>
						<div class="columns clearfix">
						<h2 class="section"><label><i18n:message key="inventario.cbcIps" /> </label></h2>
