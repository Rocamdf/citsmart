...
<script>
	...
	function LOOKUP_CONHECIMENTO_select(id, desc) {
	...
	function excluir() {
		if (document.getElementById("idConhecimento").value != "") {
	...
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="solicitacaoCargo.experienciaAnterior" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="solicitacaoCargo.experienciaAnterior" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message key="citcorpore.comum.pesquisa" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/experienciaAnterior/experienciaAnterior'>
								...
								<div class="columns clearfix">
									<div class="col_50">
				               			<fieldset style="height: 70px;">
				             				...
				             				<input type='text' name='descricao' size='50' maxlength="100"/>
				               			</fieldset>
				               	    </div>
				               	    <div class="col_100">
				               			<fieldset style="height: 130px;">
				             				<label><i18n:message key="solicitacaoCargo.detalhamento" /></label>
				             				<textarea name='detalhe' rows="5" cols="48"></textarea>
				               			</fieldset>
				             		</div>
								</div>
								<br>
					...
					<div id="tabs-2" class="block">
						<div class="section">
							...
							<form name='formPesquisa'>
								<cit:findField formName='formPesquisa'lockupName='LOOKUP_CONHECIMENTO' id='LOOKUP_CONHECIMENTO' top='0'left='0' len='550' heigth='400' javascriptCode='true' htmlCode='true' />
							</form>
						</div>
					</div>
