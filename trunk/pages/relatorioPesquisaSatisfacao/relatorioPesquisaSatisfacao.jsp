...
<%@page import="br.com.centralit.citcorpore.bean.PesquisaSatisfacaoDTO"%>
<!doctype html public "">
<html>
<head>
<%
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="relatoriopesquisasatisfacao.titulo" /></a></li>
				</ul>
				...
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/relatorioPesquisaSatisfacao/relatorioPesquisaSatisfacao'>
								...
								<div class = "col_25">
									...
									<div class="col_25">
										<fieldset  style="height: 64px !important;">
											<label><i18n:message key="relatoriopesquisasatisfacao.nota" /></label>
											<div>
												<select id="comboNotas" name="nota" style="margin-bottom: 3px;"></select>
											</div>
										</fieldset>
									</div>	
								</div>
