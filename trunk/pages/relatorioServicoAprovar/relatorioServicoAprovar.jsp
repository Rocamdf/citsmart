...
<script><!--
	...
	function imprimirRelatorioQuantitativoPorServico(){
		...
		if(validaData(dataInicio,dataFim)){
			...
			document.form.fireEvent("imprimirRelatorioServicoAprovar");
	...
	function imprimirRelatorioQuantitativoPorServicoXls(){	
		...
		if(validaData(dataInicio,dataFim)){
			JANELA_AGUARDE_MENU.show();
			document.form.fireEvent("imprimirRelatorioServicoAprovarXls");
		}
	}
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message key="relatorioAprovacaoSolicitacoes" /></a></li>
				</ul>
				<a href="#" class="toggle">&nbsp;</a>
				<div class="toggle_container">
					<div class="block" >
						<div id="parametros">
							<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/relatorioServicoAprovar/relatorioServicoAprovar'>
								...
								<div class="columns clearfix">
									...
									<div class="col_25">
										<fieldset style="height: 64px">
											...
											<div>
												<select name="situacaoAprovacao"></select>
											</div>
										</fieldset>
									</div>
								</div>
