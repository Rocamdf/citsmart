...
<!-- Conteudo -->
	...
	<div class="section">											
	<form name='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/contratos/contratos'>
		...
		<div class="columns clearfix">
			...
			<div class="col_20">				
				<fieldset>
					<label><i18n:message key="visao.dataContrato" /></label>
						<div>
