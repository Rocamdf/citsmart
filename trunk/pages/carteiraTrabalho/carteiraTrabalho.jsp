...
<html>
    ...
    <script type="text/javascript" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/js/raphael.2.1.0.min.js"></script>
    <script type="text/javascript" src="<%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/js/justgage.1.0.1.min.js"></script>
		  ...
		  AddLinkSolicitacao = function(row, cell, value, columnDef, dataContext) {
		  	...
		  	if (solicitacaoDto != null) {
		  	  ...
		  	  //if (solicitacaoDto.situacao != "<%=SituacaoSolicitacaoServico.Suspensa%>") {
	  	  	      str += "<img src='" + URL_INITIAL + "imagens/viewCadastro.png' style='cursor:pointer;' title='<i18n:message key='gerenciaservico.visualizarcadastrosolicitacao' />' \n onclick='visualizarSolicitacao("+solicitacaoDto.idSolicitacaoServico+")'>";
			  	  if (tarefaDto.executar == 'S') {
		  ...
		  AddSituacao = function(row, cell, value, columnDef, dataContext) {
		  	...
		  	if (solicitacaoDto != null) {
		  	  ...
		  	  if (parseFloat(solicitacaoDto.atrasoSLA) > parseFloat("0,00") && solicitacaoDto.situacao != "<%=SituacaoSolicitacaoServico.Suspensa%>") 
		      	 str += " <img src='" + URL_INITIAL + "imagens/exclamation02.gif' height='15px' width='20px' title='<i18n:message key='gerenciaservico.atrasada' />'>"; 
	...
	<body>	
		<div id="wrapper">
			...
			<div id="main_container" class="main_container container_16 clearfix">
				...
				<div class="flat_area grid_16">
					<h2><i18n:message key="carteiraTrabalho.carteiraTrabalho"/></h2>						
				</div>
				<div id='divX'>
				</div>
						...
						<tr>
							<td colspan="2">
								...
								<div style="z-index: 999 !important; width: 100%">
								    ...
								    <iframe width="99%" height="800" src="<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/gerenciamentoServicos/gerenciamentoServicos.load?iframe=true"></iframe>
								</div>
							</td>
						</tr>
					</table>
		...
		<div id="POPUP_EDITAR" title="Editar" style="display: none">
			<form name="formCarteira" action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/carteiraTrabalho/carteiraTrabalho'>
			...
			<div class="col_75">
				<fieldset>
					<label style="margin-top: 5px;"><i18n:message key="carteiraTrabalho.informacoesTarefa" /></label>
			...
			<div class="col_100">
			    <div class="col_25">
					<fieldset>
						<label style="margin-top: 5px;" class="campoObrigatorio"><i18n:message key="carteiraTrabalho.horaInicio" /></label>
							<div>
				...
				<div class="col_25">
					<fieldset>
						<label style="margin-top: 5px;" class="campoObrigatorio"><i18n:message key="citcorpore.comum.data" /></label>
							<div>
				...
				<div class="col_25">
					<fieldset>
						<label style="margin-top: 5px;" class="campoObrigatorio"><i18n:message key="carteiraTrabalho.qtdeHoras" /></label>
							<div>
				...
				<div class="col_25">
					<fieldset>
					<label style="margin-top: 5px;" class="campoObrigatorio"><i18n:message key="carteiraTrabalho.percentualExecutado" /></label>
							<div>
			...
			<div class="col_100">
				<fieldset>
				<label style="margin-top: 5px;" class=""><i18n:message key="carteiraTrabalho.detalhamento" /></label>
						<div>
						  	<textarea rows="3" cols="70" maxlength="140" name="detalhamento" id="detalhamento"></textarea>
						</div>
				</fieldset>
			</div>	
			<br><br>
	...
	<form name='form' id='form' action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/gerenciamentoServicos_OLD/gerenciamentoServicos_OLD'>
