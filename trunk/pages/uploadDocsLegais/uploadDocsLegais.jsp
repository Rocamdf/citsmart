...
#divUpload_uploadAnexosdocsLegais, #divUpload_uploadAnexosdocsLegais{
...
<script>
	...
	function excluirImagemUpload(path){
		if (confirm(i18n_message("citcorpore.comum.confirme.desejaexcluiranexo"))){
			window.location = '<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/uploadDocsLegaisExcluir/uploadDocsLegaisExcluir.load?path=' + path;
		}
	}
