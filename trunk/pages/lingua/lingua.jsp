	...
	<div id="wrapper">
		...
		<div id="main_container" class="main_container container_16 clearfix">
			...
			<div class="flat_area grid_16">
				<h2>
					<i18n:message key="lingua.lingua" />
				</h2>
			</div>
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><i18n:message
								key="lingua.cadastroLingua" /> </a></li>
					<li><a href="#tabs-2" class="round_top"><i18n:message
								key="lingua.pesquisaLingua" /> </a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/lingua/lingua'>
								<input type='hidden' name='idLingua' /> <input type='hidden'
									name='dataInicio' id="dataInicio" /> <input type='hidden'
									name='dataFim' id="dataFim" />
								<div class="columns clearfix">
									<div class="col_25">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message
													key="lingua.nome" /></label>
											<div>
												<input type='text' name="nome" maxlength="245"
													class="Valid[Required] Description[lingua.nome]" />
											</div>
										</fieldset>
									</div>
									<div class="col_25">
										<fieldset>
											<label class="campoObrigatorio"><i18n:message
													key="lingua.sigla" /></label>
											<div>
												<input type='text' name="sigla" maxlength="245"
													class="Valid[Required] Description[lingua.sigla]" />
											</div>
										</fieldset>
									</div>
								</div>
						...
						<div class="section">
							...
							<form name='formPesquisa'>
								<cit:findField formName='formPesquisa'
									lockupName='LOOKUP_LINGUA' id='LOOKUP_LINGUA' top='0' left='0'
