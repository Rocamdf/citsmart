...
(function($) {
	...
	$.fn.pagination.defaults = {
		...
		beforePageText : i18n_message('citcorpore.comum.pagina'),
		afterPageText : i18n_message('citcorpore.comum.deMin') +"  {pages}",
		displayMsg : i18n_message('citcorpore.comum.exibindo') + " {from} " + i18n_message('citcorpore.comum.ate') + " {to} " + i18n_message('citcorpore.comum.deMin') +" {total} " + i18n_message('cotacao.itens')
	};
})(jQuery);
(function($) {
	function _93(_94) {
...
(function($) {
	...
	function _355(_356, _357) {
		...
		function _358() {
			...
			btn.blur();
			/*
			 * var p = $("#tst"); var position = p.offset();
			 * $("body>div.menu-top").menu("hide");
			 * $(opts.menu).menu("show",{left:left,top:position.top+btn.outerHeight()+'px'});
			 * btn.blur();
			 */
		}
		;
...
(function($) {
	...
	$.fn.validatebox.defaults = {
		required : false,
		validType : null,
		missingMessage : "Este campo é necessário.",
		invalidMessage : null,
		rules : {
			email : {
			...
			length : {
				...
				message : "Por favor, digite um valor entre {0} e {1}."
			},
			remote : {
				...
				message : "Por favor, corrigir esse campo."
			}
		}
	};
})(jQuery);
		...
		$(_3c5).unbind(".numberbox").bind("keypress.numberbox",
				function(e) {
					...
					if (e.which == 46) {
						...
						if ((e.which >= 48 && e.which <= 57	&& e.ctrlKey == false && e.shiftKey == false) || e.which == 0 || e.which == 8 || e.which == 44) {
							return true;
						} else {
...
(function($) {
	...
	function init(_3d8) {$(_3d8).addClass("calendar").wrapInner(
	...
	var _545 = {
		text : {
			init : function(_546, _547) {
				var _548 = "";
				if(_547 != undefined){
					_548 = $("<input type=\"text\" maxlength=\""+_547.maxlength+"\" class=\"datagrid-editable-input\">").appendTo(_546);
				}else{
					_548 = $("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_546);
				}
				return _548;
			},
	...
	$.fn.datagrid.defaults = $
			.extend(
					...
					$.fn.panel.defaults,
					{
						...
						idField : null,
						url : null,
						loadMsg : i18n_message("citcorpore.comum.aguardeProcessando"),
						rownumbers : false,
						singleSelect : false,
						selectOnCheck : true,
						checkOnSelect : true,
