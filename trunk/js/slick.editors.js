...
var SlickEditor =  {
    ...
    BoolCellFormatter : function(row, cell, value, columnDef, dataContext) {
        return value ? "<img src='" + URL_INITIAL + "imagens/tick.png'>" : "";
    },
    ...
    TaskNameFormatter : function(row, cell, value, columnDef, dataContext) {
        ...
        return spacer + " <img src='" + URL_INITIAL + "imagens/expand.gif'>&nbsp;" + value;
    },
    ...
    ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
        ...
        if (columnDef.width < 50)
            return (resources.length > 1 ? "<center><img src='" + URL_INITIAL + "imagens/user_identity_plus.gif' " : "<center><img src='" + URL_INITIAL + "imagens/user_identity.gif' ") +
    ...
    StarFormatter : function(row, cell, value, columnDef, dataContext) {
        return (value) ? "<img src='" + URL_INITIAL + "imagens/bullet_star.png' align='absmiddle'>" : "";
    },
    ...
    DateCellEditor : function($container, columnDef, value, dataContext) {
        ...
        this.init = function() {
            ...
            $input.datepicker({
                ...
                buttonImage: "" + URL_INITIAL + "imagens/calendar.gif"
            });
    ...
    StarCellEditor : function($container, columnDef, value, dataContext) {
        ...
        this.init = function() {
            $input = $("<IMG src='" + URL_INITIAL + "imagens/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />");
