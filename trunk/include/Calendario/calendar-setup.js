...
// $Id: calendar-setup.js,v 1.1 2007/04/23 11:35:06 emauri Exp $
...
Calendar.setup = function (params) {
	...
	param_default("button",        "inputField");
	...
	if (!(params.flat || params.inputField || params.displayArea || params.button)) {
		alert("Calendar.setup:\n  Nada a configurar (nenhum campo encontrado).  Por favor, verifique o seu código.");
		return false;
	}
	...
	function onSelect(cal) {
		if (cal.params.flat) {
			if (typeof cal.params.flatCallback == "function") {
				...
				alert("Nenhum flatCallback dado -- nada a fazer.");
			}
			return false;
		}
	...
	if (params.flat != null) {
		...
		if (!params.flat) {
			alert("Calendar.setup:\n  Flat especificado mas o parent não encontrado.");
			return false;
		}
