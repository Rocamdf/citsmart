...
oM.makeMenu('top0','','Cadastros', '', '',66, 200)
	...
	oM.makeMenu('sub0_2','top0','Cargos', '','', 170,'','','','','','','right')
		oM.makeMenu('sub0_2_1','sub0_2','Incluir', raiz + '/pages/cargos/exibirInsercao.do','', 170,'','','','','','','right')
		oM.makeMenu('sub0_2_2','sub0_2','Consultar', raiz + '/pages/cargos/exibirConsulta.do','', 170,'','','','','','','right')
