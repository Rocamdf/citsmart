...
function cm_checkalign(a){
  switch(a){
    ...
    case "rightcenter": return 9; break; case "leftcenter": return 10; break;
 
  }return null
}
/**Making each individual menu ALTERADO**/
makeCM.prototype.makeMenu=function(name,parent,txt,lnk,targ, largura, w,h,img1,img2,cl,cl2,align,rows,nolink,onclick,onmouseover,onmouseout){
  ...
  }m.rows=rows>-1?rows:c.l[l].rows; m.w=cm_cp(largura||w||c.l[l].width,1); m.h=cm_cp(h||c.l[l].height,0); m.txt=txt; m.lnk=lnk; 
...
makeCM.prototype.getcoords=function(m,bx,by,x,y,maxw,maxh,ox,oy){
  ...
  switch(a){
    ...
    case 9:  x+=m.w+bx; y-=(maxh-m.h)/2; break;
    case 10:  x-=maxw+bx; y-=(maxh-m.h)/2; break;
