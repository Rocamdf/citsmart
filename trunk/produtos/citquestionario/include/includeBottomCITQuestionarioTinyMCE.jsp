...
<form name='formArquivosMultimidia' method="post" action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/uploadArquivoMultimidia/uploadArquivoMultimidia'>
...
<cit:janelaPopup style="display:none;top:1350px;width:600px;left:50px;height:200px;position:absolute;" title="Upload Anexo" id="POPUP_UPLOAD_MULTIMIDIA">
	...
	<form name='formAnexo' method="post" ENCTYPE="multipart/form-data" action='<%=CitCorporeConstantes.CAMINHO_SERVIDOR%><%=request.getContextPath()%>/pages/uploadArquivoMultimidia/uploadArquivoMultimidia'>
