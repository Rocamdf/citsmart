...
alter table requisicaomudanca add  datahorainicioagendada smalldatetime null default '0000-00-00 00:00:00';
alter table requisicaomudanca add  datahoraterminoagendada  smalldatetime null default '0000-00-00 00:00:00';

alter table requisicaomudanca add  idlocalidade integer;

alter table aprovacaomudanca add  datahorainicio smalldatetime null;
...
alter table requisicaomudanca alter  column  datahoraconclusao smalldatetime not null;
...
alter table requisicaomudanca alter column  datahorainicio smalldatetime null;
alter table requisicaomudanca alter column  datahoratermino smalldatetime null;
alter table requisicaomudanca alter column  datahoracaptura smalldatetime null;
alter table requisicaomudanca alter column  datahorareativacao smalldatetime null;
alter table requisicaomudanca alter column  datahorasuspensao smalldatetime null;
alter table requisicaomudanca alter column  datahorainicioagendada smalldatetime null;
alter table requisicaomudanca alter column  datahoraterminoagendada smalldatetime null;
...
alter table solicitacaoservico alter column datahorafim smalldatetime null;
-- FIM
