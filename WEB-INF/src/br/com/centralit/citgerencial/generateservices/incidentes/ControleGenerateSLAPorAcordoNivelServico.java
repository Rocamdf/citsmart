...
public class ControleGenerateSLAPorAcordoNivelServico {
	public List execute(Integer idAcordoNivelServico, Date datainicio, Date datafim)
 ...
 */
		...
		sql = sql + "WHERE (sol.idacordonivelservico = ?) ";
