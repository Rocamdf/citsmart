 ...
 * @since 14/08/2012
 */
public class GenerateServiceIncidentesPorTipoServico extends GerencialGenerateService {
	...
	public List execute(HashMap parametersValues, Collection paramtersDefinition) throws ParseException {
		...
		try {
			col = graficosDao.consultaIncidentesPorTipoServico(getNovoParametro(), "I");
		} catch (Exception e) {
			e.printStackTrace();
		}
