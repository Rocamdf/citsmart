...
public class ControleGenerateSLAPorServicoContratoPeriodo {
	public List execute(Integer idServicoContrato, Date datainicio, Date datafim)
 ...
 */
		...
		sql = sql + "WHERE (sol.idservicocontrato = ?) ";
		...
		parametersValuesBusca.add(idServicoContrato);
