...
public class ControleGenerateSLAPorRequisitoSLA {
...
*/
		...
		sql = sql + "WHERE (sol.idacordonivelservico in (select idacordonivelservico from SLARequisitoSLA where idRequisitoSLA = ?)) ";
