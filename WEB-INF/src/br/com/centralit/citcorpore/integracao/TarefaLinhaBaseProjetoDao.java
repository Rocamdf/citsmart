...
public class TarefaLinhaBaseProjetoDao extends CrudDaoDefaultImpl {
	...
	public void deleteFilhasByIdLinhaBaseProjeto(Integer idLinhaBaseProjeto) throws Exception {
	...
	public Collection calculaValoresTarefasFilhas(Integer idTarefaLinhaBaseProjetoParm) throws Exception {
		List parametro = new ArrayList();
		List list = new ArrayList();
		List listRetorno = new ArrayList();
