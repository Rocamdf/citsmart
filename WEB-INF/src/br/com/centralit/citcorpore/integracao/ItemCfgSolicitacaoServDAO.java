...
public class ItemCfgSolicitacaoServDAO extends CrudDaoDefaultImpl {
	...
	public ItemCfgSolicitacaoServDTO findByIdItemConfiguracaoEidsolicitacaoservico(Integer idItemConfiguracao, Integer idsolicitacaoservico) throws Exception{
	 ...
	 */
	public boolean verificaSeCadastrado(ItemCfgSolicitacaoServDTO itemDTO) throws Exception {
