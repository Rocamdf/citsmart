...
public class HistoricoValorDAO extends CrudDaoDefaultImpl {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5966657766090197494L;
...
/*	public List<HistoricoValorDTO> listHistoricoValorByIdHistoricoIc(Integer idHistoricoIc) throws Exception {
    ...
    public HistoricoValorDTO restoreValorByIdValor(Integer  idValor) throws Exception {
	...
	public void deleteByIdHitoricoIC(Integer parm) throws Exception {
		List condicao = new ArrayList();
