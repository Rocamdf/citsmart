...
public class TipoMudancaDAO extends CrudDaoDefaultImpl{
	...
	public Collection encontrarPorNomeTipoMudanca(TipoMudancaDTO tipoMudancaDTO) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
	 ...
	 * @throws Exception
	 */	
	public ArrayList<TipoMudancaDTO> findByIdCalendario(Integer idCalendario) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList(); 
