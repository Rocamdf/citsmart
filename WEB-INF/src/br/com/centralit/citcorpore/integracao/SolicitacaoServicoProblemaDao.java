...
public class SolicitacaoServicoProblemaDao extends CrudDaoDefaultImpl {
	...
	public void deleteByIdSolictacaoServico(Integer parm) throws Exception {
		List condicao = new ArrayList();
		condicao.add(new Condition("idSolicitacaoServico", "=", parm));
		super.deleteByCondition(condicao);
	}
	
	public Collection findByIdSolictacaoServico(Integer parm) throws Exception {
		List condicao = new ArrayList();
	...
	public Collection<SolicitacaoServicoDTO> listSolicitacaoServicoByProblema(Integer id) throws Exception{
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public List<SolicitacaoServicoDTO> listSolicitacaoServicoByIdProblema (Integer idProblema) throws Exception {
		List parametro = new ArrayList();
