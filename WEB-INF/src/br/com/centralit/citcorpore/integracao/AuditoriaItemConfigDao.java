...
import org.apache.jackrabbit.standalone.cli.info.LsItems;
...
public class AuditoriaItemConfigDao extends CrudDaoDefaultImpl {
	...
	public List<AuditoriaItemConfigDTO> historicoAlteracaoItemConfiguracaoByIdItemConfiguracao(ItemConfiguracaoDTO itemConfiguracaoDTO) throws Exception{
		...
		str.append(" group by au.idauditoriaitemConfig, it.identificacao, tp.nometipoitemconfiguracao, us.login, it.iditemconfiguracao order by au.datahoraalteracao desc, it.iditemconfiguracao, au.tipoalteracao  ");
