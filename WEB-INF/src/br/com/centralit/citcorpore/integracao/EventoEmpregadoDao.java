...
public class EventoEmpregadoDao extends CrudDaoDefaultImpl {
    ...
    public Collection<EventoEmpregadoDTO> listByIdEvento(Integer idEvento) throws Exception {
    ...
    public Collection<EventoEmpregadoDTO> listByIdEventoGrupo(Integer idEvento) throws Exception {
    ...
    public Collection<EventoEmpregadoDTO> listByIdEventoUnidade(Integer idEvento) throws Exception {
    ...
    public Collection<EventoEmpregadoDTO> listByIdEventoEmpregado(Integer idEvento) throws Exception {
