...
public class RequisicaoProdutoDao extends CrudDaoDefaultImpl {
    ...
    private String getSQLRestoreAll() {
        ...
        sql.append("       rp.idCentroCusto, cc.nomeCentroResultado, rp.idProjeto, proj.nomeProjeto, rp.finalidade, rp.idEnderecoEntrega, rp.rejeitada ");
    ...
    public Collection<RequisicaoProdutoDTO> consultaRequisicoesPorCCusto(HashMap parametros) throws Exception {
    ...
    public Collection<RequisicaoProdutoDTO> consultaRequisicoesPorUnidade(HashMap parametros) throws Exception {
        List parametrosBusca = new ArrayList();
    ...
    public Collection findByIdCentroCusto(Integer idCentroCusto) throws Exception {
        List parametro = new ArrayList();
