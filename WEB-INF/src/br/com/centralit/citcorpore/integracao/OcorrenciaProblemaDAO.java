...
public class OcorrenciaProblemaDAO extends CrudDaoDefaultImpl{
    ...
    public Collection<OcorrenciaProblemaDTO> listByIdProblemaEPorUltimaData(Integer idProblema) throws Exception{
    	List condicao = new ArrayList();
    	List ordenacao = new ArrayList();
    ...
    public Collection<OcorrenciaProblemaDTO> listByUltimaDataEHora(Integer idProblema)throws Exception{
    	List condicao = new ArrayList();
    	List ordenacao = new ArrayList();
    ...
    public Collection<OcorrenciaProblemaDTO> listByUltimaDataEHora(ProblemaDTO problemaDTO)throws Exception{
    	List condicao = new ArrayList();
    	List ordenacao = new ArrayList();
    ...
    public Collection<OcorrenciaProblemaDTO> listByIdProblemaAndCategoria(Integer idProblema, CategoriaOcorrencia categoria) throws Exception{
    	List condicao = new ArrayList();
    	List ordenacao = new ArrayList();
    ...
    public OcorrenciaProblemaDTO listUltimaDataHora(int idProblema) throws Exception {
...
//    		Especificando as colunas cujo os valores serão retornados.
    ...
    public OcorrenciaProblemaDTO findUltimoByIdSolicitacaoServico(Integer idProblema) throws Exception {
		List parametro = new ArrayList();
    ...
    public OcorrenciaProblemaDTO findUltimoByIdSolicitacaoServicoAndOcorrencia(Integer idProblema) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
