...
public class ExecucaoDemandaDao extends CrudDaoDefaultImpl {
	...
	public Collection getAtividadesByGrupoAndPessoa(Integer idEmpregado, String[] grupo) throws Exception{
	...
	public void updateAtribuir(IDto obj) throws Exception{
	...
	public void updateStatus(IDto obj) throws Exception{
		ExecucaoDemandaDTO execDemanda = (ExecucaoDemandaDTO)obj;
		ExecucaoDemandaDTO execDemandaUpdate = new ExecucaoDemandaDTO();
