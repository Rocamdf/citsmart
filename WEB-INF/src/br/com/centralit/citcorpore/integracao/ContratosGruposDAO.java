...
public class ContratosGruposDAO extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = 6643650945554944641L;
	...
	public Collection<MenuDTO> listarMenusPorPerfil(UsuarioDTO usuario, Integer idMenuPai, boolean horizontal) throws Exception {
		List result = null;
		StringBuffer sql = new StringBuffer();
		ArrayList<Integer> parametros = new ArrayList<Integer>();
