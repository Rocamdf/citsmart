...
public class AnexoBaseConhecimentoDAO extends CrudDaoDefaultImpl {
    ...
    private static final long serialVersionUID = -3497539547027044226L;
     ...
     * @author valdoilo.damasceno
     */
    public Collection<AnexoBaseConhecimentoDTO> consultarAnexosDaBaseConhecimento(BaseConhecimentoDTO baseConhecimentoBean) throws Exception {
	List ordenacao = new ArrayList();
