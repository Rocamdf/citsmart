...
public class CaracteristicaTipoItemConfiguracaoDAO extends CrudDaoDefaultImpl {
    ...
    private static final long serialVersionUID = -8146050482678893635L;
     ...
     * @author valdoilo.damasceno
     */
    public boolean existeAssociacaoComCaracteristica(Integer idCaracteristica, Integer idTipoItemConfiguracao) throws Exception {
    	boolean exists;		
