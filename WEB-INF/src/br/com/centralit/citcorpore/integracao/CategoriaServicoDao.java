...
public class CategoriaServicoDao extends CrudDaoDefaultImpl {
	...
	public Collection findByIdPai(Integer idCategoriaPaiParm) throws Exception {
	 ...
	 * @throws Exception
	 */
	public List<CategoriaServicoDTO> listCategoriasServicoidPaiFilho(CategoriaServicoDTO bean) throws Exception {
	 ...
	 * @throws Exception
	 */
	public List<CategoriaServicoDTO> listCategoriasServicoidPaiIsNull(CategoriaServicoDTO bean) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Collection listCategoriasAtivasByNomeConcatenado() throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
	 ...
	 * @author euler.ramos
	 */
	public List<CategoriaServicoDTO> findByIdCategoriaServico(Integer id) throws Exception {
	 ...
	 * @author euler.ramos
	 */
	public List<CategoriaServicoDTO> findByNomeCategoria(String titulo) throws Exception {
		List resp = new ArrayList();
