...
public class ComentariosDAO extends CrudDaoDefaultImpl {
    ...
    private static final long serialVersionUID = 4763977478458327508L;
     ...
     */
    public Collection<ComentariosDTO> consultarComentarios(BaseConhecimentoDTO baseConhecimentoBean) throws Exception {
    ...
    public Collection<ComentariosDTO> consultarComentariosPorPeriodo(BaseConhecimentoDTO baseConhecimentoDTO) throws Exception{
		...
		parametro.add(Timestamp.valueOf(UtilDatas.dateToSTR(baseConhecimentoDTO.getDataInicio(), "yyyy-MM-dd") + " 00:00:00"));
		//parametro.add(baseConhecimentoDTO.getDataInicio() + " 00:00:00");
		parametro.add(Timestamp.valueOf(UtilDatas.dateToSTR(baseConhecimentoDTO.getDataFim(), "yyyy-MM-dd") + " 23:59:59"));
