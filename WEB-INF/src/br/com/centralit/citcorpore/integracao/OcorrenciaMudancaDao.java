...
public class OcorrenciaMudancaDao extends CrudDaoDefaultImpl {
    ...
    public Collection<OcorrenciaMudancaDTO> listByIdMudancaAndCategoria(Integer idRequisicaoMudanca, CategoriaOcorrencia categoria) throws Exception{
    	List condicao = new ArrayList();
    	List ordenacao = new ArrayList();
    ...
    public OcorrenciaMudancaDTO findUltimoByIdSolicitacaoServico(Integer idRequisicaoMudancaParm) throws Exception {
    ...
    public OcorrenciaMudancaDTO findUltimoByIdSolicitacaoServicoAndOcorrencia(Integer idRequisicaoMudanca) throws Exception {
		List parametro = new ArrayList();
		List listRetorno = new ArrayList();
		List list = new ArrayList();
