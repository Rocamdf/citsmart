...
public class UnidadeMedidaDao extends CrudDaoDefaultImpl {
	...
	/*
	 * public Collection consultarUnidadesMedidasAtivas(UnidadeMedidaDTO unidadeMedidaDTO) throws Exception { List condicao = new ArrayList(); List ordenacao = new ArrayList(); condicao.add(new
