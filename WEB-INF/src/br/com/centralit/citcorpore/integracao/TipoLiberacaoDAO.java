...
public class TipoLiberacaoDAO extends CrudDaoDefaultImpl{
	...
	public Collection encontrarPorNomeTipoLiberacao(TipoLiberacaoDTO tipoLiberacaoDTO) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
	 ...
	 * @throws Exception
	 */
	public ArrayList<TipoLiberacaoDTO> findByIdCalendario(Integer idCalendario) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList(); 
