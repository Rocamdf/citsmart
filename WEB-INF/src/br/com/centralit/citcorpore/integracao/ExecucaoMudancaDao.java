...
public class ExecucaoMudancaDao extends CrudDaoDefaultImpl {
	...
	public ExecucaoMudancaDTO findByIdInstanciaFluxo(Integer idInstanciaFluxo) throws Exception {
	...
	public Collection<ExecucaoMudancaDTO> listByIdRequisicaoMudanca(Integer idRequisicaoMudanca) throws Exception {
		List condicao = new ArrayList();
