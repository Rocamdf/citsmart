...
public class AcordoNivelServicoHistoricoDao extends CrudDaoDefaultImpl {
	...
	public AcordoNivelServicoHistoricoDTO findAtivoByIdServicoContrato(Integer idServicoContrato, String tipo) throws Exception {
		List condicao = new ArrayList();
	 ...
	 * 
	 */
	public List<AcordoNivelServicoHistoricoDTO> findAcordosSemVinculacaoDireta() throws Exception {
		List resp = new ArrayList();
