...
public class CaracteristicaDao extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = -3604691351757775509L;
	...
	@Override
	public Collection find(IDto caracteristicaDto) throws Exception {
	 ...
	 * @author VMD
	 */
	public List consultarCaracteristicasAtivas(Integer idTipoItemConfiguracao) throws Exception {
	 ...
	 */
	public List consultarCaracteristicasAtivas(Integer idTipoItemConfiguracao, String [] arr) throws Exception {
		Object[] objs = new Object[] { idTipoItemConfiguracao };
	 ...
	 * @throws Exception
	 */
	public List consultarCaracteristicas(String tagtipoitemconfiguracao, String tagcaracteristica, Boolean dataFim) throws Exception {
