...
public class CategoriaPostDao extends CrudDaoDefaultImpl {
	 ...
	 * @throws Exception
	 */
	public List<CategoriaPostDTO> listCategoriasPostidPaiFilho(CategoriaPostDTO bean) throws Exception {
	 ...
	 * @throws Exception
	 */
	public List<CategoriaPostDTO> listCategoriasPostidPaiIsNull(CategoriaPostDTO bean) throws Exception {
	 ...
	 * @throws Exception
	 */
	public Collection findByNomeCategoria(CategoriaPostDTO categoriaPostDTO) throws Exception {
		List condicao = new ArrayList();
		List ordenacao = new ArrayList();
