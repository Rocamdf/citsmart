...
public class FluxoServicoDao extends CrudDaoDefaultImpl {
	...
	private static final long serialVersionUID = 6078007054607563459L;
	...
	public Collection findByIdServicoContratoAndIdFase(Integer idServicoContrato, Integer idFase) throws Exception {
		List parametro = new ArrayList();
	...
	public FluxoServicoDTO findByIdServicoContratoAndIdTipoFluxo(Integer idServicoContrato, Integer idTipoFluxo) throws Exception {
		List parametro = new ArrayList();
		parametro.add(idServicoContrato);
	...
	public void deleteByIdServicoContrato(Integer idServicocContrato) throws Exception {
