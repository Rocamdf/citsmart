...
public class CatalogoServicoDao extends CrudDaoDefaultImpl {
	...
	public Collection<CatalogoServicoDTO> listAllCatalogos() throws Exception {
	...
	public Collection<CatalogoServicoDTO> listByIdContrato(Integer idContrato) throws Exception {
		List parametro = new ArrayList();
