...
public class ProblemaDAO extends CrudDaoDefaultImpl {
	...
	public Collection find(IDto problemaDTO) throws Exception {
	...
	public Collection<ProblemaDTO> findByIdProblemaPai(Integer idProblemaPai) throws Exception {
		List condicao = new ArrayList();
	...
	public Collection<PesquisaProblemaDTO> listProblemaByCriterios(PesquisaProblemaDTO pesquisaProblemaDto) throws Exception {
		...
		sql.append("inner join usuario as proprietario on proprietario.idusuario = problema.idproprietario ");
