...
public class ExcecaoEmpregadoDao extends CrudDaoDefaultImpl {
	...
	public Collection<ExcecaoEmpregadoDTO> listByIdEventoIdGrupo(Integer idEvento, Integer idGrupo) throws Exception {
	...
	public Collection<ExcecaoEmpregadoDTO> listByIdEventoIdUnidade(Integer idEvento, Integer idUnidade) throws Exception {
