...
public class ItemConfigEventoDao extends CrudDaoDefaultImpl {
    ...
    public Collection<ItemConfigEventoDTO> listByIdEvento(Integer idEvento) throws Exception {
    ...
    public Collection<ItemConfigEventoDTO> verificaDataHoraEvento() throws Exception {
