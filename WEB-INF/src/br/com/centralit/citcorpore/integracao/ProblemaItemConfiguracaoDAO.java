...
public class ProblemaItemConfiguracaoDAO extends CrudDaoDefaultImpl {
	...
	public ProblemaItemConfiguracaoDTO findByIdItemConfiguracaoEIdProblema(Integer idItemConfiguracao, Integer idProblema) throws Exception{
	 ...
	 */
	public boolean verificaSeCadastrado(ProblemaItemConfiguracaoDTO itemDTO) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void deletaOsQueNaoEstaoNaListaByIdProblema(Integer idProblema, ArrayList<ProblemaItemConfiguracaoDTO> listaICs) throws Exception {
	...
	public List<ItemConfiguracaoDTO> listItemConfiguracaoByIdProblema (Integer idProblema) throws Exception {
		List parametro = new ArrayList();
	...
	public ProblemaItemConfiguracaoDTO restoreByIdProblema(Integer idSolicitacao) throws Exception {
		List parametro = new ArrayList();
