...
public class UnidadesAccServicosDao extends CrudDaoDefaultImpl {
	...
	public void deleteByIdServicoUnidade(Integer idUnidade, Integer idServico) throws Exception {
		List condicao = new ArrayList();
	 ...
	 */
	public boolean existeAssociacaoComUnidade(Integer idServico, Integer idUnidade) throws Exception {
	 ...
	 * @author rodrigo.oliveira
	 */
	public Collection consultaServicosPorUnidade(Integer idUnidade) throws Exception {
