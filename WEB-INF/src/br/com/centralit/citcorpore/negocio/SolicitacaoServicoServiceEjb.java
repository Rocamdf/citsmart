...
import br.com.citframework.integracao.DaoTransactDefaultImpl;
...
@SuppressWarnings({ "unchecked", "serial", "rawtypes", "unused", "static-access" })
public class SolicitacaoServicoServiceEjb extends CrudServicePojoImpl implements SolicitacaoServicoService {
	...
	public IDto create(IDto model) throws ServiceException, LogicException {
		...
		return create(model, tc, true, true, true);
	}
	...
	public IDto create(IDto model, TransactionControler tc, boolean determinaPrioridadePrazo, boolean determinaHoraInicio, boolean determinaDataHoraSolicitacao) throws ServiceException,
		...
		try {
			...
			//valida email
			//Comentado para tratamento de email em javascript
//			if(solicitacaoServicoDto.getEmailcontato() != null && !Util.isValidEmailAddress(solicitacaoServicoDto.getEmailcontato())){
//				throw new LogicException(i18n_Message("citcorpore.validacao.emailInvalido"));
//			}
			...
			if (servicoContratoDto == null)
				throw new LogicException(i18n_Message("solicitacaoservico.validacao.servicolocalizado"));
			...
			if (solicitacaoServicoDto.getIdGrupoNivel1() == null || solicitacaoServicoDto.getIdGrupoNivel1().intValue() <= 0) {
				...
				if (idGrupoNivel1 == null || idGrupoNivel1.intValue() <= 0)
					throw new LogicException(i18n_Message("solicitacaoservico.validacao.grupoatendnivel"));
			...
			if (idGrupo > 0 && idTipoFluxoSolicitacaoServico > 0) {
				...
				if (resultado == false) {
					throw new LogicException(i18n_Message("solicitacaoServico.grupoSemPermissao"));
				}
			} else {
				throw new LogicException(i18n_Message("fluxo.fluxoserviconaodefinido "));
			}
			...
			execucaoSolicitacaoService.registraSolicitacao(solicitacaoServicoDto, tc);
			...
			// restoreAll(solicitacaoServicoDto.getIdSolicitacaoServico(), tc);
	...
	public void determinaPrazoLimite(SolicitacaoServicoDTO solicitacaoDto, Integer idCalendarioParm, TransactionControler tc) throws Exception {
		new ExecucaoSolicitacaoServiceEjb().determinaPrazoLimite(solicitacaoDto, idCalendarioParm, tc);
	}
	...
	public void determinaPrioridadeEPrazo(SolicitacaoServicoDTO solicitacaoServicoDto, TransactionControler tc) throws Exception {
		...
		if (acordoNivelServicoDto == null) {
			...
			if (acordoServicoContratoDTO == null) {
				throw new Exception(i18n_Message("solicitacaoservico.validacao.tempoacordo"));
			}
		...
		if (solicitacaoServicoDto.getIdPrioridade() == null)
			throw new Exception(i18n_Message("solicitacaoservico.validacao.prioridadesolicitacao"));
		...
		if (colTempos != null) {
			...
			if (idFasePadraoStr == null)
				throw new Exception(i18n_Message("solicitacaoservico.validacao.padraoexecucao"));
		...
		if ((prazoHH + prazoMM) == 0) {
			if (solicitacaoServicoDto.getIdPrioridade() != null && solicitacaoServicoDto.getIdPrioridade().intValue() == 5) {
				...
				throw new Exception(i18n_Message("solicitacaoservico.prazoacordonivel") + " " + solicitacaoServicoDto.getIdPrioridade());
			}
		}
		...
		if(solicitacaoServicoDto != null && solicitacaoServicoDto.getIdSolicitacaoServico() != null){
			solAux = (SolicitacaoServicoDTO) new SolicitacaoServicoDao().restore(solicitacaoServicoDto);
	...
	public void fechaSolicitacaoServicoVinculadaByProblemaOrMudanca(SolicitacaoServicoDTO solicitacaoServicoDto, TransactionControler tc) throws Exception {
		...
		if (solicitacaoAuxDto != null && solicitacaoAuxDto.getIdSolicitacaoServico() != null) {
			...
			solicitacaoServicoDao.updateNotNull(solicitacaoAuxDto);
		}
	}
	...
	public Collection findByConhecimento(BaseConhecimentoDTO baseConhecimentoDto) throws ServiceException, LogicException {
		...
		try {
			return solicitacaoServicoDao.findByConhecimento(baseConhecimentoDto);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected CrudDAO getDao() throws ServiceException {
		return new SolicitacaoServicoDao();
	}
	...
	public Integer getQuantidadeByIdServico(int idServico) throws Exception {
		try {
			...
			return dao.getQuantidadeByIdServico(idServico);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Integer getQuantidadeByIdServicoContrato(int idServicoContrato) throws Exception {
		try {
			SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
			return dao.getQuantidadeByIdServicoContrato(idServicoContrato);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorFase(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorFase(solicitacaoDto);
	}

	@Override
	public Collection<SolicitacaoServicoDTO> listarSLA() throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listarSLA();
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorGrupo(HttpServletRequest request, SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		...
		Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorGrupo = solicitacaoDao.listaQuantidadeSolicitacaoPorGrupo(solicitacaoDto);
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorHoraAbertura(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorHoraAbertura(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorItemConfiguracao(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorItemConfiguracao(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorOrigem(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorOrigem(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorPesquisaSatisfacao(HttpServletRequest request, SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		...
		Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorPesquisaSatisfacao = solicitacaoServicoDao.listaQuantidadeSolicitacaoPorPesquisaSatisfacao(solicitacaoDto);
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorPrioridade(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorPrioridade(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorResponsavel(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorResponsavel(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorServico(SolicitacaoServicoDTO solicitacaoServicoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorServico(solicitacaoServicoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaServicosAbertosAprovados(SolicitacaoServicoDTO solicitacaoServicoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaServicosAbertosAprovados(solicitacaoServicoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorSituacaoSLA(HttpServletRequest request, SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoServicoDao = new SolicitacaoServicoDao();
		List<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorSituacaoSLA = solicitacaoServicoDao.listaQuantidadeSolicitacaoPorSituacaoSLA(solicitacaoDto);
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorSolicitante(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		...
		return solicitacaoDao.listaQuantidadeSolicitacaoPorSolicitante(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorTipo(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorTipo(solicitacaoDto);
	}
	...
	public Collection<RelatorioQuantitativoSolicitacaoDTO> listaQuantidadeSolicitacaoPorTipoServico(SolicitacaoServicoDTO solicitacaoDto) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaQuantidadeSolicitacaoPorTipoServico(solicitacaoDto);
	}

	@Override
	public String listaServico(Integer idSolicitacaoservico) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaServico(idSolicitacaoservico);
	}
	...
	public Collection<SolicitacaoServicoDTO> listaSolicitacaoServicoPorServicoContrato(Integer idServicoContratoContabil) throws Exception {
		try {
			SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
			return dao.listaSolicitacaoServicoPorServicoContrato(idServicoContratoContabil);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection listaSolicitacoesSemPesquisaSatisfacao() throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.listaSolicitacoesSemPesquisaSatisfacao();
	}

	public Collection<SolicitacaoServicoDTO> listByTarefas(Collection<TarefaFluxoDTO> listTarefas) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		Collection<SolicitacaoServicoDTO> listSolicitacaoServicoDto = new ArrayList();

		listSolicitacaoServicoDto = solicitacaoDao.listByTarefas(listTarefas);
		...
		if (listSolicitacaoServicoDto != null && !listSolicitacaoServicoDto.isEmpty()) {
			...
			for (SolicitacaoServicoDTO solicitacaoDto : listSolicitacaoServicoDto) {
				...
				if (solicitacaoDto != null) {
					...
					solicitacaoDto = this.verificaSituacaoSLA(solicitacaoDto);
				}
			}
		}
	...
	public Collection<SolicitacaoServicoDTO> listByTarefas(Collection<TarefaFluxoDTO> listTarefas, TipoSolicitacaoServico[] tiposSolicitacao) throws Exception {
		...
		listSolicitacaoServicoDto = solicitacaoDao.listByTarefas(listTarefas, tiposSolicitacao);
	...
	public SolicitacaoServicoDTO listIdentificacao(Integer idItemConfiguracao) throws Exception {
		...
		try {
			SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
			return dao.listIdentificacao(idItemConfiguracao);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public SolicitacaoServicoDTO listInformacaoContato(String nomeContato) throws Exception {
		try {
			SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
			return dao.retornaSolicitacaoServicoComInformacoesDoContato(nomeContato);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public List<SolicitacaoServicoDTO> listSolicitacaoServicoByItemConfiguracao(Integer idItemConfiguracao) throws Exception {
		SolicitacaoServicoDao solicitacaoServicoDao = new SolicitacaoServicoDao();
		return solicitacaoServicoDao.listSolicitacaoServicoByItemConfiguracao(idItemConfiguracao);
	}
	...
	public Collection<SolicitacaoServicoDTO> listSolicitacaoServicoEmAndamento(Integer idSolicitacaoServico) {
		...
		try {
			...
			listSolicitacaoServicoEmAndamento = solicitacaoDao.listSolicitacaoServicoEmAndamento(idSolicitacaoServico);
	...
	public Collection<SolicitacaoServicoDTO> listSolicitacaoServicoRelacionada(int idSolicitacaoPai) {
		...
		try {
			...
			listSolicitacaoServicoRelacionada = solicitacaoDao.listSolicitacaoServicoRelacionada(idSolicitacaoPai);
	...
	public Collection<SolicitacaoServicoDTO> listSolicitacaoServicoRelacionadaPai(int idSolicitacaoPai) {
		...
		try {
			...
			listSolicitacaoServicoRelacionada = solicitacaoDao.listSolicitacaoServicoRelacionadaPai(idSolicitacaoPai);
	...
	public Collection<SolicitacaoServicoDTO> listSolicitacoesFilhas() throws Exception {
		...
		return solicitacaoServicoDao.listSolicitacoesFilhas();
	}
	...
	public SolicitacaoServicoDTO obterQuantidadeSolicitacoesServico(Integer idServicoContrato, java.util.Date dataInicio, java.util.Date dataFim) throws Exception {
		try {
			SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
			return dao.obterQuantidadeSolicitacoesServico(idServicoContrato, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> quantidadeSolicitacaoPorBaseConhecimento(SolicitacaoServicoDTO solicitacao) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.quantidadeSolicitacaoPorBaseConhecimento(solicitacao);
	}
	...
	public void reativa(UsuarioDTO usuarioDto, SolicitacaoServicoDTO solicitacaoServicoDto, TransactionControler tc) throws Exception {
		if(solicitacaoServicoDto.getSituacaoSLA()!=null && solicitacaoServicoDto.getSituacaoSLA().equalsIgnoreCase("M")){
	...
	public FluxoDTO recuperaFluxo(SolicitacaoServicoDTO solicitacaoServicoDto) throws Exception {
		if (solicitacaoServicoDto == null || solicitacaoServicoDto.getIdSolicitacaoServico() == null)
			throw new Exception(i18n_Message("solicitacaoservico.validacao.solicitacaoservico"));
	...
	public Collection<SolicitacaoServicoDTO> relatorioControleSla(SolicitacaoServicoDTO solicitacao) throws Exception {
		...
		return solicitacaoServicoDao.relatorioControleSla(solicitacao);
	}
	...
	public SolicitacaoServicoDTO relatorioControlePercentualQuantitativoSla(SolicitacaoServicoDTO solicitacaoServicoDTO) throws Exception {
		...
		List<SolicitacaoServicoDTO> listSolicitacaoservico = (List<SolicitacaoServicoDTO>) solicitacaoServicoDao.relatorioControleSla(solicitacaoServicoDTO);
	...
	public SolicitacaoServicoDTO restoreAll(Integer idSolicitacaoServico, TransactionControler tc) throws Exception {
		...
		try {
			solicitacaoDto = (SolicitacaoServicoDTO) solicitacaoDao.restoreAll(idSolicitacaoServico);
		} catch (Exception e) {
			throw new Exception(i18n_Message("solicitacaoservico.erro.recuperardadosolicitacao") + " " + idSolicitacaoServico);
		}
	...
	public SolicitacaoServicoDTO restoreByIdInstanciaFluxo(Integer idInstanciaFluxo) throws Exception {
		...
		SolicitacaoServicoDTO solicitacaoDto = null;
		try {
			solicitacaoDto = (SolicitacaoServicoDTO) solicitacaoDao.restoreByIdInstanciaFluxo(idInstanciaFluxo);
		} catch (Exception e) {
			// throw new
			// Exception("Erro na recuperação dos dados da solicitação da instância fluxo"+" "+idInstanciaFluxo);
		...
		return verificaSituacaoSLA(solicitacaoDto);
	}
	...
	public SolicitacaoServicoDTO retornaSolicitacaoServicoComItemConfiguracaoDoSolicitante(String login) throws Exception {
		try {
			SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
			return dao.retornaSolicitacaoServicoComItemConfiguracaoDoSolicitante(login);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public void updateSimples(IDto model) throws LogicException, ServiceException {
		...
		try {
			...
			solicitacaoServicoDao.setTransactionControler(tc);
			solicitacaoServicoDao.update(model);
	...
	public IDto updateInfo(IDto model) throws ServiceException, LogicException {
		...
		try {
			...
			SolicitacaoServicoDTO solicitacaoServicoAux = (SolicitacaoServicoDTO) solicitacaoServicoDao.restore(solicitacaoServicoDto);
			...
			if (solicitacaoServicoDto.getReclassificar() != null && solicitacaoServicoDto.getReclassificar().equalsIgnoreCase("S")) {
				...
				if (solicitacaoServicoAux != null) {
					...
					if (servicoContratoDTO != null) {
						...
						if (servicoDto != null) {
							nomeServicoAnterior = i18n_Message("citcorpore.comum.codigo") + ": " + servicoDto.getIdServico() + " - " + i18n_Message("citcorpore.comum.nome") + ": "
						...
						if (contratoDto != null) {
							nomeContratoAnterior = i18n_Message("citcorpore.comum.codigo") + ": " + contratoDto.getIdContrato() + " - " + i18n_Message("citcorpore.comum.numero") + ": "
			...
			solicitacaoServicoDao.updateNotNull(solicitacaoServicoDto);
			...
			if (solicitacaoServicoAux != null && solicitacaoServicoAux.getIdTarefaEncerramento() == null && solicitacaoServicoDto.atendida()) {
				if (solicitacaoServicoDto.getIdTarefa() != null
					...
					solicitacaoServicoDao.atualizaIdTarefaEncerramento(solicitacaoServicoDto);
				}
			...
			if (solicitacaoServicoDto.getReclassificar() != null && solicitacaoServicoDto.getReclassificar().equalsIgnoreCase("S")) {
				String strRecl = i18n_Message("citcorpore.comum.reclassificaosolicitacao");
				strRecl += "\n" + i18n_Message("citcorpore.comum.servicoanterior") + ": " + nomeServicoAnterior;
				strRecl += "\n" + i18n_Message("citcorpore.comum.contratoanterior") + ": " + nomeContratoAnterior;
				strRecl += "\n" + i18n_Message("citcorpore.comum.descricaoanterior") + ": " + strDescricaoAnterior;
	...
	public void updateNotNull(IDto obj) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		solicitacaoDao.updateNotNull(obj);
	...
	public void updateSLA(IDto model) throws ServiceException, LogicException {
		...
		try {
			...
			String strOcorr = "\n" + i18n_Message("gerenciaservico.mudarsla.tiposla") + ": ";
			if (solicitacaoServicoDto.getSlaACombinar().equalsIgnoreCase("S")) {
				strOcorr += i18n_Message("citcorpore.comum.acombinar");
			} else {
				strOcorr += i18n_Message("citcorpore.comum.definicaonovotempo");
			}

			// SolicitacaoServicoDTO solicitacaoAuxDto =
			// restoreAll(solicitacaoServicoDto.getIdSolicitacaoServico());
			strOcorr += "\n " + i18n_Message("gerenciamento.mudarsla.prazoanterior");
	...
	public void updateTimeAction(Integer idGrupoRedirect, Integer idPrioridadeRedirect, Integer idSolicitacaoServicoParm) throws ServiceException, LogicException {
		...
		try {
			...
			listaSolicitacao = (List<SolicitacaoServicoDTO>) solicitacaoServicoDao.find(solicitacaoAuxDto);
	...
	public boolean verificarExistenciaDeUnidade(Integer idUnidade) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		return solicitacaoDao.verificarExistenciaDeUnidade(idUnidade);
	}
	...
	public boolean verificarExistenciaSolicitacaoFilho(Integer idSolicitacaoServicoPai) throws Exception {
		...
		listSolicitacaoServicoFilho = solicitacaoServicoDao.findByIdSolicitacaoPai(idSolicitacaoServicoPai);
	...
	public Collection incidentesPorContrato(Integer idContrato) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		return dao.incidentesPorContrato(idContrato);
	...
	public Collection<SolicitacaoServicoDTO> listaSolicitacaoServicoPorCriteriosPaginado(PesquisaSolicitacaoServicoDTO pesquisaSolicitacaoServicoDto, String paginacao, Integer pagAtual,
		...
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdContratoPaginada(pesquisaSolicitacaoServicoDto, paginacao, pagAtual, pagAtualAux, totalPag, quantidadePaginator, campoPesquisa);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public SolicitacaoServicoDTO findByIdSolicitacaoServico(Integer idSolicitacaoServico) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdSolicitacaoServico(idSolicitacaoServico);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataBaixa(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataBaixa(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataMedia(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataMedia(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataAlta(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataAlta(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataAtendidasBaixa(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataAtendidasBaixa(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataAtendidasMedia(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataAtendidasMedia(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataAtendidasAlta(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataAtendidasAlta(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataTotal(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataTotal(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataSuspensasTotal(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataSuspensasTotal(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdPessoaEDataAtendidas(Integer idGrupo, String login, String nome, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdPessoaEDataAtendidas(idGrupo, login, nome, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdPessoaEData(Integer idGrupo, String login, String nome, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdPessoaEData(idGrupo, login, nome, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdPessoaEDataNaoAtendidas(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdPessoaEDataNaoAtendidas(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataAtendidasTotal(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataAtendidasTotal(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> findByIdGrupoEDataAtrasadasTotal(Integer idGrupo, Date dataInicio, Date dataFim) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.findByIdGrupoEDataAtrasadasTotal(idGrupo, dataInicio, dataFim);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> listaSolicitacoesPorIdEmpregado(Integer pgAtual, Integer qtdPaginacao, GerenciamentoServicosDTO gerenciamentoBean) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		try {
			return dao.listaSolicitacoesPorIdEmpregado(pgAtual, qtdPaginacao, gerenciamentoBean);
		} catch (Exception e) {
			throw new ServiceException(e);
		}
	}
	...
	public Collection<SolicitacaoServicoDTO> resumoSolicitacoesServico(Collection<TarefaFluxoDTO> listTarefas, Integer idTipoDemandaServico, Integer idPrioridade) throws Exception {
		...
		listSolicitacaoServicoDto = listByTarefas(listTarefas);
	...
	public Collection<SolicitacaoServicoDTO> listByTarefas(Collection<TarefaFluxoDTO> listTarefas, Integer qtdAtual, Integer qtdAPaginacao) throws Exception {
		SolicitacaoServicoDao solicitacaoDao = new SolicitacaoServicoDao();
		Collection<SolicitacaoServicoDTO> listSolicitacaoServicoDto = new ArrayList();

		listSolicitacaoServicoDto = solicitacaoDao.listByTarefas(listTarefas, qtdAtual, qtdAPaginacao);
	...
	public boolean existeSolicitacaoServico(SolicitacaoServicoDTO solicitacaoservico) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		return dao.existeSolicitacaoServico(solicitacaoservico);
	}
	...
	public Collection<SolicitacaoServicoDTO> listByTarefas(Collection<TarefaFluxoDTO> listTarefas, Integer qtdAtual, Integer qtdAPaginacao, GerenciamentoServicosDTO gerenciamentoBean,
		...
		listSolicitacaoServicoDto = solicitacaoServicoDao.listByTarefas(listTarefas, qtdAtual, qtdAPaginacao, gerenciamentoBean, listContratoUsuarioLogado);
	 ...
	 * @since 05.11.2013
	 */
	public Collection<SolicitacaoServicoDTO> listByTarefas(Collection<TarefaFluxoDTO> listTarefas, GerenciamentoServicosDTO gerenciamentoBean, Collection<ContratoDTO> listContratoUsuarioLogado)
			throws Exception {
		...
		listSolicitacaoServicoDto = solicitacaoDao.listByTarefas(listTarefas, gerenciamentoBean, listContratoUsuarioLogado);
	...
	public SolicitacaoServicoDTO restoreInfoEmails(Integer idSolicitacaoServico, TransactionControler tc) throws Exception{
		...
		SolicitacaoServicoDTO solicitacaoDto = null;
		try {
			solicitacaoDto = (SolicitacaoServicoDTO) solicitacaoDao.restoreInfoEmails(idSolicitacaoServico);
		} catch (Exception e) {
			throw new Exception(i18n_Message("solicitacaoservico.erro.recuperardadosolicitacao") + " " + idSolicitacaoServico);
		}
	...
	public Collection<SolicitacaoServicoDTO> listarSolicitacoesAbertasEmAndamentoPorGrupo(int idGrupoAtual, String situacaoSla) throws Exception {
		 SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		 return dao.listarSolicitacoesAbertasEmAndamentoPorGrupo(idGrupoAtual, situacaoSla);
	}
	...
	public Collection<SolicitacaoServicoDTO> listarSolicitacoesMultadasSuspensasPorGrupo(int idGrupoAtual, String situacaoSla) throws Exception {
		 SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		 return dao.listarSolicitacoesMultadasSuspensasPorGrupo(idGrupoAtual, situacaoSla);
	}
	...
	public Collection<SolicitacaoServicoDTO> listaServicosPorResponsavelNoPeriodo(RelatorioKpiProdutividadeDTO dto) throws Exception {
		SolicitacaoServicoDao dao = new SolicitacaoServicoDao();
		 return dao.listaServicosPorResponsavelNoPeriodo(dto);
	}
}