...
public interface PastaService extends CrudServiceEjb2 {
	 ...
	 * @author valdoilo.damasceno
	 */
	public PastaDTO create(PastaDTO pastaBean) throws LogicException, RemoteException, ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(PastaDTO pastaBean) throws LogicException, RemoteException, ServiceException;
