...
public class CargoFormacaoAcademicaDao extends CrudDaoDefaultImpl {
	
	public CargoFormacaoAcademicaDao() {
	...
	public String getTableName() {
		return "RH_CargoFormacaoAcademica";
	}
	...
	public Class getBean() {
		...
		return CargoFormacaoAcademicaDTO.class;
	}
