...
public class CargoExperienciaAnteriorDao extends CrudDaoDefaultImpl {
	
	public CargoExperienciaAnteriorDao() {
	...
	public String getTableName() {
		return "RH_CargoExperienciaAnterior";
	}
	...
	public Class getBean() {
		...
		return CargoExperienciaAnteriorDTO.class;
	}
