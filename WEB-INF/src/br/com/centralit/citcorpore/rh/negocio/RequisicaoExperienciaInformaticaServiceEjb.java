...
public class RequisicaoExperienciaInformaticaServiceEjb extends CrudServicePojoImpl implements RequisicaoExperienciaInformaticaService {
	protected CrudDAO getDao() throws ServiceException {
		return new RequisicaoExperienciaInformaticaDao();
	}
	...
	public Collection findByIdSolicitacaoServico(Integer parm) throws Exception{
		RequisicaoExperienciaInformaticaDao dao = new RequisicaoExperienciaInformaticaDao();
		try{
