...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    new Select (driver.findElement(By.id("idJustificativa"))).selectByVisibleText("Aquisição de Licenças");
	    js.executeScript("gravar();");
	    driver.switchTo().alert().getText().endsWith("Confirma a suspensão?");
	    Thread.sleep(2000L); 
