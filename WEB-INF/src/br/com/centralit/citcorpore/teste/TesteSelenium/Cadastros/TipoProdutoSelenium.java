...
public class TipoProdutoSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
    ...
    driver.findElement(By.cssSelector("a[id=itemMM50]")).click();
   	...
   	js.executeScript("chamaItemMenu('/citsmart/pages/tipoProduto/tipoProduto.load')");
    driver.findElement(By.id("nomeProduto")).clear();
    driver.findElement(By.id("nomeProduto")).sendKeys("teste");
    driver.findElement(By.id("categoriaProduto")).click();
    js.executeScript("pesq_LOOKUP_CATEGORIAPRODUTO()");
    js.executeScript("setRetorno_LOOKUP_CATEGORIAPRODUTO('1','teste');");
    driver.findElement(By.id("aceitaRequisicao")).click();
    ...
    driver.findElement(By.partialLinkText("Pesquisa de Tipo de Produto")).click();
    driver.findElement(By.id("pesqLockupLOOKUP_TIPOPRODUTO_nomeProduto")).clear();
    driver.findElement(By.id("pesqLockupLOOKUP_TIPOPRODUTO_nomeProduto")).sendKeys("teste");
