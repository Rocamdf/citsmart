...
public class TipoSolicitacaoServicoSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("a[id=itemMM50]")).click();
	   	...
	   	js.executeScript("chamaItemMenu('/citsmart/pages/dinamicViews/dinamicViews.load?identificacao=TipoSolicitacaoServico')");
	    driver.findElement(By.id("NOMETIPODEMANDASERVICO")).clear();
	    driver.findElement(By.id("NOMETIPODEMANDASERVICO")).sendKeys("teste");
	    ...
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_19")).clear();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_19")).sendKeys("teste");
	    driver.findElement(By.id("btn_REFRESH_VIEW")).click();
	    driver.findElement(By.cssSelector("div.datagrid-cell.datagrid-cell-c5-IDTIPODEMANDASERVICO")).click();
	    driver.findElement(By.id("btnLimpar")).click();
	    driver.findElement(By.partialLinkText("Pesquisa Solicitação Serviço")).click();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_19")).clear();
	    driver.findElement(By.id("termo_pesq_TABLESEARCH_19")).sendKeys("teste");
	    driver.findElement(By.id("btn_REFRESH_VIEW")).click();
	    driver.findElement(By.cssSelector("div.datagrid-cell.datagrid-cell-c5-IDTIPODEMANDASERVICO")).click();
