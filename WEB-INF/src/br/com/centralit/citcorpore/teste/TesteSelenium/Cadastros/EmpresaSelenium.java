...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	...
	js.executeScript("chamaItemMenu('/citsmart/pages/empresa/empresa.load')");
    driver.findElement(By.id("nomeEmpresa")).clear();
    driver.findElement(By.id("nomeEmpresa")).sendKeys("teste");
    js.executeScript("document.form.save();");
    driver.switchTo().alert().getText().endsWith("Registro inserido com sucesso");
    Thread.sleep(2000L); 
    driver.switchTo().alert().accept();
    driver.findElement(By.partialLinkText("Pesquisa Empresa")).click();
    driver.findElement(By.id("pesqLockupLOOKUP_EMPRESA_NOMEEMPRESA")).clear();
    driver.findElement(By.id("pesqLockupLOOKUP_EMPRESA_NOMEEMPRESA")).sendKeys("teste");
    driver.findElement(By.id("btnPesquisar")).click();
    driver.findElement(By.name("sel")).click();
    driver.findElement(By.id("btnLimpar")).click();
    driver.findElement(By.cssSelector("div.section")).click();
    driver.findElement(By.partialLinkText("Pesquisa Empresa")).click();
    driver.findElement(By.id("pesqLockupLOOKUP_EMPRESA_NOMEEMPRESA")).clear();
    driver.findElement(By.id("pesqLockupLOOKUP_EMPRESA_NOMEEMPRESA")).sendKeys("teste");
    driver.findElement(By.id("btnPesquisar")).click();
