...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
    ...
    new Select(driver.findElement(By.id("tipoAlcada"))).selectByVisibleText("Autorização de compras");
    ...
    driver.findElement(By.partialLinkText("Pesquisa de Alçada")).click();
