...
public class SituacaoServicoSelenium {
...
//    driver = new FirefoxDriver();
  ...
  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("a[id=itemMM50]")).click();
	   	...
	   	js.executeScript("chamaItemMenu('/citsmart/pages/situacaoServico/situacaoServico.load')");
	    driver.findElement(By.id("nomeSituacaoServico")).clear();
	    driver.findElement(By.id("nomeSituacaoServico")).sendKeys("teste");
	    js.executeScript("document.form.save();");
	    driver.switchTo().alert().getText().endsWith("Registro inserido com sucesso");
	    Thread.sleep(2000L); 
	    driver.switchTo().alert().accept();
	    driver.findElement(By.linkText("Pesquisa de Situação de Serviço")).click();
	    driver.findElement(By.id("pesqLockupLOOKUP_SITUACAOSERVICO_nomesituacaoservico")).clear();
	    driver.findElement(By.id("pesqLockupLOOKUP_SITUACAOSERVICO_nomesituacaoservico")).sendKeys("teste");
	    ...
	    driver.switchTo().alert().getText().endsWith("Deseja realmente excluir o registro");
	    Thread.sleep(2000L); 
	    driver.switchTo().alert().accept(); 
