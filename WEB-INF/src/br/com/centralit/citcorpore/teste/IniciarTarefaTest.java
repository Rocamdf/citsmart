...
public class IniciarTarefaTest {
	protected CrudDAO getDao() throws ServiceException {
		return new ExecucaoSolicitacaoDao();
	}
	public String testIniciarTarefa() {
		try {
			...
			new ExecucaoSolicitacao(tc).executa(solicitacaoServicoDto.getUsuarioDto().getLogin(), solicitacaoAuxDto, gerenciamentoBean.getIdTarefa(), Enumerados.ACAO_INICIAR, objetos);	
		return new UtilTest().testNotNull(Enumerados.ACAO_INICIAR);
