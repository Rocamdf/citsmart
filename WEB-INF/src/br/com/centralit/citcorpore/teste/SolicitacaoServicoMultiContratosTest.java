...
//			solicitacaoServicoDTO.setColItensMudanca(arrayList);
			...
			solicitacaoServicoDTO.setDataHoraLimiteStr(UtilDatas.getDataCorrenteStr());
			solicitacaoServicoDTO.setDataHoraLimiteToString(UtilDatas.getDataCorrenteStr());
			solicitacaoServicoDTO.setDataHoraSolicitacao(UtilDatas.getDataHoraAtual());
			solicitacaoServicoDTO.setDataHoraSolicitacaoStr(UtilDatas.getDataCorrenteStr());
			solicitacaoServicoDTO.setDataHoraSolicitacaoToString(UtilDatas.getDataCorrenteStr());
