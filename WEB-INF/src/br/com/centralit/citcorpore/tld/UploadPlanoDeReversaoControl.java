...
public class UploadPlanoDeReversaoControl extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		try {
			...
			out.println("<div style='border:1px solid black; height: 480px' id='divUpload_" + getId() + "'>\n");
			...
			if (!UtilStrings.nullToVazio(disabled).equalsIgnoreCase("true")){
				out.println("<table border='0'>");
					...
					out.println("<tr>");
						...
						out.println("</td>");
						out.println("<td>");						
							out.println("<input type='text' name='descUploadFile_" + getId() + "' id='descUploadFile_" + getId() + "' size='50' maxlength='70'/>");
							out.println("</tr>");	
							out.println("<tr>");
							out.println("<td>");
							out.println(UtilI18N.internacionaliza((HttpServletRequest) pageContext.getRequest(), "citcorpore.comum.versao")+":");
							out.println("</td>");
							out.println("<td>");
							out.println("<input type='text' name='versao_" + getId() + "' id='versao_" + getId() + "' size='20' maxlength='20'/>");
						out.println("</td>");
						out.println("</tr>");	
						out.println("<tr>");
						out.println("<td>");
