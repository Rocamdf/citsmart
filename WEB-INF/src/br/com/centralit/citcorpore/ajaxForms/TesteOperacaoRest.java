...
public class TesteOperacaoRest extends AjaxFormAction {
    ...
    public void autentica(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	try{
			...
			String str = "<html><head></head><body><table><tr><td colspan='2'><b>/services/login</b></td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Parâmetros:</b></td><td>"+input+"</td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Saída:</b></td><td>"+saida+"</td></tr></table></body></html>";
    ...
    public void notification_getByUser(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	try{
			...
			String saida = clientResponse.getEntity();
			System.out.println("###### SAIDA: "+ saida);
			String str = "<html><head></head><body><table><tr><td colspan='2'><b>/mobile/notification/getByUser</b></td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Parâmetros:</b></td><td>"+input+"</td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Saída:</b></td><td>"+saida+"</td></tr></table></body></html>";
			os.write(str.getBytes());
    ...
    public void notification_getById(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	try{
			...
			String str = "<html><head></head><body><table><tr><td colspan='2'><b>/mobile/notification/getById</b></td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Parâmetros:</b></td><td>"+input+"</td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Saída:</b></td><td>"+clientResponse.getEntity()+"</td></tr></table></body></html>";
			os.write(str.getBytes());
    ...
    public void notification_new(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	try{
			...
			String str = "<html><head></head><body><table><tr><td colspan='2'><b>/mobile/notification/new</b></td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Parâmetros:</b></td><td>"+input+"</td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Saída:</b></td><td>"+clientResponse.getEntity()+"</td></tr></table></body></html>";
			os.write(str.getBytes());
    ...
    public void notification_getReasons(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	try{
			...
			String str = "<html><head></head><body><table><tr><td colspan='2'><b>/mobile/notification/getReasons</b></td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Parâmetros:</b></td><td>"+input+"</td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Saída:</b></td><td>"+clientResponse.getEntity()+"</td></tr></table></body></html>";
			os.write(str.getBytes());
    ...
    public void notification_feedback(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	try{
			...
			String str = "<html><head></head><body><table><tr><td colspan='2'><b>/mobile/notification/feedback</b></td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Parâmetros:</b></td><td>"+input+"</td></tr><tr><td>&nbsp;</td></tr><tr><td><b>Saída:</b></td><td>"+clientResponse.getEntity()+"</td></tr></table></body></html>";
			os.write(str.getBytes());
