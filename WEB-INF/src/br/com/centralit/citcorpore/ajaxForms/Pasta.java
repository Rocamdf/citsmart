...
public class Pasta extends AjaxFormAction {
	 ...
	 * @throws ServiceException
	 */
	private void carregarComboPastaSuperiorNoRestore(DocumentHTML document, HttpServletRequest request, PastaDTO pastaDto) throws Exception, LogicException, RemoteException, ServiceException {
