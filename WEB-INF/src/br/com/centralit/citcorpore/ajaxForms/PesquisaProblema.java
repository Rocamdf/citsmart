		...
		if (listaProblema != null) {
			...
			for (PesquisaProblemaDTO problema : listaProblema) {
				...
				if(problema.getDataHoraCaptura()!=null){
					problema.setDataHoraInicioStr(UtilDatas.formatTimestamp(problema.getDataHoraCaptura()));
				}
				
				if(problema.getDataHoraFim()!=null){
					problema.setDataHoraConclusaoStr(UtilDatas.formatTimestamp(problema.getDataHoraFim()));
				}
