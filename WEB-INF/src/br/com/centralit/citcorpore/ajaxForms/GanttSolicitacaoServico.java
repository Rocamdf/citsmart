...
public class GanttSolicitacaoServico extends AjaxFormAction {
	...
	if (listaSolicitacaoServico != null && !listaSolicitacaoServico.isEmpty()) {
	    StringBuffer gantt = gerarGantt(listaSolicitacaoServico);
	...
	*/
    ...
    public void filtrarGantt(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (listaSolicitacaoServico != null && !listaSolicitacaoServico.isEmpty()) {
		    StringBuffer gantt = gerarGantt(listaSolicitacaoServico, this.getGanttSolicitacaoServicoBean(), request);
		    document.executeScript(gantt.toString());
     ...
     * @author valdoilo
     */
    private StringBuffer gerarGantt(Collection<SolicitacaoServicoDTO> listaSolicitacaoServico, GanttSolicitacaoServicoDTO ganttSolicitacaoServicoDTO, HttpServletRequest request) {
