...
public class ControleRendimentoExecucao extends AjaxFormAction{
	...
	public void calculaPontuacaoMesPorPessoa(String ano, String mes, Integer idGrupo, DocumentHTML document) throws ServiceException, Exception{
		...
		for (EmpregadoDTO empregadoDTO : listaEmpregadosFabrica) {
			...
			if(usuarioDto != null){
				...
				Integer qtdTotalPontosnegativos = calculaQtdTotalPontosNegativosPessoa(listaTotalSolicitacoesPessoa, dInicio, dFim);
	...
	public Integer calculaQtdTotalPontosNegativosPessoa(Collection<SolicitacaoServicoDTO> listaTotalSolicitacoesPessoa, Date dataInicio, Date dataFim) throws ServiceException, Exception{
		...
		if(listaTotalSolicitacoesPessoa != null){
			...
			Collection<RelatorioQuantitativoRetornoListaDTO> listaPorPeriodo = retornos.trazListaRetornos(solicitacaoAux);
		...
		if(idPessoa == null){
			...
			for (EmpregadoDTO empregadoDTO : listaEmpregadosFabrica) {
				...
				if(usuarioDto != null){
					...
					Integer qtdTotalPontosnegativos = calculaQtdTotalPontosNegativosPessoa(listaTotalSolicitacoesPessoa, dataInicio, dataFim);
