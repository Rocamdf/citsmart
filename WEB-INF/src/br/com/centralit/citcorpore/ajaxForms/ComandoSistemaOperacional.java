...
public class ComandoSistemaOperacional extends AjaxFormAction {
	...
	public void load(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (sistemaOperacionalService != null) {
			...
			ArrayList<SistemaOperacionalDTO> lista = (ArrayList<SistemaOperacionalDTO>) sistemaOperacionalService.list();
			...
			ArrayList<ComandoDTO> listaComando = (ArrayList<ComandoDTO>) comandoService.list();
