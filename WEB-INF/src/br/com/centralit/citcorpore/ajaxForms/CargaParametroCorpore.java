	...
	public void load(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (hshRetorno != null) {
			...
			if (fileItems != null && !fileItems.isEmpty()) {
				...
				CargaParametroCorporeService cargaParametroCorporeService = (CargaParametroCorporeService) ServiceLocator.getInstance().getService(CargaParametroCorporeService.class, null);

				Thread.sleep(5000);
				System.out.println("Vai carregar o arquivo de Parâmetros..." + CITCorporeUtil.caminho_real_app + "tempFiles/" + fileName);
				arquivo = new File(CITCorporeUtil.caminho_real_app + "tempFiles/" + fileName);
