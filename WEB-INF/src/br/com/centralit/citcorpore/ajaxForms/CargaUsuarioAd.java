...
/* Desenvolvedor: Euler Data: 28/10/2013 Horário: 09h45min ID Citsmart: 120393 Motivo/Comentário: Eliminar mensagem de erro antes de carregar a tela */
	...
	public void load(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (hshRetorno != null) {
			...
			if (fileItems != null && !fileItems.isEmpty()) {
				...
				System.out.println(">>> Carga de Usuários e Empregados Iniciada..." + CITCorporeUtil.caminho_real_app + "tempFiles/" + fileName);
