...
public class ValidacaoRequisicaoProduto extends RequisicaoProduto {
	...
	protected String getAcao() {
        return RequisicaoProdutoDTO.ACAO_VALIDACAO;
    }
    ...
    public void restore(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (itensRequisicao != null) {
            tblItensRequisicao.addRowsByCollection(itensRequisicao, 
                                                new String[] {"","descricaoItem","quantidade","siglaUnidadeMedida","descrSituacao","codigoProduto","nomeProduto"}, 
                                                null, 
                                                "", 
                                                new String[] {"gerarImg"}, 
                                                "editarItem", 
        ...
        StringBuffer aprovadores = requisicaoProdutoService.recuperaLoginAutorizadores(requisicaoProdutoDto.getIdSolicitacaoServico());
        if (aprovadores != null)
