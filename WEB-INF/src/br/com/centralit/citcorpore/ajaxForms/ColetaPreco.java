...
public class ColetaPreco extends AjaxFormAction {
    ...
    public void carregaCombos(DocumentHTML document, HttpServletRequest request, ColetaPrecoDTO coletaPrecoDto) throws Exception {
    ...
    public void atualiza(DocumentHTML document, HttpServletRequest request, HttpServletResponse response) throws Exception {
        try{
            ...
            carregaCombos(document,request,coletaPrecoDto);
        }finally{
