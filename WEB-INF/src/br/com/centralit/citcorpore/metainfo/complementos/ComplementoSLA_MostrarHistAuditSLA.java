			...
			if (IDACORDONIVELSERVICO > 0){
				...
				if (col != null){
					for (Iterator it = col.iterator(); it.hasNext();){
						...
						strTable += "</td>";
						strTable += "<td style='border:1px solid black'>";
							strTable += "" + UtilDatas.dateToSTR(acordoNivelServicoHistoricoDTO.getDataInicio()) + "";
						strTable += "</td>";	
						strTable += "<td style='border:1px solid black'>";
							if (acordoNivelServicoHistoricoDTO.getDataFim() != null){
								strTable += "" + UtilDatas.dateToSTR(acordoNivelServicoHistoricoDTO.getDataFim()) + "";
							}else{
								strTable += "&nbsp;";
							}
						strTable += "</td>";
						strTable += "<td style='border:1px solid black'>";
							strTable += "" + UtilDatas.dateToSTR(acordoNivelServicoHistoricoDTO.getAvaliarEm()) + "";
						strTable += "</td>";	
						strTable += "<td style='border:1px solid black'>";
						...
						strTable += "</td>";	
						strTable += "<td style='border:1px solid black'>";
							strTable += "" + UtilDatas.dateToSTR(acordoNivelServicoHistoricoDTO.getModificadoEm()) + "";
						strTable += "</td>";			
						strTable += "</tr>";	
