...
public class PesquisaRequisicaoMudancaDTO extends ObjetoNegocioFluxoDTO {
	...
	public boolean atendida() {
		return this.status != null
				&& (this.status.equalsIgnoreCase(Enumerados.SituacaoRequisicaoMudanca.Resolvida.name())
						|| this.status.equalsIgnoreCase(Enumerados.SituacaoRequisicaoMudanca.Cancelada.name()) || this.status
	...
	public boolean emAtendimento() {
		return this.status != null
				&& (this.status.equalsIgnoreCase(Enumerados.SituacaoRequisicaoMudanca.Registrada.name())
						|| this.status.equalsIgnoreCase(Enumerados.SituacaoRequisicaoMudanca.Aprovada.name())
						|| this.status.equalsIgnoreCase(Enumerados.SituacaoRequisicaoMudanca.EmExecucao.name()) || this.status
