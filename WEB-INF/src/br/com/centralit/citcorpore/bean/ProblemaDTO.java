...
//	por padrão é S no banco de dados.
	...
	public boolean atendida() {
		return this.status != null && (this.status.equalsIgnoreCase(Enumerados.SituacaoProblema.Resolvida.name()) || this.status.equalsIgnoreCase(Enumerados.SituacaoProblema.Cancelada.name()) || this.status.equalsIgnoreCase(Enumerados.SituacaoProblema.Fechada.name()));
	}
	...
	public void setListProblemaItemConfiguracaoDTO(
			List<ProblemaItemConfiguracaoDTO> listProblemaItemConfiguracaoDTO) {
