...
public class QuestaoQuestionarioDao extends CrudDaoDefaultImpl {
	...
	public int deleteByIdGrupoQuestionario(Integer idGrupoQuestionario) throws Exception {
    ...
    public Collection findByIdGrupoQuestionario(Integer idGrupoQuestionario) throws Exception {
    ...
    private Collection listCabecalhos(Integer idQuestaoAgrupadora, String SQL) throws Exception {
    ...
    public Collection listBySiglaAndIdQuestao(String sigla, Integer idQuestaoOrigem, Integer idQuestao) throws Exception {
