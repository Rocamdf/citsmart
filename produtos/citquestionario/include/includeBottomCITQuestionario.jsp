...
<form name='formArquivosMultimidia' method="post" action='<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/uploadArquivoMultimidia/uploadArquivoMultimidia'>
...
<cit:janelaPopup style="display:none;top:1350px;width:600px;left:50px;height:200px;position:absolute;" title="Upload Anexo" id="POPUP_UPLOAD_MULTIMIDIA">
	...
	<form name='formAnexo' method="post" ENCTYPE="multipart/form-data" action='<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/uploadArquivoMultimidia/uploadArquivoMultimidia.load'>
...
<cit:janelaPopup style="display:none;top:1350px;width:600px;left:50px;height:200px;position:absolute;" title="Modelos Textuais" id="POPUP_MODELOS_TEXTUAIS">
	<form name='formModeloTextual' method="post" action='<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/pages/modeloTextual/modeloTextual'>
...
<cit:janelaPopup style="display:none;top:1350px;width:800px;left:50px;height:600px;position:absolute;" title="Galeria de Imagens" id="POPUP_GALERIA_IMAGENS">
	<form name='formGaleriaImagens' method="post" target="_blank" action='<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/uploadArquivoMultimidia/uploadArquivoMultimidia'>
