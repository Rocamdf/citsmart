...
trataComplementoOpcao = function(campo, idQuestao, idOpcao){
    ...
    adicionarRespostaTabela = function(idTabela){
        ...
        colunaDestino.innerHTML = '<img src="<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/produtos/citsaude/imagens/btnExcluirRegistro.gif" title="Clique aqui para excluir esta linha" border="0" onclick="excluirRespostaTabela('+idTabela+',this)"/>';
	...
	chamaEditorImagens = function(idQuestaoParm, idImagemParm, caminhoImagemFundo, campoValue){
		...
		//window.open('<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/svg-edit-2.4/svg-editor.jsp?funcaoRecebeConteudo=recebeConteudo&frame=ifrImagem_' + idQuestaoParm + '&imagemFundo=' + caminhoImagemFundo);
		document.formGaleriaImagens.action = '<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/svg-edit-2.4/svg-editor.jsp';
    ...
    abreMaisMenosGrp = function(obj, divNameGRP){
    	    ...
    	    obj.src = '<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/produtos/citsaude/imagens/im_menos1.jpg';
    	    document.getElementById(divNameGRP).style.display='block';
    	}else{
    	
    	    obj.src = '<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/im_mais1.jpg';
    	    document.getElementById(divNameGRP).style.display = 'none';
    	} --%>
    	if (document.getElementById(divNameGRP).style.display == 'none'){
    	    obj.src = '<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/menos1.png';
    	    document.getElementById(divNameGRP).style.display='block';
    	}else{
    	    obj.src = '<%=br.com.citframework.util.Constantes.getValue("SERVER_ADDRESS")%><%=br.com.citframework.util.Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/mais1.png';
    	    document.getElementById(divNameGRP).style.display='none';
    	}
    };
