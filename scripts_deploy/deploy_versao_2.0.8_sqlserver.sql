...
CREATE TABLE requisicaoquestionario (
  ...
  dataquestionario smalldatetime NOT NULL DEFAULT sysdatetime(),
  idresponsavel integer NOT NULL,
  idtarefa bigint DEFAULT NULL,
  aba varchar(100) DEFAULT NULL,
  situacao char(1) NOT NULL,
  datahoragrav smalldatetime NOT NULL DEFAULT sysdatetime(),
...
alter table historicoliberacao alter column datahorareativacao smalldatetime  null;
alter table historicoliberacao alter column datahorasuspensao smalldatetime  null;
...
alter table origematendimento add datainicio smalldatetime;
alter table origematendimento add datafim smalldatetime;
