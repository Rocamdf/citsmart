...
alter table liberacao alter column datainicial smalldatetime;

alter table liberacao alter column datafinal smalldatetime;
...
create table timesheetprojeto (
   ...
   idrecursotarefalinbaseproj integer not null,
   datahorareg smalldatetime not null,
   data date not null,
...
create table historicomudanca (
  ...
  datahoramodificacao smalldatetime,
  ...
  datahoraconclusao smalldatetime,
  dataaceitacao date,
  datavotacao date,
  ...
  datahoracaptura smalldatetime,
  datahorareativacao smalldatetime,
  datahorasuspensao smalldatetime,
  ...
  datahorainicioagendada smalldatetime,
  datahoraterminoagendada smalldatetime,
