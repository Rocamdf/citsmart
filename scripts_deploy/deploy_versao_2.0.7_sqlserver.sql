...
alter table problema add  datahoracaptura smalldatetime null;

alter table problema add  datahorainiciosla smalldatetime null;

alter table problema add  datahorareativacao smalldatetime null;

alter table problema add  datahorareativacaosla smalldatetime null;

alter table problema add  datahorasuspensao smalldatetime null;

alter table problema add  datahorasuspensaosla smalldatetime null;
...
alter table problema alter column datahoralimite  smalldatetime null;
...
create table solucaocontorno (
	...
	datahoracriacao smalldatetime null
);
...
alter table problema alter column datahoralimite  smalldatetime ;

alter table problema add  enviaemailprazosolucionarexpirou char(1);

alter table problema alter column datahorasolicitacao smalldatetime null;

alter table problema alter column datahorasolicitacao  smalldatetime;
...
CREATE TABLE historicoliberacao (
  ...
  datahoraModificacao smalldatetime NOT NULL DEFAULT sysdatetime(),
  ...
  datahoratermino smalldatetime NOT NULL DEFAULT sysdatetime(),
  datahoraconclusao smalldatetime NOT NULL DEFAULT sysdatetime(),
  ...
  datahoracaptura smalldatetime NULL DEFAULT sysdatetime(),
  datahorareativacao smalldatetime NULL DEFAULT sysdatetime(),
  datahorainicio smalldatetime NOT NULL DEFAULT sysdatetime(),
  idcalendario integer DEFAULT NULL,
  datahorasuspensao smalldatetime NULL DEFAULT sysdatetime(),
  enviaemailfinalizacao varchar(1) DEFAULT NULL,
  prazohh smallint DEFAULT NULL,
  prazomm smallint DEFAULT NULL,
  idproprietario integer NOT NULL,
  datahorainicioagendada smalldatetime NULL DEFAULT sysdatetime(),
  datahoraterminoagendada smalldatetime NULL DEFAULT sysdatetime(),
...
alter table historicoliberacao alter column datahoraconclusao smalldatetime null;
...
alter table liberacao add datahoratermino smalldatetime DEFAULT '1970-01-01 00:00:00';
alter table liberacao add datahoraconclusao smalldatetime  DEFAULT '1970-01-01 00:00:00';
...
alter table liberacao add datahoracaptura smalldatetime DEFAULT '1970-01-01 00:00:00';
alter table liberacao add datahorareativacao smalldatetime DEFAULT '1970-01-01 00:00:00';
alter table liberacao add datahorainicio smalldatetime DEFAULT '1970-01-01 00:00:00';
alter table liberacao add idcalendario integer;
alter table liberacao add datahorasuspensao smalldatetime DEFAULT '1970-01-01 00:00:00';
...
alter table liberacao add datahorainicioagendada smalldatetime DEFAULT '1970-01-01 00:00:00';
alter table liberacao add datahoraterminoagendada smalldatetime DEFAULT '1970-01-01 00:00:00';
...
alter table liberacao add 	datahoraaprovacao smalldatetime DEFAULT '1970-01-01 00:00:00';
...
CREATE TABLE solicitacaoservicoquestionario (
  ...
  dataquestionario smalldatetime NOT NULL,
  idresponsavel integer NOT NULL,
  idtarefa integer DEFAULT NULL,
  aba varchar(100) DEFAULT NULL,
  situacao char(1) NOT NULL,
  datahoragrav smalldatetime NOT NULL,
...
ALTER TABLE requisicaomudanca ALTER COLUMN DATAHORACONCLUSAO smalldatetime NULL;
...
EXEC sp_rename 'limitealcada.limitevalormensal', 'limitemensalusointerno', 'COLUM';
EXEC sp_rename 'limitealcada.limitevaloritem', 'limiteitemusointerno', 'COLUM';
...
alter table problema alter column  datahorafim smalldatetime null;
...
ALTER TABLE itemconfiguracao ADD dtultimacaptura smalldatetime;

ALTER TABLE historicoic ADD dtultimacaptura smalldatetime;
