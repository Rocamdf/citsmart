...
create table aprovacaosolicitacaoservico (
  ...
  datahora smalldatetime null default null,
  ...
  alter table solicitacaoservico add datahorainiciosla smalldatetime null;
  alter table solicitacaoservico add idultimaaprovacao integer;
  alter table solicitacaoservico add situacaosla char(1);
  alter table solicitacaoservico add datahorasuspensaosla smalldatetime null;
  alter table solicitacaoservico add datahorareativacaosla smalldatetime null;
  alter table solicitacaoservico alter column datahoralimite smalldatetime null;
